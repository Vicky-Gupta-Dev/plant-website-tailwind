...
var Te = (t, e, s) => (
  ...
  Al(
    e || !t || !t.__esModule
      ? Vr(s, "default", { value: t, enumerable: !0 })
      : s,
    t,
  )
);
...
var fe = w((wx, zi) => {
  ...
  function Yi(t) {
    return t.map(
      (e) => (e.nodes && (e.nodes = Yi(e.nodes)), delete e.source, e),
    );
  }
  function Vi(t) {
  ...
  var Be = class {
    ...
    error(e, s, r, n = {}) {
      ...
      return (
        ...
        this.file &&
          (Kt && (l.input.url = Kt(this.file).toString()),
...
var Ss = w((Hx, Yo) => {
  ...
  Yo.exports = function (e) {
    Go[e] ||
      ((Go[e] = !0), typeof console < "u" && console.warn && console.warn(e));
  };
});
var As = w((Qx, Ho) => {
  "use strict";
      ...
      (n
        ...
        n &&
          ...
          i.type === "media-feature-expression" &&
            (i.nodes = va(i.value, i.sourceIndex)),
          s.push(
            Array.isArray(i.nodes) ? new Ls.default(i) : new ga.default(i),
          ),
          (i = o()),
          (n = !1)));
    }
...
var B = w((U) => {
  ...
  var w_ = (U.TAG = "tag"),
    v_ = (U.STRING = "string"),
    x_ = (U.SELECTOR = "selector"),
    __ = (U.ROOT = "root"),
    b_ = (U.PSEUDO = "pseudo"),
    E_ = (U.NESTING = "nesting"),
    S_ = (U.ID = "id"),
    k_ = (U.COMMENT = "comment"),
    T_ = (U.COMBINATOR = "combinator"),
    A_ = (U.CLASS = "class"),
    O_ = (U.ATTRIBUTE = "attribute"),
    C_ = (U.UNIVERSAL = "universal");
});
var fr = w((cr, Ca) => {
  "use strict";
  cr.__esModule = !0;
  ...
  var Bm = (function () {
    function t(e) {
      ...
      return (
        ...
        (this.current = s),
        this.lossy
          ? (this.tokens = (0, pu.default)({ safe: e.safe, css: e.css.trim() }))
...
var cn = Object.freeze({ character: "'", codePoint: 39 }),
  fn = Object.freeze({ character: '"', codePoint: 34 }),
  Wl = Object.freeze({ preferred: cn, alternate: fn }),
  Gl = Object.freeze({ preferred: fn, alternate: cn });
function Yl(t, e) {
...
function Xr(t, e) {
  t.source &&
    ((t.source.startOffset = Sn(t, e)), (t.source.endOffset = Qr(t, e)));
  for (let s in t) {
    let r = t[s];
    s === "source" ||
      !r ||
...
function Cn(t, e) {
  return [...Pn, ...(Array.isArray(e) ? e : [e])].map((s) =>
    `@${t} ${s}`.trim(),
  );
}
...
function Wn(t) {
  let { shebang: e, text: s, pragmas: r, comments: n } = Jr(t),
    i = In(s),
    o = Ln({ pragmas: { [Bn]: "", ...r }, comments: n.trimStart() });
  return (
    (e
      ? `${e}
`
...
var yi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu,
  ...
  gc = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu,
  wc = new RegExp(
    yi.source + `|(${gc.source})?(${mc.source})(${yc.source})?`,
    "giu",
  );
function V(t, e) {
...
function _e(t) {
  return E(0, t, wc, (e, s, r, n, i) =>
    !r &&
    n &&
    (i ?? (i = ""), (i = i.toLowerCase()), !i || i === "n" || Wt.has(i))
      ? ns(n) + (i ? ss(i) : "")
      : e,
  );
}
  ...
  let o = t.map(({ node: g, isLast: b, index: d }) => {
      ...
      if (!b && g.type === "value-comma_group" && ce(g.groups)) {
        ...
        (!y.source && y.close && (y = y.close),
          y.source && Vt(e.originalText, R(y)) && m.push(T));
      }
      return m;
    }, "groups"),
    u = li(r, n),
    ...
    h = a || u,
    c = D(
      [r.open ? s("open") : "", L([M, Y(C, o)]), M, r.close ? s("close") : ""],
      { shouldBreak: f },
    );
  return h ? le(c) : c;
}
...
function Oc(t, e, s) {
  ...
  return (
    t.each(() => {
      ...
      let { next: o } = t;
      (o.type === "css-comment" &&
        !Yt(e.originalText, P(o), { backwards: !0 }) &&
        !Re(n)) ||
...
function Cc(t, e, s) {
  ...
  switch (r.type) {
    ...
    case "css-decl": {
      ...
      return (
        ...
        [
          ...
          (n.type === "css-atrule" && n.variable) || Kn(t)
            ? r.prop
            : Ie(r.prop),
          o.startsWith("//") ? " " : "",
          o,
    ...
    case "value-operator":
      return r.value;
    case "value-word":
      return (r.isColor && r.isHex) || jn(r.value)
        ? r.value.toLowerCase()
        : r.value;
    case "value-colon": {
      let { previous: n } = t;
      return D([
        r.value,
        (typeof n?.value == "string" && n.value.endsWith("\\")) || qe(t, "url")
          ? ""
          : C,
      ]);
    }
...
var Pc = { singleQuote: ki.singleQuote },
  Ti = Pc;
var en = {};
...
function By(t, e) {
  ...
  for (let a = 0; a < s.length; ++a) {
    ...
    if (l.type === "paren" && l.value === "(")
      ...
      if (
        (o.groups.length > 0 && r.groups.push(o), (r.close = l), u.length === 1)
      )
      ...
      if (a === s.length - 3 && s[a + 1].type === "comment" && ll(s[a + 2]))
        continue;
      (r.groups.push(o),
        (o = { groups: [], type: "comma_group" }),
        (u[u.length - 1] = o));
...
function fl(t, e) {
  if (Se(t))
    for (let s in t)
      s !== "parent" &&
        (fl(t[s], e), s === "nodes" && ((t.group = Yr(By(t, e))), delete t[s]));
  return t;
}
function Uy(t, e) {
  ...
  if (Se(t)) {
    ...
    if (
      ...
      return s.startsWith("@") && s.endsWith(":")
        ...
        : t.mixin
          ? ((t.selector = de(s, e)), t)
          : (hl(t, e) && (t.isSCSSNesterProperty = !0),
            (t.selector = se(s)),
            t);
    if (r.trim().length > 0) {
      let i = r.match(Gy);
...
function Js(t, e, s) {
  ...
  try {
    ...
    throw typeof l != "number"
      ? o
      : ma(`${u}: ${a}`, { loc: { start: { line: l, column: f } }, cause: o });
  }
  return (
    (s.originalText = e),
    (i = gl(te(i, "css-"), s)),

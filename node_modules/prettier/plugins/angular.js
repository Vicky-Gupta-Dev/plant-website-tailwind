(function (n) {
      ...
      if ((e && typeof e == "object") || typeof e == "function")
        for (let i of _i(e))
          !ki.call(t, i) &&
            ...
            nt(t, i, {
              get: () => e[i],
              enumerable: !(s = Ci(e, i)) || s.enumerable,
            });
      return t;
    };
  var Ii = (t) => Ai(nt({}, "__esModule", { value: !0 }), t);
  var st = (t, e, n) => e.has(t) || ln("Cannot " + n);
  var U = (t, e, n) => (
    ...
    v = (t, e, n) => (st(t, e, "access private method"), n);
  var un = (t, e, n) => bi(Ti(t), n, e);
  var Gr = {};
  cn(Gr, { parsers: () => rn });
  var rn = {};
  cn(rn, {
  ...
  function ue(t) {
    return t.type === "TSNonNullExpression" && !pn(t)
      ? ue(t.expression)
  ...
  function Ge(t, e) {
    return Li(t, e, (n, s) => n.isEquivalent(s));
  }
  var S = class {
      type;
      sourceSpan;
      ...
      prop(e, n) {
        return new ft(this, e, null, n);
      }
      key(e, n, s) {
        return new dt(this, e, n, s);
      }
      callFn(e, n, s) {
        return new lt(this, e, null, n, s);
      }
      instantiate(e, n, s) {
        return new ct(this, e, n, s);
      }
      conditional(e, n = null, s) {
        return new ht(this, e, n, null, s);
      }
      equals(e, n) {
  ...
  var Tn = class t {
    ...
    keyOf(e) {
      ...
      if (e instanceof ut) return `/${e.body}/${e.flags ?? ""}`;
      if (e instanceof mt) {
        let n = [];
        ...
        for (let s of e.entries)
          if (s instanceof gt) n.push("..." + this.keyOf(s.expression));
          else {
            let i = s.key;
        ...
        if (e instanceof ot) return `read(${e.name})`;
        if (e instanceof at) return `typeof(${this.keyOf(e.expr)})`;
        if (e instanceof xt) return `...${this.keyOf(e.expression)}`;
        throw new Error(
  ...
  var bt = class extends Se {
    ...
    O = class extends g {
      ...
      constructor(e, n, s, i, r) {
        (super(
          new X(0, n === null ? 0 : n.length),
          new $(i, n === null ? i : i + n.length),
        ),
          (this.ast = e),
          (this.source = n),
          (this.location = s),
  ...
  var Dt = 96;
  function Zi(t) {
    return (t >= as && t <= ls) || t == ms;
  }
  function W(t) {
    return Hi <= t && t <= Wi;
  }
  function Bt(t) {
    return (t >= fs && t <= ds) || (t >= jt && t <= zt);
  }
  function Rn(t) {
    return t === us || t === cs || t === Dt;
  }
  var Ue = class t {
      file;
      offset;
...
` && ++u == n
  ...
  var Ce = class extends Error {
    ...
    contextualMessage() {
      ...
      return e
        ? `${this.msg} ("${e.before}[${qe[this.level]} ->]${e.after}")`
        : this.msg;
    }
    toString() {
  ...
  var er = "(:(where|is)\\()?";
  var gs = "-shadowcsshost",
    tr = "-shadowcsscontext",
    Ot = "[^)(]*",
    nr = `(?:\\(${Ot}\\)|${Ot})+?`,
    sr = `(?:\\(${nr}\\)|${Ot})+?`,
    Gt = `(?:\\((${sr})\\))`,
    to = new RegExp("(:nth-[-\\w]+)" + Gt, "g"),
    no = new RegExp(gs + Gt + "?([^,{]*)", "gim"),
    ir = tr + Gt + "?([^{]*)",
    so = new RegExp(`${er}(${ir})`, "gim"),
    rr = gs + "-no-combinator",
    io = new RegExp(`${rr}(?![^(]*\\))`, "g");
  var vs = "%COMMENT%",
    ro = new RegExp(vs, "g");
  ...
  var or = "%COMMA_IN_PLACEHOLDER%",
    ar = "%SEMI_IN_PLACEHOLDER%",
    lr = "%COLON_IN_PLACEHOLDER%",
    ao = new RegExp(or, "g"),
    lo = new RegExp(ar, "g"),
    co = new RegExp(lr, "g");
  var f;
  ...
  var cr = Symbol("ConsumesSlot"),
    xs = Symbol("DependsOnSlotContext"),
    Te = Symbol("ConsumesVars"),
    Xt = Symbol("UsesVarOffset"),
    uo = { [cr]: !0, numSlotsUsed: 1 },
    po = { [xs]: !0 },
    ho = { [Te]: !0 };
  var je = class {
    strings;
  ...
  var Xn = class t extends re {
    ...
    transformInternalExpressions(e, n) {
      this.body !== null
        ? (this.body = (this.body, n | Ft.InChildOperation, void 0))
    ...
    clone() {
      ...
      return (
        (e.fn = this.fn?.clone() ?? null),
        (e.varOffset = this.varOffset),
        e
      );
    }
  };
  var Jn = class t extends re {
      target;
      targetSlot;
      name;
      args;
...
\r	\v\u1680\u180E\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF`,
  ...
  var Ae = new A(-1, -1, h.Character, 0, ""),
    Vt = class {
      ...
      advance() {
        this.peek =
          ++this.index >= this.length ? pe : this.input.charCodeAt(this.index);
      }
      scanToken() {
        let e = this.input,
          n = this.length,
        ...
        if (es(s)) return this.scanIdentifier();
        ...
        switch (s) {
                ...
                : this.peek !== H
                  ...
                  : (this.advance(),
                    this.peek === H
                      ...
                      : this.error(
                          `Unexpected character [${String.fromCharCode(s)}]`,
                          0,
                        ))
            );
          case ve:
          ...
          case Nn:
            return this.scanComplexOperator(r, "&", Nn, "&", k, "=");
          case Mn:
            return this.scanComplexOperator(r, "|", Mn, "|", k, "=");
          case ms:
            for (; Zi(this.peek); ) this.advance();
      ...
      scanCloseBrace(e, n) {
        return (
          ...
          this.braceStack.pop() === "interpolation"
            ? (this.tokens.push(he(e, this.index, K)),
      ...
      scanIdentifier() {
        let e = this.index;
        for (this.advance(); ts(this.peek); ) this.advance();
        let n = this.input.substring(e, this.index);
        return hr.indexOf(n) > -1 ? mr(e, this.index, n) : fr(e, this.index, n);
      }
      scanPrivateIdentifier() {
        let e = this.index;
        if ((this.advance(), !es(this.peek)))
          return this.error("Invalid character [#]", -1);
        for (; ts(this.peek); ) this.advance();
        let n = this.input.substring(e, this.index);
        return dr(e, this.index, n);
      }
      scanNumber(e) {
        let n = this.index === e,
          s = !1;
        for (this.advance(); ; ) {
          if (!W(this.peek))
            ...
            else if (Sr(this.peek)) {
              if (
                (this.advance(), Er(this.peek) && this.advance(), !W(this.peek))
              )
        ...
        s && (i = i.replace(/_/g, ""));
        let r = n ? Cr(i) : parseFloat(i);
        return gr(e, this.index, r);
      }
      scanString() {
        let e = this.index,
          n = this.peek;
      ...
      scanTemplateLiteralPart(e) {
              ...
              return (
                ...
                this.tokens.push(
                  new xe(
                    e,
                    r,
                    n + this.input.substring(s, r),
                    F.TemplateLiteralPart,
                  ),
                ),
                this.advance(),
        ...
        return (
          this.advance(),
          new xe(e, this.index, n + i, F.TemplateLiteralEnd)
        );
      }
      error(e, n) {
        let s = this.index + n;
      ...
      scanStringBackslash(e, n) {
        ...
        } else ((s = yr(this.peek)), this.advance());
      ...
      isStartOfRegex() {
        ...
        if (e.isOperator("!")) {
          let n =
            this.tokens.length > 1 ? this.tokens[this.tokens.length - 2] : null;
          return (
            n === null ||
            (n.type !== h.Identifier && !n.isCharacter(q) && !n.isCharacter(G))
          );
        }
        return (
          e.type === h.Operator ||
      ...
      scanRegex(e) {
        ...
        this.advance();
        let a = xr(e, this.index, r),
          u = this.scanRegexFlags(this.index);
        return u !== null ? (this.tokens.push(a), u) : a;
      }
      scanRegexFlags(e) {
        if (!Bt(this.peek)) return null;
        for (; Bt(this.peek); ) this.advance();
        return wr(e, this.index, this.input.substring(e, this.index));
      }
    };
  function es(t) {
    return (fs <= t && t <= ds) || (jt <= t && t <= zt) || t == Xe || t == qt;
  }
  function ts(t) {
    return Bt(t) || W(t) || t == Xe || t == qt;
  }
  function Sr(t) {
    return t == zi || t == qi;
  }
  ...
  var oe = class {
      ...
      parseTemplateBindings(e, n, s, i, r) {
        ...
        return new z(
          ...
          0,
          this._supportsDirectPipeReferences,
        ).parseTemplateBindings({ source: e, span: new $(i, i + e.length) });
      }
      ...
      splitInterpolation(e, n, s, i) {
        ...
        for (; d < e.length; )
          if (w) {
            ...
            (r.push({ text: V, start: y, end: d }), (w = !0));
          }
        if (!w)
          if (D) {
            let y = r[r.length - 1];
      ...
      _stripComments(e) {
        ...
        return n != null
          ? { stripped: e.substring(0, n), hasComments: !0 }
          : { stripped: e, hasComments: !1 };
      }
      _commentStart(e) {
        let n = null;
      ...
      _checkNoInterpolation(e, n, s) {
        ...
        for (let a of this._forEachUnquotedChar(n, 0))
          ...
          else if (((r = this._getInterpolationEndIndex(n, "}}", a)), r > -1))
            break;
        i > -1 &&
          r > -1 &&
          e.push(
      ...
      *_forEachUnquotedChar(e, n) {
        ...
        for (let r = n; r < e.length; r++) {
          let a = e[r];
          (Rn(e.charCodeAt(r)) && (s === null || s === a) && i % 2 === 0
            ? (s = s === null ? a : null)
            : s === null && (yield r),
            (i = a === "\\" ? i + 1 : 0));
        }
  ...
  var ns = new Set(["d", "g", "i", "m", "s", "u", "v", "y"]),
    z = class {
      input;
      parseSourceSpan;
      absoluteOffset;
      ...
      parseChain() {
        ...
        return e.length == 1
          ? e[0]
          : new Ct(this.span(n), this.sourceSpan(n), e);
      }
      parsePipe() {
        ...
        if (this.consumeOptionalOperator("|")) {
          ...
          do {
            ...
            if (this.supportsDirectPipeReferences) {
              ...
              p =
                d === Xe || (d >= jt && d <= zt)
                  ? me.ReferencedDirectly
                  : me.ReferencedByName;
            } else p = me.ReferencedByName;
            n = new bt(this.span(e), this.sourceSpan(e, a), n, i, u, p, r);
      ...
      parseConditional() {
        ...
        if (this.consumeOptionalOperator("?")) {
          ...
          return new _t(this.span(e), this.sourceSpan(e), n, s, i);
        } else return n;
      }
      parseLogicalOr() {
        let e = this.inputIndex,
          ...
          switch (n) {
            ...
            case "!":
              return (
                this.advance(),
                (s = this.parsePrefix()),
                new Me(this.span(e), this.sourceSpan(e), s)
              );
          }
      ...
      parseCallChain() {
        ...
        for (;;)
          ...
          else if (this.consumeOptionalCharacter(te))
            n = this.parseKeyedReadOrWrite(n, e, !1);
          else if (this.consumeOptionalCharacter(ve))
            n = this.parseCall(n, e, !1);
          else if (this.consumeOptionalOperator("!"))
            n = new Pt(this.span(e), this.sourceSpan(e), n);
      ...
      parsePrimary() {
        ...
        if (this.consumeOptionalCharacter(ve)) {
          ...
          if (this.next.isKeywordNull())
            return (
              this.advance(),
              new I(this.span(e), this.sourceSpan(e), null)
            );
          if (this.next.isKeywordUndefined())
            return (
              this.advance(),
              new I(this.span(e), this.sourceSpan(e), void 0)
            );
          if (this.next.isKeywordTrue())
            return (
              this.advance(),
              new I(this.span(e), this.sourceSpan(e), !0)
            );
          if (this.next.isKeywordFalse())
            return (
              this.advance(),
              new I(this.span(e), this.sourceSpan(e), !1)
            );
          if (this.next.isKeywordIn())
            return (
              this.advance(),
              new I(this.span(e), this.sourceSpan(e), "in")
            );
          if (this.next.isKeywordThis())
            return (this.advance(), new yt(this.span(e), this.sourceSpan(e)));
          if (this.consumeOptionalCharacter(te))
          ...
          if (this.next.isIdentifier())
            return this.parseAccessMember(
              new ne(this.span(e), this.sourceSpan(e)),
              e,
              !1,
            );
          if (this.next.isNumber()) {
            ...
            if (this.next.isString() && this.next.kind === F.Plain) {
              ...
              return (
                this.advance(),
                new I(this.span(e), this.sourceSpan(e), n)
              );
            } else
              return this.next.isPrivateIdentifier()
                ...
                : this.next.isRegExpBody()
                  ...
                  : this.index >= this.tokens.length
                    ? (this.error(
                        `Unexpected end of expression: ${this.input}`,
                      ),
                      new b(this.span(e), this.sourceSpan(e)))
      ...
      parseLiteralArray(e) {
        ...
        return (
          ...
          new At(this.span(e), this.sourceSpan(e), n)
        );
      }
      parseLiteralMap() {
        let e = [],
            ...
            (e.push(d),
              r
                ...
                : this.consumeOptionalCharacter(j)
                  ? n.push(this.parsePipe())
                  : ((d.isShorthandInitialized = !0),
                    n.push(new de(u, p, p, new ne(u, p), a))));
          } while (
            this.consumeOptionalCharacter(Q) &&
            !this.next.isCharacter(K)
          );
          (this.rbracesExpected--, this.expectCharacter(K));
        }
        return new Nt(this.span(s), this.sourceSpan(s), e, n);
      }
      parseAccessMember(e, n, s) {
        ...
        if (s)
          return this.isAssignmentOperator(this.next)
            ...
            : new Tt(this.span(n), this.sourceSpan(n), a, e, r);
      ...
      parseCall(e, n, s) {
        ...
        let u = this.span(n),
          p = this.sourceSpan(n);
        return s ? new Mt(u, p, e, r, a) : new Lt(u, p, e, r, a);
      }
      parseCallArguments() {
      ...
      parseKeyedReadOrWrite(e, n, s) {
        return this.withContext(Z.Writable, () => {
          ...
          if (
            ...
            return s
              ? new kt(this.span(n), this.sourceSpan(n), e, i)
      ...
      getDirectiveBoundTarget() {
        if (this.next === Ae || this.peekKeywordAs() || this.peekKeywordLet())
          return null;
        let e = this.parsePipe(),
          { start: n, end: s } = e.span,
          i = this.input.substring(n, s);
        return new O(
          e,
          i,
      ...
      error(e, n = this.index) {
        (this.errors.push(
          ee(e, this.input, this.getErrorLocationText(n), this.parseSourceSpan),
        ),
          this.skip());
      }
  ...
  var Tr = new Map(
    ...
    yo = Array.from(Tr).reduce((t, [e, n]) => (t.set(e, n), t), new Map());
  var Co = new oe(new _e());
  function P(t) {
    return (e) => e.kind === t;
  }
  function we(t, e) {
  ...
  function kr(t) {
    return (
      ...
      !(t.expression instanceof je)
    );
  }
  var _o = [
      { test: P(f.StyleMap), transform: ze },
      { test: P(f.ClassMap), transform: ze },
      { test: P(f.StyleProp) },
      { test: P(f.ClassProp) },
      { test: we(f.Attribute, !0) },
      { test: we(f.Property, !0) },
      { test: kr },
      { test: we(f.Attribute, !1) },
      { test: P(f.Control) },
    ],
    To = [
      { test: we(f.DomProperty, !0) },
      { test: we(f.DomProperty, !1) },
      { test: P(f.Attribute) },
      { test: P(f.StyleMap), transform: ze },
      { test: P(f.ClassMap), transform: ze },
      { test: P(f.StyleProp) },
  ...
  var Ao = [l.pipeBind1, l.pipeBind2, l.pipeBind3, l.pipeBind4];
  var Io = {
    constant: [
      l.interpolate,
      l.interpolate1,
  ...
  var Ro = Symbol("queryAdvancePlaceholder");
  var is;
  (function (t) {
  ...
  var Bo = new Et("21.1.0");
  var br = "test.html";
  function Es(t) {
    let e = new He(t, br),
      n = new Ue(e, 0, 0, 0),
      s = n.moveBy(t.length);
    return { text: t, file: e, start: n, end: s, sourceSpan: new We(n, s) };
  }
  var Ar;
  function ys() {
    return Ar ?? (Ar = new oe(new _e()));
  }
  var Ir = (t) => oe.prototype._commentStart(t);
  function Nr(t) {
    let e = Ir(t);
    return e === null
      ? []
  ...
  function Cs(t) {
    ...
    if (e.errors.length !== 0) {
      ...
      let i = t.start;
      {
        ...
        a &&
          ((s = s.slice(0, a.index)), (i = i.moveBy(Number(a.groups.index))));
      }
      let r = new SyntaxError(s.trim(), { cause: n });
      throw (
        Object.assign(r, { location: i, span: n.span }),
        r.cause ?? (r.cause = n),
        r
      );
    }
  ...
  var Je = (t) => (e) => {
      let n = Es(e);
      return Cs({ ...n, result: ys()[t](e, n.sourceSpan, 0), comments: Nr(e) });
    },
    _s = Je("parseAction"),
    Ts = Je("parseBinding"),
    ks = Je("parseSimpleBinding"),
    bs = Je("parseInterpolationExpression"),
    As = (t) => {
      let e = Es(t);
      return Cs({
        ...e,
        result: ys().parseTemplateBindings("", t, e.sourceSpan, 0, 0),
        comments: [],
      });
    };
  var Ye = class {
  ...
  var Is = Object.defineProperty,
    Ns = (t, e) => {
      let n = {};
      for (var s in t) Is(n, s, { get: t[s], enumerable: !0 });
      return (e && Is(n, Symbol.toStringTag, { value: "Module" }), n);
    };
  var Ps = (t, e) => ({
    type: "ArrayExpression",
    elements: e.transformChildren(t.expressions),
  });
  var Ls = (t, e) => e.transformChild(t.ast);
  var Pr = (t) => t === "&&" || t === "||" || t === "??",
    Ms = (t, e) => {
      let { operation: n } = t,
        [s, i] = e.transformChildren([t.left, t.right]);
      return Pr(n)
        ? { type: "LogicalExpression", operator: n, left: s, right: i }
        : E.isAssignmentOperation(n)
          ? { type: "AssignmentExpression", left: s, right: i, operator: n }
          : { left: s, right: i, type: "BinaryExpression", operator: n };
    };
  var Lr = { optional: !1 },
    Mr = { optional: !0 },
    Rs =
      ...
      (e, n) => {
        ...
        return t || ue(i)
          ...
          : { type: "CallExpression", callee: i, arguments: s };
      },
    $s = Rs(Lr),
    Ds = Rs(Mr);
  var Bs = (t, e) => ({
  ...
  var Vs = (t) => {
      ...
      switch (typeof e) {
        ...
        default:
          throw new Error(
            `Unexpected 'LiteralPrimitive' value type ${typeof e}`,
          );
      }
    },
    Us = (t) => ({
  ...
  var Rr = { computed: !0, optional: !1 },
    $r = { computed: !0, optional: !0 },
    Dr = { computed: !1, optional: !1 },
    Br = { computed: !1, optional: !0 },
    Qe =
      ...
      (n, s) => {
        ...
        return e || ue(a)
          ...
          : { type: "MemberExpression", property: r, object: a, computed: t };
      },
    Hs = Qe(Rr),
    Ws = Qe($r),
    qs = Qe(Dr),
  ...
  var Gs = (t, e) => {
    ...
    return {
      ...
      properties: n.map((r, a) => {
        ...
        if (r.kind === "spread")
          return i({ type: "SpreadElement", argument: e.transformChild(u) }, p);
        ...
        return i(
          {
            ...
            key: i(
              r.quoted
                ? { type: "StringLiteral", value: r.key }
                : { type: "Identifier", name: r.key },
              r.sourceSpan,
            ),
  ...
  var Xs = (t, e) => e.transformChild(t.expression);
  var Js = (t, e) => ({
    type: "NGPipeExpression",
    left: e.transformChild(t.exp),
    right: e.create({ type: "Identifier", name: t.name }, t.nameSpan),
  ...
  var Qs = (t, e) => ({
    ...
    Zs = (t, e) => {
      ...
      return {
        ...
        value: { cooked: t.text, raw: d },
        tail: a,
        range: [p, u],
      };
    };
  var ei = () => ({ type: "ThisExpression" });
  var Jt = (t) => (e, n) => ({
  ...
  var Or = (t) => {
    ...
    ri = Or;
  var oi = Ns({
    visitASTWithSource: () => Ls,
    visitBinary: () => Ms,
    visitCall: () => $s,
    visitChain: () => Bs,
    visitConditional: () => Os,
    visitImplicitReceiver: () => ri,
    visitInterpolation: () => Fs,
    visitKeyedRead: () => Hs,
    visitLiteralArray: () => Ps,
    visitLiteralMap: () => Gs,
    visitLiteralPrimitive: () => Vs,
    visitNonNullAssert: () => zs,
    visitParenthesizedExpression: () => Xs,
    visitPipe: () => Js,
    visitPrefixNot: () => ti,
    visitPropertyRead: () => qs,
    visitRegularExpressionLiteral: () => Us,
    visitSafeCall: () => Ds,
    visitSafeKeyedRead: () => Ws,
    visitSafePropertyRead: () => js,
    visitSpreadElement: () => Ys,
    visitTaggedTemplateLiteral: () => Qs,
    visitTemplateLiteral: () => Ks,
    visitTemplateLiteralElement: () => Zs,
    visitThisReceiver: () => ei,
    visitTypeofExpression: () => ni,
    visitUnary: () => ii,
    visitVoidExpression: () => si,
  });
  var ai = oi;
  var Ke = class Yt extends Ye {
    node;
    ancestors;
    ...
    create(e, n, s = this.ancestors) {
      return (
        s[0] instanceof Ee && (e.extra = { ...e.extra, parenthesized: !0 }),
    ...
    transform() {
      ...
      let n = e.visit(ai, this);
      return this.create(n, this.node);
    }
    static transform(e, n) {
      return new Yt({ node: e, text: n, ancestors: [] }).transform();
    }
  };
  var li = class extends Ke {
    constructor(t) {
      super({ node: t, text: t.source });
    }
  };
  var ci = (t, e) => Ke.transform(t, e),
    ui = (t) => new li(t).transform();
  var pi =
    (t, e) =>
    (n, s, ...i) =>
    ...
    Ur =
      ((le = class extends Ye {
        constructor(n, s) {
          ...
          ke(this, ae);
          ke(this, J);
          (it(this, ae, n), it(this, J, s));
          for (let i of n) v(this, m, gi).call(this, i);
        }
        get expressions() {
          return v(this, m, xi).call(this);
        }
      }),
      (ae = new WeakMap()),
      (J = new WeakMap()),
      ...
      (C = function (n, s) {
        return un(le.prototype, this, "createNode").call(this, n, s);
      }),
      (Qt = function (n) {
        return ci(n, this.text);
      }),
      (Kt = function (n) {
        return fn(n.slice(U(this, m, mi).source.length));
      }),
      (Zt = function (n) {
        let s = U(this, J);
      ...
      (gi = function (n) {
        (v(this, m, Zt).call(this, n.key.span),
          di(n) && n.value && v(this, m, Zt).call(this, n.value.span));
      }),
      (vi = function (n) {
      ...
      (xi = function () {
        let n = U(this, ae),
          [s] = n,
          i =
            U(this, J).slice(s.sourceSpan.start, s.sourceSpan.end).trim()
              .length === 0
              ? n.slice(1)
              : n,
          r = [],
        ...
        for (let [u, p] of i.entries()) {
          if (
            ...
            di(p) &&
            p.value &&
            p.value.source === a.key.source
          ) {
            let d = v(this, m, C).call(
                this,
                { type: "NGMicrosyntaxKey", name: p.key.source },
                p.key.span,
              ),
              w = (T, y) => ({
                ...T,
                ...this.transformSpan({ start: T.start, end: y }),
              }),
              D = (T) => ({ ...w(T, d.end), alias: d }),
              _ = r.pop();
          ...
          } else r.push(v(this, m, wi).call(this, p, u));
          a = p;
        }
        return v(this, m, C).call(
          this,
          { type: "NGMicrosyntax", body: r },
          r.length === 0
            ? n[0].sourceSpan
            : { start: r[0].start, end: hi(0, r, -1).end },
        );
      }),
      (wi = function (n, s) {
        if (fi(n)) {
            ...
            ? s === 0
              ? v(this, m, C).call(
                  this,
                  {
                    ...
                    expression: v(this, m, Qt).call(this, r.ast),
                    alias: null,
                  },
                  r,
                )
                  ...
                  this,
                  {
                    ...
                    key: v(this, m, C).call(
                      this,
                      {
                        ...
                        name: v(this, m, Kt).call(this, i.source),
                      },
                      i.span,
                    ),
          ...
          if (/^let\s$/.test(U(this, J).slice(r.start, r.start + 4))) {
            ...
            return v(this, m, C).call(
              this,
              {
                ...
                key: v(this, m, C).call(
                  this,
                  { type: "NGMicrosyntaxKey", name: i.source },
                  i.span,
                ),
                value: a
                  ? v(this, m, C).call(
                      this,
                      { type: "NGMicrosyntaxKey", name: a.source },
                      a.span,
                    )
                  : null,
              },
      ...
      le);
  function Si(t, e) {
    return new Ur(t, e).expressions;
  }
  var Ze = (t) => (e) => {
      let { result: n, comments: s } = t(e);
      return Object.assign(ui(n), { comments: s });
    },
    et = Ze(_s),
    en = Ze(Ts),
    Hr = Ze(ks),
    tn = Ze(bs),
    nn = (t) => Si(As(t).result.templateBindings, t);
  function sn(t) {
    let e = t.range?.[0] ?? t.start,
      n = (t.declaration?.decorators ?? t.decorators)?.[0];
    return n ? Math.min(sn(n), e) : e;
  }
  function Ei(t) {
      ...
      parse(e) {
        ...
        return (
          ...
          t === et &&
            ...
            (n = { ...n, type: "NGChainedExpression", expressions: [n] }),
          { type: "NGRoot", node: n, comments: s }
        );
      },
      locStart: sn,
      locEnd: Ei,

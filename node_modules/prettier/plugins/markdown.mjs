  ...
  function rD(e, r) {
    ...
    function p(b, d, y) {
      ...
      if (d.charCodeAt(B++) === je && d.charCodeAt(B++) === hr) {
        for (P = B; B < T; ) {
          if (
            ((O = d.charCodeAt(B)), O !== O || O === Wr || O === pr || O === Ve)
          )
            return;
          if (O === St) {
            ((N = B), B++);
    ...
    function h(b, d, y) {
      ...
      if (d.charCodeAt(C++) === je && d.charCodeAt(C++) === hr) {
        for (T = C; C < w; ) {
          if (
            ((_ = d.charCodeAt(C)), _ !== _ || _ === Wr || _ === pr || _ === Ve)
          )
            return;
          if (_ === St) {
            ((B = C), C++);
              ...
              : ((v = o.slice(F, g + 1)),
                a(o.slice(0, E))({
                  ...
                  data: {
                    hName: "span",
                    hProperties: {
                      className: sD.concat(c && r.inlineMathDouble ? [nu] : []),
                    },
  ...
  function wD(e) {
    ...
    function i(a) {
      ...
      if (a > -1 && a < t[t.length - 1]) {
        for (; ++o < t.length; )
          if (t[o] > a)
            return { line: o + 1, column: a - (t[o - 1] || 0) + 1, offset: a };
      }
      return {};
    }
    function u(a) {
  ...
  function Op() {
    ...
    return (
      ...
      (i = {
        ...
        position: { start: t, end: e.eof || Aa(t) },
      }),
    ...
    if (i) {
      ...
      if (((v = a), (c = r.charAt(a)), !(c !== Yp && c !== qa))) {
        ...
        if (!(s < Gp)) {
          ...
          for (
            f = "", p = "";
            a < u && ((c = r.charAt(a)), !(c === et || (l === qa && c === l)));
          )
...
var nn = x((Sv, Ha) => {
  ...
  function sh(e) {
    for (
      ...
      for (
        u = n === $a ? oh : ah, t += u, u > 1 && (t = Math.floor(t / u) * u);
        a < t;
      )
        i[++a] = r;
      n = e.charAt(++r);
...
`,
  ...
  function kh(e, r, t) {
    for (
      ...
      s++;
    if (((p = r.charAt(s)), p === un || p === Za || p === an))
      ((h = p), (m = !1));
    else {
      for (m = !0, D = ""; s < l && ((p = r.charAt(s)), !!Qa(p)); )
        ((D += p), s++);
      if (
        ((p = r.charAt(s)),
        !D || !(p === eo || (i && p === ro)) || (t && D !== "1"))
    ...
    if (((f = r.charAt(u)), f === Dn)) {
      ...
      if (!(!c || r.charAt(u) !== vr || r.charAt(u + 1) !== Eo)) {
        ...
        if (c) {
          ...
          for (; u < a && ((f = r.charAt(u)), !(f !== nt && f !== it)); )
            ((o += f), u++);
  ...
  function gn(e, r, t) {
    ...
    if (r.charAt(0) === Ro) {
      for (
        ...
        ((o += c), a++);
      if (o) {
        if (((l += o), (o = ""), (c = r.charAt(a)), (l += c), a++, c === Mo))
          s = !0;
        else {
          if (c !== ":" || r.charAt(a + 1) !== mn) return;
          ((l += mn), a++);
        }
        for (; a < u && ((c = r.charAt(a)), !(Lo(c) || c === dn)); )
          ((o += c), a++);
...
var rs = x((e2, es) => {
  ...
  function Zo(e, r) {
    ...
    if (((i = n), i === r || !Qo(e.charCodeAt(i - 1))))
      return Zo.call(t, e, n + 1);
...
var ss = x((t2, os) => {
  ...
  function as(e, r, t) {
    ...
    if (
      !(r.charAt(0) !== v0 || i < 3) &&
      ((u = r.charAt(1)),
      !(!g0(u) && u !== A0 && u !== b0 && u !== x0) && ((a = r.match(C0)), !!a))
    )
      return t
        ? !0
        : ((a = a[0]),
            ...
            o !== i &&
              (c && i && (hc(i) || (u = pc(i)))
                ? (u
                    ? ((u = !1), (a = n && pc(n) ? n : []))
                    : (a = n && hc(n) ? n : {}),
                  dc(o, { name: t, newValue: e(c, a, i) }))
                : typeof i < "u" && dc(o, { name: t, newValue: i })));
    return o;
  };
});
var vc = x((b2, Cc) => {
  ...
  function wc() {
    ...
    function t() {
      ...
      function o(s) {
        ...
        ((u = f),
          l ? yc(l, o).apply(null, u) : a.apply(null, [null].concat(u)));
      }
    }
    function n(i) {
...
var Sc = x((rr) => {
  ...
  function Am(e, r) {
    ...
    if (
      (wr(e), (i = e.length), r === void 0 || !r.length || r.length > e.length)
    ) {
      for (; i--; )
...
var el = x((N2, Zc) => {
  ...
  function Qc() {
    ...
    function f(F, g, E) {
      if (
        (Kc(F), a(), !E && typeof g == "function" && ((E = g), (g = null)), !E)
      )
...
var si = Object.freeze({ character: "'", codePoint: 39 }),
  ci = Object.freeze({ character: '"', codePoint: 34 }),
  Jl = Object.freeze({ preferred: si, alternate: ci }),
  Ql = Object.freeze({ preferred: ci, alternate: si });
function Zl(e, r) {
...
function ye(e, r) {
  return (function t(n, i, u) {
    let a = { ...r(n, i, u) };
    return (
      a.children && (a.children = a.children.map((o, s) => t(o, s, [a, ...u]))),
      a
    );
  })(e, null, []);
}
  ...
  return (
    e.each(() => {
      ...
      a !== !1 &&
        (u.length > 0 &&
          Cf(e) &&
          (u.push(M), (Af(e, r) || qi(e)) && u.push(M), qi(e) && u.push(M)),
        u.push(a));
    }, "children"),
    u
  );
...
function Pf(e) {
  return ye(e, (r, t, [n]) => {
    ...
    return (
      ...
      { type: "sentence", position: r.position, children: Mr(i) }
    );
  });
}
function If(e, r) {
...
`,
    ...
    case "definition": {
      ...
      return Ge([
        Pt(n),
        ":",
        ir([i, Nt(n.url), n.title === null ? "" : [i, zr(n.title, r, !1)]]),
      ]);
    }
    case "footnote":
      return ["[^", z(e, r, t), "]"];
        ...
        i
          ...
          : Ge([
              Fe(
                " ".repeat(4),
                z(e, r, t, {
                  processor: ({ isFirst: u }) => (u ? Ge([Nr, t()]) : t()),
                }),
              ),
            ]),
      ];
...
function ml({ isMDX: e }) {
  return (r) => {
    let t = (0, dl.default)()
      .use(hl.default, { commonmark: !0, ...(e && { blocks: [rl] }) })
      .use(Dl.default)
      .use(ol)
      .use(pl.default)
      .use(e ? al : fl)
...
var Fl = {
  ...
  cF = { ...Fl, parse: ml({ isMDX: !1 }) },
  lF = { ...Fl, parse: ml({ isMDX: !0 }) };
var fF = { mdast: Hi };
export {
  gl as default,
  Ki as languages,

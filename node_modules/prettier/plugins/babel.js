...
- Did you mean \`import { "${a}" as foo }\`?`,
  ...
  var { defineProperty: hi } = Object,
    Bt = (a, t) => {
      a && hi(a, t, { enumerable: !1, value: a[t] });
    };
  function ne(a) {
  ...
  var ci = (a) =>
      class extends a {
        ...
        estreeParseChainExpression(e, s) {
          ...
          return (
            (i.expression = e),
            this.finishNodeAt(i, "ChainExpression", s)
          );
        }
        directiveToStmt(e) {
          let s = e.value;
  ...
  function P(a, t = {}) {
    return (
      ...
      yt.push(a),
      xt.push(t.binop ?? -1),
      Pt.push(t.beforeExpr ?? !1),
      gt.push(t.startsExpr ?? !1),
      Tt.push(t.prefix ?? !1),
      mt.push(new we(a, t)),
      pe
    );
  ...
  var pi = {
    ...
    incDec: P("++/--", { prefix: j, postfix: li, startsExpr: m }),
    ...
    _do: S("do", { isLoop: _e, beforeExpr: T }),
      ...
      class extends a {
        ...
        flowParseDeclareExportDeclaration(e, s) {
          ...
          if (
            ...
            throw this.raise(
              ...
              this.state.startLoc,
              { unsupportedExportKind: i, suggestion: Oi[i] },
            );
          }
          if (
            this.match(74) ||
        ...
        getArrowLikeExpressions(e, s) {
          ...
          return s
            ...
            : Fi(r, (n) => n.params.every((o) => this.isAssignable(o, !0)));
        }
        ...
        checkGetterSetterParams(e) {
          ...
          if (s.length > 0) {
            ...
            this.isThisParam(i) && e.kind === "get"
              ...
              : this.isThisParam(i) &&
                this.raise(g.SetterMayNotHaveThisParam, i);
          }
        }
...
`))
        ...
        jsxParseElementAt(e) {
          ...
          if (
            ...
            throw this.raise(
              U.UnwrappedAdjacentJSXElements,
              this.state.startLoc,
            );
          return V(r)
    ...
    Xe = class extends fe {
      importsStack = [];
      createScope(t) {
        return (this.importsStack.push(new Set()), new Ge(t));
      }
      enter(t) {
  ...
  var Ze = class extends Qe {
      ...
      finalizeComment(t) {
        ...
        if (t.leadingNode !== null || t.trailingNode !== null)
          (t.leadingNode !== null && is(t.leadingNode, e),
            t.trailingNode !== null && Vi(t.trailingNode, e));
        else {
    ...
    et = class a {
      ...
      clone() {
        ...
        return (
          ...
          (t.firstInvalidTemplateEscapePos =
...
`);
      ...
      case 120: {
        let l;
        return (
          ({ code: l, pos: t } = tt(a, t, e, s, 2, !1, n, r)),
  ...
  function as(a, t, e, s, i, r) {
    ...
    if (n === 123) {
      if (
        (++t,
        ({ code: o, pos: t } = tt(a, t, e, s, a.indexOf("}", t) - t, !0, i, r)),
        ++t,
        o !== null && o > 1114111)
      )
  ...
  var Ki = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
    st = class {
      constructor(t) {
    ...
    it = class extends Ze {
      ...
      next() {
        (this.checkKeywordEscapes(),
          this.optionFlags & 256 && this.pushToken(new st(this.state)),
    ...
    at = class {
      ...
      declarePrivateName(t, e, s) {
        ...
        (o &&
          this.parser.raise(p.PrivateNameRedeclaration, s, {
            identifierName: t,
          }),
          i.add(t),
          n.delete(t));
    ...
    nt = class {
      ...
      recordAsyncArrowParametersError(t) {
        ...
        for (; i.canBeArrowParameterDeclaration(); )
          (i.type === 2 &&
            i.recordDeclarationError(p.AwaitBindingIdentifier, t),
            (i = e[--s]));
      }
      validateAsPattern() {
        let { stack: t } = this,
  ...
  var ot = class extends it {
    ...
    ct = (a) => (a.type === "ParenthesizedExpression" ? ct(a.expression) : a),
    lt = class extends ht {
      toAssignable(t, e = !1) {
        let s;
        switch (
      ...
      checkIdentifier(t, e, s = !1) {
        (this.state.strict &&
          (s ? ss(t.name, this.inModule) : ts(t.name)) &&
          (e === 64
  ...
  var Qi = (a) =>
    class extends a {
      ...
      parseBindingElement(e, s) {
        ...
        !(e & 4) &&
          (n || h || o) &&
          this.raise(y.UnexpectedParameterModifier, i);
      ...
      parsePostMemberNameModifiers(e) {
        (this.eat(17) && (e.optional = !0),
          e.readonly &&
            this.match(10) &&
            this.raise(y.ClassMethodHasReadonly, e),
          e.declare &&
            this.match(10) &&
            this.raise(y.ClassMethodHasDeclare, e));
      }
      shouldParseExportDeclaration() {
        return this.tsIsDeclarationStart()
          ? !0
    ...
    sr = (a) =>
      class extends a {
        ...
        chStartsBindingIdentifier(e, s) {
          ...
          return (
            this.input.charCodeAt(i) === 37 &&
            this.input.charCodeAt(i + 1) === 37
          );
        }
        ...
        assertNoSpace() {
          this.state.start >
            this.offsetToSourcePos(this.state.lastTokEndLoc.index) &&
            this.raise(Kt.UnexpectedSpace, this.state.lastTokEndLoc);
        }
      },
    ir = (a) =>
      class extends a {
  ...
  function rr(a) {
    ...
    if (
      a.has("discardBinding") &&
      a.get("discardBinding").syntaxType !== "void"
    )
      throw new Error(
  ...
  var cs = {
    ...
    ut = class extends lt {
      ...
      parseCoverCallAndAsyncArrowHead(t, e, s, i) {
        ...
        (h && (this.expressionScope.enter(Ji()), (n = new Y())),
          l && (o.optional = i),
          i
  ...
  var ft = class extends ut {
      parseTopLevel(t, e) {
        return (
          ...
          this.optionFlags & 256 &&
            (t.tokens = hr(this.tokens, this.input, this.startIndex)),
      ...
      parseStatementContent(t, e) {
        ...
        switch (s) {
          ...
          case 82: {
            ...
            return (
              s === 83
                ? (u = this.parseImport(i))
                : (u = this.parseExport(i, e)),
      ...
      parseImportSpecifier(t, e, s, i, r) {
        if (this.eatContextual(93)) t.local = this.parseIdentifier();
          ...
          let { imported: n } = t;
          if (e)
            throw this.raise(p.ImportBindingIsString, t, {
              importName: n.value,
            });
...
`
  ...
  function dr(a, t) {
    let e = null,
      s = t;
    for (; s !== e; )
      ((e = s), (s = ls(a, s)), (s = us(a, s)), (s = ms(a, s)), (s = ds(a, s)));
    return s;
  }
  var ys = dr;
  function xs(a) {
...
`);
  ...
  var te = Tr;
  var br = te(["Block", "CommentBlock", "MultiLine"]),
    se = br;
  var Ar = te([
      "Line",
      "CommentLine",
...
`);
  ...
  function Mr(a) {
    ...
    return (
      ...
      t.startsWith(vs) && (t = t.slice(vs.length)),
...
`,
    ...
    let s = Object.create(null),
      i = xe(0, a, Ds, "").replace(Ls, "").trimEnd(),
      r;
    for (; (r = Ds.exec(a)); ) {
      let n = xe(0, r[2], _r, "");
  ...
  var Fs = ["noformat", "noprettier"],
    Bs = ["format", "prettier"];
  function Rs(a) {
    let t = ve(a);
    t && (a = a.slice(t.length + 1));
    let e = Ms(a),
      { pragmas: s, comments: i } = Os(e);
  ...
  var ie = (a) => H(Gr(a)),
    ...
    _ = (a, t = Kr) => ({ ...t, plugins: [...t.plugins, ...a] }),
    Hr = /@(?:no)?flow\b/u;
  function Wr(a, t) {
  ...
  function Jr(a, t, e) {
    let s = a(t, e),
      i = s.errors.find((r) => !Xr.has(r.reasonCode));
    if (i) throw i;
    return s;
  }
  function Gr({ isExpression: a = !1, optionsCombinations: t }) {
    return (e, s = {}) => {
      ...
      if (
        ...
        (s.parser === "babel" || s.parser === "__babel_estree") && Wr(e, i))
      )
        return ((s.parser = "babel-flow"), $s.parse(e, s));
      let r = t,
        n = s.__babelSourceType ?? js(i);
      n &&
        n !== Oe &&
        (r = r.map((u) => ({
          ...u,
      ...
      let o = /%[A-Z]/u.test(e);
      e.includes("|>")
        ? (r = (o ? [...zs, Vs] : zs).flatMap((f) => r.map((d) => _([f], d))))
        : o && (r = r.map((u) => _([Vs], u)));
      let h = a ? Ne : Ie,
        l;
      try {
  ...
  var Xr = new Set([
    ...
    qs = [_(["jsx"])],
    Yr = ie({ optionsCombinations: qs }),
    Qr = ie({
      optionsCombinations: [_(["jsx", "typescript"]), _(["typescript"])],
    }),
    Zr = ie({ isExpression: !0, optionsCombinations: [_(["jsx"])] }),
    ea = ie({ isExpression: !0, optionsCombinations: [_(["typescript"])] }),
    $s = ie({

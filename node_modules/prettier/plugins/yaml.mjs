...
var on = (t, e, n) => (
  ...
  xi(
    e || !t || !t.__esModule
      ? sn(n, "default", { value: t, enumerable: !0 })
      : n,
    t,
  )
);
...
`)
      ...
      get jsonLike() {
        return (
          [st.FLOW_MAP, st.FLOW_SEQ, st.QUOTE_DOUBLE, st.QUOTE_SINGLE].indexOf(
            this.type,
          ) !== -1
        );
      }
...
` + this.comment.replace(/^/gm, `${c}#`)),
  ...
  var ue = class extends Q {
    ...
    T = class t extends j {
      ...
      set commentBefore(e) {
        if (
          (this.key == null && (this.key = new x(null)), this.key instanceof j)
        )
...
` && (L = ""),
  ...
  var ct = class extends Q {
    ...
    $t = class extends T {
      constructor(e) {
        if (e instanceof T) {
          let n = e.value;
          (n instanceof ue ||
            ((n = new ue()), n.items.push(e.value), (n.range = e.value.range)),
            super(e.key, n),
            (this.range = e.range));
    ...
    Oo = { defaultType: p.Type.BLOCK_LITERAL, lineWidth: 76 },
    Ao = { trueStr: "true", falseStr: "false" },
    Lo = { asBigInt: !1 },
    To = { nullStr: "null" },
    be = {
...
${a}`
  ...
  function Yo(t, e) {
    ...
    let { comments: n, items: r } =
        e.type === p.Type.FLOW_MAP ? Uo(t, e) : qo(t, e),
      s = new ct();
    ((s.items = r), ss(s, n));
    let i = !1;
...
`
  ...
  function Vo(t, e) {
    ...
    let { comments: n, items: r } =
        e.type === p.Type.FLOW_SEQ ? Ko(t, e) : Wo(t, e),
      s = new ue();
    if (
      ((s.items = r),
      ss(s, n),
  ...
  var G = ce(),
    ...
    jo = {
      ...
      stringify: ({ comment: t, type: e, value: n }, r, s, i) => {
        ...
        if ((e || (e = O.binaryOptions.defaultType), e === G.Type.QUOTE_DOUBLE))
          n = o;
        else {
...
var Kn = ne((bs) => {
  ...
  var la = Vn.concat(
    ...
    fa = { core: ca, failsafe: Vn, json: ws, yaml11: la },
    ua = {
      binary: $.binary,
      bool: ms,
      float: Ss,
...
`) || null;
  ...
  var Qt = class t {
    ...
    listNonDefaultTags() {
      return wa(this.contents).filter(
...
var Ms = ne((Cs) => {
  ...
  function Pa(t, e) {
    let n = Ts(t, e);
    if ((n.warnings.forEach((r) => Ca.warn(r)), n.errors.length > 0))
      throw n.errors[0];
    return n.toJSON();
  }
  function va(t, e) {
...
function dn(t, e, n) {
  return e(
    "children" in t
      ? { ...t, children: t.children.map((r) => dn(r, e, t)) }
      : t,
    n,
  );
}
...
function kt(t, e) {
  let { node: n, root: r } = t,
    s;
  return (
    yn.has(r) ? (s = yn.get(r)) : ((s = new Set()), yn.set(r, s)),
    !s.has(n.position.end.line) &&
    (s.add(n.position.end.line), _r(n, e) && !En(t.parent))
      ? Lt
      : ""
  );
}
      ...
      s.push(
        _(r.type === "sequenceItem" ? 2 : 0, [
          ...
          v(
            N,
            t.map(
              ({ node: c }) => [pn(e.originalText, tt(c)) ? N : "", n()],
              "endComments",
            ),
          ),
        ]),
...
var sr = on(Gn(), 1);
var J = on(Ps(), 1),
  Cf = J.default.findPair,
  Mf = J.default.toJSON,
  kf = J.default.parseMap,
  Pf = J.default.parseSeq,
  vf = J.default.stringifyNumber,
  If = J.default.stringifyString,
  _f = J.default.Type,
  xf = J.default.YAMLError,
  Rf = J.default.YAMLReferenceError,
  vs = J.default.YAMLSemanticError,
  Df = J.default.YAMLSyntaxError,
  $f = J.default.YAMLWarning;
function F(t, e = null) {
...
function Ai(t) {
  ...
  n.setOrigRanges();
  let r = e.map((i) =>
    new sr.default.Document({ merge: !1, keepCstNodes: !0 }).parse(i),
  );
  for (let i of r)

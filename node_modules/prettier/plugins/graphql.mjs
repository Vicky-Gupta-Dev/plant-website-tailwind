...
var de = (e, t) => {
  for (var n in t) pt(e, n, { get: t[n], enumerable: !0 });
};
var ut = {};
de(ut, {
  languages: () => Ye,
...
var Q = class e extends Error {
  constructor(t, ...n) {
    ...
    ((this.source =
      ...
      (this.locations =
        p && u ? p.map((N) => M(u, N)) : O?.map((N) => M(N.source, N.start))));
...
function le(e, t, n) {
  if (!b(n))
    throw h(e.source, t, `Invalid number, expected digit but got: ${R(e, t)}.`);
  let i = e.source.body,
    r = t + 1;
...
var fe = class {
  ...
  expectKeyword(t) {
    ...
    if (n.kind === o.NAME && n.value === t) this.advanceLexer();
      ...
      throw h(this._lexer.source, n.start, `Expected "${t}", found ${ne(n)}.`);
  }
...
function Zt(e) {
  if (e?.name === "GraphQLError") {
    ...
    return ct(t, { loc: { start: n }, cause: e });
  }
  return e;
}
function en(e) {

(function (f) {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let r of lt(t))
          !ft.call(e, r) &&
            ...
            ie(e, r, {
              get: () => t[r],
              enumerable: !(i = pt(t, r)) || i.enumerable,
            });
      return e;
    };
  var dt = (e) => ht(ie({}, "__esModule", { value: !0 }), e);
  var cn = {};
  me(cn, {
    languages: () => je,
    options: () => Xe,
  ...
  function I(e, t = "", n = {}) {
    return (
      S(e),
      t !== "" && S(t),
      { type: xe, breakContents: e, flatContents: t, groupId: n.groupId }
    );
  }
  function E(e, t) {
    (S(e), Y(t));
...
`
  ...
  function Ot(e, t) {
    ...
    return ((i = Se(e, i)), (i = X(e, i)), i !== !1 && De(e, i));
  }
  var ke = Ot;
  function It(e) {
...
`,
  ...
  function Ue(e, t) {
    let { node: n } = e;
    return oe(n.variableDefinitions)
      ? y([
          "(",
...
`) &&
  ...
  var wt = { bracketSpacing: $e.bracketSpacing },
    Xe = wt;
  var de = {};
  me(de, { graphql: () => on });
  function He(e) {
  ...
  function M(e, t) {
    ...
    for (let r of e.body.matchAll(Ft)) {
      if ((typeof r.index == "number" || Je(!1), r.index >= t)) break;
  ...
  var Q = class e extends Error {
    constructor(t, ...n) {
      ...
      (super(t),
        ...
        (this.nodes = We(Array.isArray(a) ? a : a ? [a] : void 0)));
      let O = We(
      ...
      ((this.source =
        ...
        (this.locations =
          p && u
            ? p.map((N) => M(u, N))
            : O?.map((N) => M(N.source, N.start))));
      let re = He(d?.extensions) ? d?.extensions : void 0;
      ((this.extensions =
        (s = D ?? re) !== null && s !== void 0 ? s : Object.create(null)),
  ...
  function Gt(e, t, n) {
    ...
    if ((s === 45 && (s = i.charCodeAt(++r)), s === 48)) {
      if (((s = i.charCodeAt(++r)), b(s)))
        throw h(
          e.source,
          r,
          `Invalid number, unexpected digit after 0: ${R(e, r)}.`,
        );
    ...
    if (
      ...
      throw h(
        e.source,
        r,
        `Invalid number, expected digit but got: ${R(e, r)}.`,
      );
  ...
  function fe(e, t, n) {
    if (!b(n))
      throw h(
        e.source,
        t,
        `Invalid number, expected digit but got: ${R(e, t)}.`,
      );
    let i = e.source.body,
      r = t + 1;
    ...
    parseValueLiteral(t) {
      ...
      switch (n.kind) {
        ...
        case o.INT:
          return (
            this.advanceLexer(),
            this.node(n, { kind: c.INT, value: n.value })
          );
        case o.FLOAT:
          return (
            this.advanceLexer(),
            this.node(n, { kind: c.FLOAT, value: n.value })
          );
        case o.STRING:
        case o.BLOCK_STRING:
      ...
      return (
        ...
        n
          ? s
            ...
            : this.node(t, { kind: c.DIRECTIVE_COORDINATE, name: i })
          : r
            ? s
              ? this.node(t, {
            ...
            : this.node(t, { kind: c.TYPE_COORDINATE, name: i })
      );
    }
    node(t, n) {
      return (

(function (f) {
  ...
  var As = (e, t, r) =>
    t in e
      ...
      : (e[t] = r);
  var en = (e, t) => {
      for (var r in t) St(e, r, { get: t[r], enumerable: !0 });
    },
    ys = (e, t, r, n) => {
  ...
  var Ns = (e) => ys(St({}, "__esModule", { value: !0 }), e);
  var sr = (e, t, r) => As(e, typeof t != "symbol" ? t + "" : t, r),
    Ls = (e, t, r) => t.has(e) || Zr("Cannot " + r);
  var $e = (e, t, r) => (
      Ls(e, t, "read from private field"),
      r ? r.call(e) : t.get(e)
    ),
    tn = (e, t, r) =>
      t.has(e)
  ...
  var Ps =
    ...
    Os = xe("replaceAll", function () {
      if (typeof this == "string") return Ps;
    }),
    w = Os;
  function Ds(e) {
    return this[e < 0 ? this.length + e : e];
  }
  var Is = xe("at", function () {
      if (Array.isArray(this) || typeof this == "string") return Ds;
    }),
    F = Is;
  var Rs = () => {},
    ze = Rs;
  var Ye = "string",
    ...
    bt = "label",
    De = "break-parent",
    wt = new Set([Et, Ae, ye, Ct, Ne, Le, Pe, Oe, vt, Tt, Y, bt, De]);
  function Ms(e) {
...
Expected it to be 'string' or 'object'.`;
    if (kt(e)) throw new Error("doc is valid.");
      ...
      switch (kt(s)) {
        ...
        case Ne: {
          ...
          return (
            ...
            t({ ...s, contents: o, expandedStates: a })
          );
        }
        case ye:
        case Ae:
...
`),
  ...
  function on(e) {
    return qs(Number.NEGATIVE_INFINITY, e);
  }
  var j = { type: De };
  function At(e) {
  ...
  function X(e, t = "", r = {}) {
    return (
      D(e),
      t !== "" && D(t),
      { type: Pe, breakContents: e, flatContents: t, groupId: r.groupId }
    );
  }
  function ln(e, t) {
    return (
      D(e),
      { type: Oe, contents: e, groupId: t.groupId, negate: t.negate }
    );
  }
  function q(e, t) {
    (D(e), xt(t));
  ...
  var _ = { type: Y },
    ...
    Hs = { type: Y, hard: !0 },
    v = [Hs, j],
    Vs = { type: Y, hard: !0, literal: !0 },
    nn = [Vs, j];
  var cn = Object.freeze({ character: "'", codePoint: 39 }),
    un = Object.freeze({ character: '"', codePoint: 34 }),
    Us = Object.freeze({ preferred: cn, alternate: un }),
    Ws = Object.freeze({ preferred: un, alternate: cn });
  function Gs(e, t) {
    let { preferred: r, alternate: n } = t === !0 || t === "'" ? Us : Ws,
      { length: i } = e,
      s = 0,
      a = 0;
    for (let o = 0; o < i; o++) {
...
`,
  ...
  var Ys = new Set([
    ...
    js = new Set(["if", "else if", "for", "switch", "case"]);
  function fn(e, t, r) {
    ...
    if (
      (e.kind === "docType" &&
        (t.value = w(0, e.value.toLowerCase(), /\s+/gu, " ")),
  ...
  function Xs(e, t, r, n) {
    let { node: i } = r,
      s = n.originalText.slice(
        i.sourceSpan.start.offset,
        i.sourceSpan.end.offset,
      );
    return /^\s*$/u.test(s)
      ? ""
      : x(s, e, { parser: "__ng_directive", __isInHtmlAttribute: !1 }, W);
  }
  var gn = Xs;
  var Ks =
  ...
  var yt = sa;
  var Nt = Symbol.for("PRETTIER_IS_FRONT_MATTER");
  function aa(e) {
    return !!e?.[Nt];
  }
  var ce = aa;
...
`)),
  ...
  function Lt(e, t) {
    return !!(
      ...
      (pe(e) &&
        e.children.some(
          (r) => r.kind !== "text" && r.kind !== "interpolation",
        )) ||
      (Dt(e, t) && !H(e, t) && e.kind !== "interpolation")
    );
  }
  function he(e) {
    return e.kind === "attribute" || !e.parent || !e.prev ? !1 : pa(e.prev);
  }
  function pa(e) {
  ...
  function An(e, t) {
    return H(e, t) || e.kind === "interpolation" || gr(e);
  }
  function gr(e) {
  ...
  function yn(e, t) {
    let r = n();
    if (r && !e.prev && e.parent?.tagDefinition?.ignoreFirstLf)
              ...
              : !(
                  (!e.prev &&
                    (e.parent.kind === "root" ||
                      ...
                      H(e.parent, t) ||
                      Je(e.parent, t) ||
                      !_a(e.parent.cssDisplay))) ||
                  (e.prev && !Ca(e.prev.cssDisplay))
                );
    }
  }
  function Nn(e, t) {
            ...
            : !(
                (!e.next &&
                  (e.parent.kind === "root" ||
                    ...
                    H(e.parent, t) ||
                    Je(e.parent, t) ||
                    !Sa(e.parent.cssDisplay))) ||
                (e.next && !Ea(e.next.cssDisplay))
              );
  }
  function Ln(e, t) {
    return va(e.cssDisplay) && !H(e, t);
  }
  function Ke(e) {
    return (
      ce(e) ||
  ...
  function Pt(e) {
    return Rn(e) || (e.prev && ha(e.prev)) || On(e);
  }
  function ha(e) {
  ...
  function Ot(e) {
    return e.lastChild ? Ot(e.lastChild) : e;
  }
  function ma(e) {
  ...
  function fa(e, t) {
    ...
    return !s && !i ? "babel" : (yt(t, { language: s }) ?? Mn(i));
  }
  function da(e, t) {
    if (!Dt(e, t)) return;
    let { attrMap: r } = e;
  ...
  function Bn(e, t) {
    ...
    if (e.kind === "element" && e.namespace === "svg")
      if (Ta(e, (n) => n.fullName === "svg:foreignObject")) r = !0;
  ...
  function Fn(e) {
    return e.kind === "element" &&
      (!e.namespace || ue(e)) &&
      Object.prototype.hasOwnProperty.call(fr, e.name)
      ? fr[e.name]
      : wn;
  }
  function Er(e) {
  ...
  var ba = new Set(["template", "style", "script"]);
  function Je(e, t) {
    return me(e, t) && !ba.has(e.fullName);
  }
  function me(e, t) {
    return (
      t.parser === "vue" &&
  ...
  function Dt(e, t) {
    return (
      me(e, t) && (Je(e, t) || (e.attrMap.lang && e.attrMap.lang !== "html"))
    );
  }
  function qn(e) {
    let t = e.fullName;
  ...
  var Cr = (e) => (t, r, n) => x(b(n.node), t, { parser: e }, W),
    ka = [
      {
        test(e) {
      ...
      },
      {
        ...
        print: Cr("__ng_binding"),
      },
      {
        test: (e) => e.node.fullName.startsWith("*"),
        print: Cr("__ng_directive"),
      },
      { test: (e) => /^i18n(?:-.+)?$/u.test(e.node.fullName), print: xa },
      { test: Un, print: Wn },
    ].map(({ test: e, print: t }) => ({
      test: (r, n) => n.parser === "angular" && e(r),
      print: t,
    }));
  function xa(e, t, { node: r }) {
    let n = b(r);
    return K(At(It(r, n.trim())), !n.includes("@@"));
  }
  var Gn = ka;
  var $n = ({ node: e }, t) =>
      !t.parentParser && e.fullName === "class" && !e.value.includes("{{"),
  ...
  var ya = new Set(vr),
    Yn = ({ node: e }, t) =>
      ya.has(e.fullName) && !t.parentParser && !e.value.includes("{{"),
    jn = (e, t, r) =>
      x(
        b(r.node),
        e,
...
` ||
  ...
  function Ra(e) {
    ...
    for (;;) {
      ...
      ((c = o),
        (r = u(Oa)),
        (n = []),
        r.slice(-1) === "," ? ((r = r.replace(Da, "")), S()) : d());
    }
    function d() {
      for (u(La), i = "", s = "in descriptor"; ; ) {
      ...
      for (z = 0; z < n.length; z++)
        ((ee = n[z]),
          ...
          Zn.test(ke) && _t === "w"
            ...
            : Ia.test(ke) && _t === "x"
              ? ((g || E || P) && (m = !0), ir < 0 ? (m = !0) : (E = ir))
              : Zn.test(ke) && _t === "h"
                ? ((P || E) && (m = !0), Ge === 0 ? (m = !0) : (P = Ge))
                : (m = !0));
      if (!m)
        ((le.source = { value: r, startOffset: c }),
          g && (le.width = { value: g }),
        ...
        throw new Error(
          `Invalid srcset descriptor found in "${e}" at "${ee}".`,
        );
    }
  }
  var ei = Ra;
  var ti = (e) =>
    ...
    ri = { width: "w", height: "h", density: "x" },
    Ma = Object.keys(ri);
  function ni(e, t, r) {
    let n = b(r.node),
      i = ei(n),
      s = Ma.filter((m) =>
        i.some((g) => Object.prototype.hasOwnProperty.call(g, m)),
      );
    if (s.length > 1)
  ...
  var ii = ({ node: e }, t) =>
      e.fullName === "style" && !t.parentParser && !e.value.includes("{{"),
    si = async (e, t, r) =>
      K(await e(b(r.node), { parser: "css", __isHTMLStyleAttribute: !0 }));
  var Tr = new WeakMap();
  function Ba(e, t) {
    let { root: r } = e;
    return (
      Tr.has(r) ||
        Tr.set(
          r,
          r.children.some(
            (n) => Rt(n, t) && ["ts", "typescript"].includes(n.attrMap.lang),
          ),
        ),
      Tr.get(r)
    );
  ...
  function oi(e, t, r, n) {
    ...
    return x(`function _(${i}) {}`, e, { parser: s, __isVueBindings: !0 });
  }
  async function li(e, t, r, n) {
    let i = b(r.node),
      { left: s, operator: a, right: o } = Fa(i),
      c = G(r, n);
    return [
      C(
  ...
  var qa = [
    { test: (e) => e.node.fullName === "v-for", print: li },
    {
      test: (e, t) => e.node.fullName === "generic" && Rt(e.parent, t),
      print: ai,
    },
    { test: ({ node: e }, t) => qn(e) || Hn(e, t), print: oi },
    {
      test(e) {
        let t = e.node.fullName;
    ...
    },
    {
      test(e) {
        let t = e.node.fullName;
        return (
          t.startsWith(":") || t.startsWith(".") || t.startsWith("v-bind:")
        );
      },
      print: Va,
    },
    { test: (e) => e.node.fullName.startsWith("v-"), print: ci },
  ].map(({ test: e, print: t }) => ({
  ...
  async function Ha(e, t, r, n) {
    ...
    let i = b(r.node),
      s = G(r, n) ? "__vue_ts_event_binding" : "__vue_event_binding";
    return x(i, e, { parser: s }, W);
  }
  function Va(e, t, r, n) {
    let i = b(r.node),
      s = G(r, n) ? "__vue_ts_expression" : "__vue_expression";
    return x(i, e, { parser: s }, W);
  }
  function ci(e, t, r, n) {
    let i = b(r.node),
      s = G(r, n) ? "__ts_expression" : "__js_expression";
    return x(i, e, { parser: s }, W);
  }
  var ui = qa;
  var Ua = [
    ...
    ...ui,
    ...Gn,
  ].map(({ test: e, print: t }) => ({ test: e, print: Ga(t) }));
  function Wa(e, t) {
    let { node: r } = e,
      { value: n } = r;
    if (n)
  ...
  function Ze(e, t) {
    return [e.isSelfClosing ? "" : $a(e, t), fe(e, t)];
  }
  function $a(e, t) {
    return e.lastChild && _e(e.lastChild) ? "" : [za(e, t), Bt(e, t)];
  }
  function fe(e, t) {
  ...
  function V(e, t) {
    return _e(e) ? Bt(e.parent, t) : et(e) ? Ft(e.next, t) : "";
  }
  function Bt(e, t) {
    if (mi(e, t)) return "";
    switch (e.kind) {
  ...
  function mi(e, t) {
    return !e.isSelfClosing && !e.endSourceSpan && (he(e) || Lt(e.parent, t));
  }
  function $(e) {
    return (
      e.prev &&
  ...
  function _e(e) {
    return (
      !e.next && !e.hasTrailingSpaces && e.isTrailingSpaceSensitive && O(Ot(e))
    );
  }
  function et(e) {
    return (
  ...
  function ja(e, t, r) {
    ...
    let i = n.prev?.kind === "comment" && Ya(n.prev.value),
      s =
        typeof i == "boolean"
          ? () => i
          : Array.isArray(i)
            ...
            : () => !1,
      a = e.map(
        ({ node: d }) => (s(d) ? L(t.originalText.slice(Q(d), te(d))) : r()),
        "attrs",
      ),
      o =
        n.kind === "element" &&
  ...
  function Xa(e) {
    return e.firstChild && tt(e.firstChild) ? "" : qt(e);
  }
  function rt(e, t, r) {
    let { node: n } = e;
    return [Se(n, t), ja(e, t, r), n.isSelfClosing ? "" : Xa(n)];
  }
  function Se(e, t) {
    return e.prev && et(e.prev) ? "" : [U(e, t), Ft(e, t)];
  }
  function U(e, t) {
    return tt(e) ? qt(e.parent) : $(e) ? de(e.prev, t) : "";
  }
  var hi = "<!doctype";
  function Ft(e, t) {
    switch (e.kind) {
  ...
  function Ka(e, t) {
    ...
    e.firstChild && tt(e.firstChild) && (r -= qt(e).length);
  ...
  function Ja(e, t) {
    ...
    switch (r.kind) {
        ...
        if (!r.isSelfClosing && Dt(r, t)) {
          ...
          return n
            ? async (i, s) => {
                ...
                return (
                  o ||
                    ((c = await i(dr(a), { parser: n, __embeddedInHtml: !0 })),
                    (o = c === "")),
                  [
                    U(r, t),
                    C(rt(e, t, s)),
      ...
      case "angularControlFlowBlockParameters":
        return Qa.has(e.parent.name) ? gn : void 0;
      case "angularLetDeclarationInitializer":
        return (n) =>
          x(r.value, n, { parser: "__ng_binding", __isInHtmlAttribute: !1 });
    }
  }
  var fi = Ja;
  var nt = null;
...
${e}`;
        ...
        L(
          y.trimEnd(
            t.originalText.slice(
              Q(n) + (n.prev && et(n.prev) ? Ft(n).length : 0),
  ...
  function Re(e, t, r) {
    ...
    return e.map(({ node: s, index: a }) => {
      ...
      let o = [],
        ...
        u = [],
        p = [],
        d = s.prev ? Vt(s.prev, s) : "",
        S = s.next ? Vt(s, s.next) : "";
      return (
        d &&
          (Ke(s.prev)
            ? o.push(v, v)
  ...
  function Ai(e) {
    return !(
      ...
      wi.get(e.name)?.has(e.next.name)
    );
  }
  var ro = (e) =>
    e?.kind === "angularControlFlowBlock" &&
    (e.name === "case" || e.name === "default");
  function no(e) {
    return (
      ro(e) &&
      e.endSourceSpan &&
      e.endSourceSpan.start.offset === e.endSourceSpan.end.offset
    );
  }
  function io(e) {
    let { previous: t } = e;
      ...
      C([
        A([
          ...
          e.map(({ node: i, isLast: s }) => {
            ...
            return (
              i.kind === "text" &&
                (i.hasLeadingSpaces && a.unshift(_),
                i.hasTrailingSpaces && !s && a.push(_)),
              a
            );
          }, "expression"),
        ]),
  ...
  function Pi(e, t, r) {
    let { node: n } = e;
    if (Lt(n, t))
      return [U(n, t), C(rt(e, t, r)), L(Ht(n, t)), ...Ze(n, t), V(n, t)];
    let i =
        n.children.length === 1 &&
        (n.firstChild.kind === "interpolation" ||
          n.firstChild.kind === "angularIcuExpression") &&
  ...
  var xr = { name: "custom-elements" },
    Ar = { name: "no-errors-schema" },
    re = (function (e) {
      return (
        (e[(e.NONE = 0)] = "NONE"),
        (e[(e.HTML = 1)] = "HTML"),
  ...
  var so = /-+([a-z0-9])/g;
  function Oi(e) {
    return e.replace(so, (...t) => t[1].toUpperCase());
  }
  var Ut;
  function yr() {
    return (
  ...
  function ot(e, t) {
    for (let r of t) Ut[r.toLowerCase()] = e;
  }
  var Di = class {};
  var ao = "boolean",
    oo = "number",
    ...
    po = Array.from(Ii).reduce((e, [t, r]) => (e.set(t, r), e), new Map()),
    Ri = class extends Di {
      constructor() {
        (super(),
          ...
          uo.forEach((e) => {
            let t = new Map(),
              ...
              [a, o] = n.split("^");
            a.split(",").forEach((u) => {
              (this._schema.set(u.toLowerCase(), t),
                this._eventSchema.set(u.toLowerCase(), r));
            });
              ...
              if (u.length > 0)
                switch (u[0]) {
                  case "*":
                    ...
                    break;
                  case "!":
                    t.set(u.substring(1), ao);
                    break;
                  case "#":
                    t.set(u.substring(1), oo);
                    break;
                  case "%":
                    t.set(u.substring(1), co);
                    break;
                  default:
                    t.set(u, lo);
                }
      ...
      hasElement(e, t) {
        return t.some((r) => r.name === Ar.name) ||
          (e.indexOf("-") > -1 &&
            (wr(e) || kr(e) || t.some((r) => r.name === xr.name)))
          ? !0
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`,
      ...
      allKnownAttributesOfElement(e) {
        let t =
          this._schema.get(e.toLowerCase()) || this._schema.get("unknown");
        return Array.from(t.keys()).map((r) => po.get(r) ?? r);
      }
      ...
      normalizeAnimationStyleValue(e, t, r) {
        ...
        if (ho(e) && r !== 0 && r !== "0")
          if (typeof r == "number") n = "px";
            ...
            a &&
              a[1].length == 0 &&
              (s = `Please provide a CSS unit value for ${t}:${r}`);
          }
  ...
  var f = class {
      constructor({
        ...
        ((this.closedByChildren = {}),
          ...
          e &&
            e.length > 0 &&
            e.forEach((c) => (this.closedByChildren[c] = !0)),
          (this.isVoid = i),
    ...
    return (
      lt ||
        ...
        (lt = Object.assign(Object.create(null), {
          ...
          tfoot: new f({ closedByChildren: ["tbody"], closedByParent: !0 }),
          tr: new f({ closedByChildren: ["tr"], closedByParent: !0 }),
          td: new f({ closedByChildren: ["td", "th"], closedByParent: !0 }),
          th: new f({ closedByChildren: ["td", "th"], closedByParent: !0 }),
          col: new f({ isVoid: !0 }),
          ...
          li: new f({ closedByChildren: ["li"], closedByParent: !0 }),
          dt: new f({ closedByChildren: ["dt", "dd"] }),
          dd: new f({ closedByChildren: ["dt", "dd"], closedByParent: !0 }),
          rb: new f({
...
` && ++o == r
    ...
    ne = class extends Error {
      ...
      contextualMessage() {
        ...
        return e
          ? `${this.msg} ("${e.before}[${Fi[this.level]} ->]${e.after}")`
          : this.msg;
      }
      toString() {
...
`,
  ...
  function ns(e, t, r, n = {}) {
    let i = new Fo(new mt(e, t), r, n);
    return (
      i.tokenize(),
      new Io($o(i.tokens), i.errors, i.nonNormalizedIcuExpressions)
    );
  }
  var Ro = /\r\n?/g;
  function be(e) {
      ...
      constructor(e, t, r) {
        ((this._getTagContentType = t),
          ...
          (this._leadingTriviaCodePoints =
            ...
            r.leadingTriviaChars.map((i) => i.codePointAt(0) || 0)),
        ...
        ((this._cursor = r.escapedString ? new zo(e, n) : new is(e, n)),
...
`,
      ...
      _consumeBlockStart(e) {
        ...
        this._attemptCharCode(123)
          ...
          : this._isBlockStart() &&
              (t.parts[0] === "case" || t.parts[0] === "default")
      ...
      _consumeLetDeclaration(e) {
        if (
          ...
          this._beginToken(l.LET_START, e),
          ct(this._cursor.peek()))
        )
          this._attemptCharCodeUntilFn(T);
        else {
        ...
        (this._attemptCharCodeUntilFn((r) => T(r) && !pt(r)),
          ...
          this._cursor.peek() === 59
            ? (this._beginToken(l.LET_END),
              this._endToken([]),
              this._cursor.advance())
            : ((t.type = l.INCOMPLETE_LET),
              (t.sourceSpan = this._cursor.getSpan(e))));
      }
      ...
      _consumeLetDeclarationValue() {
        ...
        for (this._beginToken(l.LET_VALUE, e); this._cursor.peek() !== 0; ) {
          ...
          (Wt(t) &&
            (this._cursor.advance(),
            this._attemptCharCodeUntilFn((r) =>
              r === 92 ? (this._cursor.advance(), !1) : r === t,
            )),
            this._cursor.advance());
        }
        this._endToken([this._cursor.getChars(e)]);
      ...
      _tokenizeExpansionForm() {
        ...
        if (Uo(this._cursor.peek()) && this._isInExpansionForm())
      ...
      _attemptCharCodeCaseInsensitive(e) {
        return Wo(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
      }
      _requireCharCode(e) {
        let t = this._cursor.clone();
        if (!this._attemptCharCode(e))
          throw this._createError(
            be(this._cursor.peek()),
            this._cursor.getSpan(t),
          );
      }
      _attemptStr(e) {
      ...
      _isBlockStart() {
        return this._cursor.peek() === 64 && Bo.some((e) => this._peekStr(e));
      }
      _isLetStart() {
      ...
      _consumeEntity(e) {
        ...
        if ((this._cursor.advance(), this._attemptCharCode(35))) {
          ...
          if ((this._attemptCharCodeUntilFn(Ho), this._cursor.peek() != 59)) {
            this._cursor.advance();
            let s = r ? Br.HEX : Br.DEC;
            throw this._createError(
              Mo(s, this._cursor.getChars(t)),
      ...
      _consumePrefixAndName(e) {
        let t = this._cursor.clone(),
          r = "";
        for (; this._cursor.peek() !== 58 && !qo(this._cursor.peek()); )
          this._cursor.advance();
        let n;
      ...
      _consumeTagOpen(e) {
          ...
          for (; !ts(this._cursor.peek()); )
            if (this._selectorlessEnabled && this._cursor.peek() === 64) {
              let o = this._cursor.clone(),
                c = o.clone();
              (c.advance(), Yt(c.peek()) && this._consumeDirective(o, c));
            } else {
        ...
        (this._handleFullNameStackForTagOpen(r, t),
          a === R.RAW_TEXT
            ...
            : a === R.ESCAPABLE_RAW_TEXT &&
              this._consumeRawTextWithTagClose(r, i, n, !0));
      }
      _consumeRawTextWithTagClose(e, t, r, n) {
        (this._consumeRawText(n, () =>
          ...
          !this._attemptStrCaseInsensitive(
            e && t.type !== l.COMPONENT_OPEN_START ? `${e}:${r}` : r,
          ))
            ? !1
            : (this._attemptCharCodeUntilFn(T), this._attemptCharCode(62)),
        ),
          this._beginToken(
            t.type === l.COMPONENT_OPEN_START ? l.COMPONENT_CLOSE : l.TAG_CLOSE,
          ),
      ...
      _consumeAttributeName() {
        ...
        if (e === 39 || e === 34)
          throw this._createError(be(e), this._cursor.getSpan());
      ...
      _consumeComponentOpenEnd() {
        let e = this._attemptCharCode(47)
          ? l.COMPONENT_OPEN_END_VOID
          : l.COMPONENT_OPEN_END;
        (this._beginToken(e), this._requireCharCode(62), this._endToken([]));
      }
      _consumeTagClose(e) {
      ...
      _consumeInterpolation(e, t, r) {
        ...
        for (; this._cursor.peek() !== 0 && (r === null || !r()); ) {
          ...
          if (this._isTagStart()) {
            ((this._cursor = o),
              n.push(this._getProcessedChars(i, o)),
              this._endToken(n));
            return;
          }
          if (s === null)
  ...
  var is = class Fr {
      ...
      getSpan(t, r) {
        ...
        return new h(
          ...
          n !== t ? this.locationFromCursor(n) : i,
        );
      }
      getChars(t) {
      ...
      advanceState(t) {
        if (t.offset >= this.end)
          throw ((this.state = t), new Ur('Unexpected character "EOF"', this));
        let r = this.charAt(t.offset);
        (r === 10 ? (t.line++, (t.column = 0)) : pt(r) || t.column++,
          t.offset++,
          this.updatePeek(t));
      }
      updatePeek(t) {
      ...
      decodeHexDigits(t, r) {
        ...
        if (isNaN(i))
          throw (
            ...
            new Ur("Invalid hexadecimal escape sequence", t)
          );
        return i;
      }
    },
    ...
    ls = class {
      ...
      parse(e, t, r, n = !1, i) {
        let s =
          ...
          S = new jo(u.tokens, a, p, d, n);
        return (S.build(), new Yo(S.rootNodes, [...u.errors, ...S.errors]));
      }
    },
    jo = class cs {
      ...
      build() {
        for (; this._peek.type !== l.EOF; )
          this._peek.type === l.TAG_OPEN_START ||
          this._peek.type === l.INCOMPLETE_TAG_OPEN
        ...
        for (let t of this._containerStack)
          t instanceof ve &&
            this.errors.push(
              N.create(t.name, t.sourceSpan, `Unclosed block "${t.name}"`),
            );
      }
      _advance() {
        let t = this._peek;
      ...
      _consumeCdata(t) {
        ...
        this._addToParent(
          new Vi(n, new h(t.sourceSpan.start, (i || r).sourceSpan.end), [r]),
        );
      }
      _consumeComment(t) {
      ...
      _consumeExpansion(t) {
        ...
        (this._addToParent(new Ui(r.parts[0], n.parts[0], i, s, r.sourceSpan)),
          this._advance());
      }
      _parseExpansionCase() {
        let t = this._advance();
...
`
          ...
          a != null &&
            ...
            s.ignoreFirstLf &&
            ((i = i.substring(1)),
            (r[0] = { type: t.type, sourceSpan: t.sourceSpan, parts: [i] }));
        }
        for (
          ;
        ...
        if (i.length > 0) {
          let a = t.sourceSpan;
          this._addToParent(
            new Hi(i, new h(n.start, a.end, n.fullStart, n.details), r),
          );
        }
      }
      _closeVoidElement() {
      ...
      _consumeElementStartTag(t) {
        ...
        let s = this._getElementFullName(
            t,
        ...
        if (this._peek.type === l.TAG_OPEN_END_VOID) {
          ...
          this._peek.type === l.TAG_OPEN_END && (this._advance(), (o = !1));
        let c = this._peek.sourceSpan.fullStart,
          ...
          g =
            m !== null &&
            !!(
              !((r = this._getTagDefinition(m)) === null || r === void 0) &&
              r.isClosedByChild(S.name)
            );
        (this._pushContainer(S, g),
          o
            ...
            : t.type === l.INCOMPLETE_TAG_OPEN &&
              ...
              this.errors.push(
                N.create(s, u, `Opening tag "${s}" not terminated.`),
              )));
      }
      _consumeComponentStartTag(t) {
        ...
        let p = this._peek.sourceSpan.fullStart,
          ...
          S = new h(t.sourceSpan.start, p, t.sourceSpan.fullStart),
          m = new J(n, o, c, i, s, [], u, d, S, void 0),
        ...
        (this._pushContainer(m, E),
          u
            ...
            : t.type === l.INCOMPLETE_COMPONENT_OPEN &&
              ...
              this.errors.push(
                N.create(c, d, `Opening tag "${c}" not terminated.`),
              )));
      }
      _consumeAttributesAndDirectives(t, r) {
        for (
          ;
          this._peek.type === l.ATTR_NAME ||
      ...
      _consumeComponentEndTag(t) {
        let r = this._getComponentFullName(
          t,
          this._getClosestElementLikeParent(),
        );
      ...
      _consumeElementEndTag(t) {
        ...
        if (
          n &&
          !((r = this._getTagDefinition(n)) === null || r === void 0) &&
          r.isVoid
        )
          this.errors.push(
            N.create(
      ...
      _popContainer(t, r, n) {
        ...
        for (let a = this._containerStack.length - 1; a >= 0; a--) {
          ...
          (o instanceof ve ||
            !(
              !((s = this._getTagDefinition(o)) === null || s === void 0) &&
              s.closedByParent
            )) &&
            (i = !0);
        }
      ...
      _consumeAttr(t) {
        ...
        this._peek.type === l.ATTR_QUOTE &&
          (c = n = this._advance().sourceSpan.end);
        let u =
          o &&
          c &&
          new h(
            i?.sourceSpan.start ?? o.start,
            c,
            i?.sourceSpan.fullStart ?? o.fullStart,
          );
        return new Gi(
          r,
          s,
      ...
      _consumeDirective(t) {
        ...
        if ((this._advance(), this._peek.type === l.DIRECTIVE_OPEN)) {
          for (
            n = this._peek.sourceSpan.end, this._advance();
            this._peek.type === l.ATTR_NAME;
          )
      ...
      _consumeBlockOpen(t) {
        ...
        for (; this._peek.type === l.BLOCK_PARAMETER; ) {
          let o = this._advance();
          r.push(new Lr(o.parts[0], o.sourceSpan));
        }
      ...
      _consumeLet(t) {
        ...
        let s = i.sourceSpan.fullStart,
          ...
          u = new Pr(r, n.parts[0], a, c, n.sourceSpan);
        this._addToParent(u);
      }
  ...
  var Ko = [Jo, Zo, tl, nl, il, ol, sl, al, ll, rl];
  function Qo(e, t) {
    for (let r of Ko) r(e, t);
    return e;
  }
  function Jo(e) {
    e.walk((t) => {
...
`
        ...
        for (let a = 0; a < n.length; a++) {
          ...
          u
            ...
            : (r.removeChild(o),
              a--,
              (c || p) &&
                (d && (d.hasTrailingSpaces = !0),
                S && (S.hasLeadingSpaces = !0)));
        }
  ...
  function ll(e, t) {
    e.walk((r) => {
      ...
      if (n) {
        ...
        for (let i of n)
          ((i.isLeadingSpaceSensitive = yn(i, t)),
            (i.isTrailingSpaceSensitive = Nn(i, t)));
        for (let i = 0; i < n.length; i++) {
          let s = n[i];
          ((s.isLeadingSpaceSensitive =
            (i === 0 || s.prev.isTrailingSpaceSensitive) &&
            s.isLeadingSpaceSensitive),
    ...
    switch (n.kind) {
      ...
      case "text": {
        if (n.parent.kind === "interpolation") {
          let o = /\n[^\S\n]*$/u,
            c = o.test(n.value),
            u = c ? n.value.replace(o, "") : n.value;
          return [L(u), c ? v : ""];
        }
        let i = U(n, t),
          s = It(n),
          a = V(n, t);
        return ((s[0] = [i, s[0]]), s.push([s.pop(), a]), At(s));
      }
      case "docType":
        return [
          C([
  ...
  var fs = "HTML",
    pl = {
      bracketSameLine: Gr.bracketSameLine,
      ...
      singleAttributePerLine: Gr.singleAttributePerLine,
  ...
  var tr = { attrs: !0, children: !0, cases: !0, expression: !0 },
    Ss = new Set(["parent"]),
    oe,
    zr,
    Yr,
    We = class We {
      constructor(t = {}) {
        ...
        sr(this, "kind");
        sr(this, "parent");
        for (let r of new Set([...Ss, ...Object.keys(t)]))
      ...
      setProperty(t, r) {
        if (this[t] !== r) {
          if (
            (t in tr && (r = r.map((n) => this.createChild(n))), !Ss.has(t))
          ) {
            this[t] = r;
            return;
          }
      ...
      map(t) {
        ...
        for (let n in tr) {
          let i = this[n];
          if (i) {
            let s = fl(i, (a) => a.map(t));
            r !== i &&
              (r || (r = new We({ parent: this.parent })), r.setProperty(n, s));
          }
        }
        if (r) for (let n in this) n in tr || (r[n] = this[n]);
        return t(r || this);
      }
      walk(t) {
        for (let r in tr) {
  ...
  var dl = [
    ...
    { regex: /^\[if(?<condition>[^\]]*)\]><!$/u, parse: _l },
    { regex: /^<!\s*\[endif\]$/u, parse: Sl },
  ];
  function Es(e, t) {
    if (e.value)
      for (let { regex: r, parse: n } of dl) {
  ...
  var jr = class extends Or {
    ...
    visit(t, { parseOptions: r }) {
      (Tl(t), bl(t, r), kl(t, r), wl(t));
    }
  };
  function Ts(e, t, r, n) {
    (Gt(new jr(), e.children, { parseOptions: r }), t && e.children.unshift(t));
    let i = new rr(e);
    return (
      i.walk((s) => {
        if (s.kind === "comment") {
    ...
    if (e.kind === "block") {
      ...
      e.parameters = {
        ...
        sourceSpan: new h(
          ...
          F(0, e.parameters, -1).sourceSpan.end,
        ),
      };
    }
  }
      ...
      for (let r of e.attrs)
        r.namespace ||
          (r.name = Cs(
            r.name,
            (n) =>
              er.has(e.name) && (er.get("*").has(n) || er.get(e.name).has(n)),
          ));
  }
  function Kr(e, t) {
    let { rootNodes: r, errors: n } = Jt(e, $r(t));
    return (n.length > 0 && Xr(n[0]), { parseOptions: t, rootNodes: r });
  }
  function bs(e, t) {
    let r = $r(t),
      { rootNodes: n, errors: i } = Jt(e, r);
    if (
      n.some(
        (u) =>
      ...
      return Kr(e, nr);
    let a,
      o = () => a ?? (a = Jt(e, { ...r, getTagContentType: void 0 })),
      c = (u) => {
        let { offset: p } = u.startSourceSpan.start;
        return (
          o().rootNodes.find(
            (d) => d.kind === "element" && d.startSourceSpan.start.offset === p,
          ) ?? u
        );
      };
      ...
      if (p.kind === "element") {
        if (p.isVoid) ((i = o().errors), (n[u] = c(p)));
          ...
          let { endSourceSpan: d, startSourceSpan: S } = p,
            m = o().errors.find(
              (g) =>
                g.span.start.offset > S.start.offset &&
                g.span.start.offset < d.end.offset,
            );
          (m && Xr(m), (n[u] = c(p)));
        }
      }
  ...
  function Al(e, t, r, n, i, s) {
    let { offset: a } = n,
      o = w(0, t.slice(0, a), /[^\n]/gu, " ") + r,
      c = Qr(o, e, { ...i, shouldParseFrontMatter: !1 }, s);
  ...
  function Qr(e, t, r, n = {}) {
    let { frontMatter: i, content: s } = r.shouldParseFrontMatter
      ...
      d = { kind: "root", sourceSpan: new h(o, c), children: p },
      S;
    if (i) {
      let [g, E] = [i.start, i.end].map(
        (P) => new qe(a, P.index, P.line - 1, P.column),
      );
      S = { ...i, kind: "frontMatter", sourceSpan: new h(g, E) };
    }
    return Ts(d, S, u, (g, E) => Al(t, e, g, E, u, n));
  }
  var nr = Zt({
    name: "html",
    normalizeTagName: !0,
  ...
  var yl = gt(nr),
    Nl = new Set(["mj-style", "mj-raw"]),
    Ll = gt({ ...nr, name: "mjml", shouldParseAsRawText: (e) => Nl.has(e) }),
    Pl = gt({
      name: "angular",
      ...
      shouldParseAsRawText(e, t, r, n) {
        return (
          ...
          (e !== "template" ||
            n.some(
              ({ name: i, value: s }) =>
                i === "lang" && s !== "html" && s !== "" && s !== void 0,
            ))
        );
      },
    }),
    Dl = gt({ name: "lwc", canSelfClose: !1 });
  var Il = { html: hs };
  return Ns(Rl);
});

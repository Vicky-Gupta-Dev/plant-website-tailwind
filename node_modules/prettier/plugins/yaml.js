(function (f) {
  ...
  var ne = (t, e) => () => (
    ...
    sr = (t, e) => {
      for (var n in e) mt(t, n, { get: e[n], enumerable: !0 });
    },
    ir = (t, e, n, r) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let s of Pi(e))
          !Ii.call(t, s) &&
            ...
            mt(t, s, {
              get: () => e[s],
              enumerable: !(r = ki(e, s)) || r.enumerable,
            });
      return t;
    };
  var or = (t, e, n) => (
      ...
      ir(
        e || !t || !t.__esModule
          ? mt(n, "default", { value: t, enumerable: !0 })
          : n,
        t,
      )
    ),
    _i = (t) => ir(mt({}, "__esModule", { value: !0 }), t);
  var ce = ne((B) => {
    "use strict";
    var ie = {
        ANCHOR: "&",
...
`;
    ...
    function go({ start: t, end: e }, n, r = 80) {
      let s = ho(t.line, n);
      if (!s) return null;
      let { col: i } = t;
      if (s.length > r)
...
`
          ...
          if (r) {
            if (s !== r) return !1;
          } else if (s !== ie.DIRECTIVES_END && s !== ie.DOCUMENT_END)
            return !1;
          let o = e[n + 1],
            a = e[n + 2];
          if (o !== s || a !== s) return !1;
...
`)
        ...
        get rangeAsLinePos() {
          ...
          let e = Sn(this.range.start, this.context.root);
          if (!e) return;
          let n = Sn(this.range.end, this.context.root);
...
` &&
    ...
    B.Type = st;
    B.YAMLError = ge;
    B.YAMLReferenceError = wn;
    B.YAMLSemanticError = it;
    B.YAMLSyntaxError = bn;
    B.YAMLWarning = Nn;
    B._defineProperty = yo;
    B.defaultTagPrefix = po;
    B.defaultTags = mo;
  });
  var Qr = ne((jr) => {
    "use strict";
...
` &&
    ...
    function An(t) {
      ...
      if (!(e instanceof _t)) return null;
...
`:
        ...
        parse(e, n) {
          ...
          return (
            (s = this.parseDirectives(s)),
            (s = this.parseContents(s)),
            s
          );
        }
        setOrigRanges(e, n) {
...
`),
      ...
      le = { CLIP: "CLIP", KEEP: "KEEP", STRIP: "STRIP" },
      Mn = class extends u.Node {
        constructor(e, n) {
          (super(e, n),
            (this.blockIndent = null),
            (this.chomping = le.CLIP),
            (this.header = null));
        }
        get includesTrailingLines() {
        ...
        toString(
          ...
          let y = !1,
            ...
            d = this.items.reduce((P, A, C) => {
              let L;
              (A &&
                (!y && A.spaceBefore && P.push({ type: "comment", str: "" }),
                A.commentBefore &&
                  A.commentBefore.match(/^.*$/gm).forEach((Ci) => {
                    P.push({ type: "comment", str: `#${Ci}` });
                  }),
...
` + this.comment.replace(/^/gm, `${c}#`)),
    ...
    var ue = class extends Q {
      ...
      T = class t extends j {
        ...
        set commentBefore(e) {
          if (
            (this.key == null && (this.key = new x(null)),
            this.key instanceof j)
          )
        ...
        toString(e, n, r) {
          ...
          if (e.allNullValues && !o)
            return (
              this.comment
                ? ((w = Re(w, e.indent, this.comment)), n && n())
                : d && !l && r && r(),
              e.inFlow && !f ? w : `? ${w}`
            );
          ((w = f
...
` && (L = ""),
      ...
      we = class t extends j {
        ...
        toJSON(e, n) {
          ...
          if (
            s >= 0 &&
            ((i.count += 1),
            i.aliasCount === 0 && (i.aliasCount = Rt(this.source, r)),
    ...
    var ct = class extends Q {
      ...
      No = { defaultType: p.Type.BLOCK_LITERAL, lineWidth: 76 },
      Oo = { trueStr: "true", falseStr: "false" },
      Ao = { asBigInt: !1 },
      Lo = { nullStr: "null" },
      be = {
...
`),
      ...
      return ((a = c ? a + i.slice(c) : i), n ? a : Bt(a, o, Dt, Rn(e)));
    }
    function es(t, e) {
      if (e.implicitKey) {
...
${n}`,
          ...
          "'";
      return e.implicitKey ? r : Bt(r, n, Zr, Rn(e));
    }
    function $t({ comment: t, type: e, value: n }, r, s, i) {
      if (/\n[\t ]+$/.test(n) || /^\s*$/.test(n)) return Se(n, r);
      let o = r.indent || (r.forceBlockIndent || Ft(n) ? "  " : ""),
        a = o ? "2" : "1",
        c =
          e === p.Type.BLOCK_FOLDED
            ...
            : e === p.Type.BLOCK_LITERAL
              ? !0
              : !To(n, be.fold.lineWidth, o.length),
        l = c ? "|" : ">";
      if (!n)
        return (
          l +
...
`) !== -1
        ...
        return $t(t, e, n, r);
      if (l === "" && Ft(o)) return ((e.forceBlockIndent = !0), $t(t, e, n, r));
      let m = o.replace(
        /\n+/g,
        `$&
${l}`,
      ...
      if (a) {
        ...
        if (typeof xn(m, y, y.scalarFallback).value != "string")
          return Se(o, e);
      }
      let g = c ? m : Bt(m, l, Zr, Rn(e));
      return s &&
        !f &&
        (g.indexOf(`
`) !== -1 ||
...
`) !== -1)
    ...
    function ko({ format: t, minFractionDigits: e, tag: n, value: r }) {
...
` + s)
    ...
    function Do(t, e) {
      ...
      try {
        let o = Dn(t, e);
        return xn(o, s.tags, s.tags.scalarFallback);
      } catch (o) {
    ...
    function pe(t, e) {
      ...
      let { comments: n, hasAnchor: r, hasTag: s } = Ro(t.errors, e);
      if (r) {
        let { anchors: o } = t,
          a = e.anchor,
          c = o.getNode(a);
...
${a}`
    ...
    function $o(t, e) {
      ...
      let { comments: n, items: r } =
          e.type === p.Type.FLOW_MAP ? qo(t, e) : Fo(t, e),
        s = new ct();
      ((s.items = r), ss(s, n));
      let i = !1;
      for (let o = 0; o < r.length; ++o) {
        let { key: a } = r[o];
        if (
          (a instanceof Q && (i = !0), t.schema.merge && a && a.value === zr)
        ) {
          r[o] = new Yt(r[o]);
    ...
    var Yo = ({ context: { lineStart: t, node: e, src: n }, props: r }) => {
...
`
    ...
    function Uo(t, e) {
      ...
      let { comments: n, items: r } =
          e.type === p.Type.FLOW_SEQ ? Wo(t, e) : Vo(t, e),
        s = new ue();
      if (
        ((s.items = r),
        ss(s, n),
        !t.options.mapAsMap &&
          r.some((i) => i instanceof T && i.key instanceof Q))
      ) {
        let i =
          "Keys with collection values will be stringified as YAML due to JS Object restrictions. Use mapAsMap: true to avoid this.";
...
`
          ...
          (ns(t.errors, f), n.push({ comment: f.comment, before: r.length }));
        else {
          if (a) {
    ...
    M.resolveString = Dn;
    M.strOptions = be;
    M.stringifyNumber = ko;
    M.stringifyString = Mo;
    M.toJSON = fe;
  });
  var Fn = ne((ee) => {
    "use strict";
    var G = ce(),
      ...
      Ko = {
        ...
        stringify: ({ comment: t, type: e, value: n }, r, s, i) => {
          ...
          if (
            (e || (e = O.binaryOptions.defaultType), e === G.Type.QUOTE_DOUBLE)
          )
            n = o;
          else {
...
${i.comment}`
    ...
    var zo = {
      ...
      Zo = {
        ...
        resolve: (t, e, n) => $n(e, n.replace(/_/g, "")),
        stringify: cs,
      },
      ea = {
        identify: (t) => typeof t == "number",
    ...
    function ra(t, e) {
      if (!is[t] && Yn(!0)) {
        ...
        ((n += e ? `, use '${e}' instead.` : "."), Bn(n, "DeprecationWarning"));
      }
    }
    ee.binary = Ko;
    ee.floatTime = ea;
    ...
    ee.timestamp = ta;
    ee.warn = Bn;
    ee.warnFileDeprecation = na;
    ee.warnOptionDeprecation = ra;
  });
  var Wn = ne((bs) => {
    "use strict";
    var Vt = ce(),
    ...
    var Wt = {
      ...
      Un = [ft, Wt, oa],
      Kt = (t) => typeof t == "bigint" || Number.isInteger(t),
      Vn = (t, e, n) => (E.intOptions.asBigInt ? BigInt(t) : parseInt(e, n));
    function us(t, e, n) {
      let { value: r } = t;
      return Kt(r) && r >= 0 ? n + r.toString(e) : E.stringifyNumber(t);
    }
    var ps = {
        identify: (t) => t == null,
      ...
      Ss = {
        ...
        resolve(t, e, n) {
          ...
          return (
            r && r[r.length - 1] === "0" && (s.minFractionDigits = r.length),
            s
          );
        },
        stringify: E.stringifyNumber,
      },
      aa = Un.concat([ps, ms, hs, ds, gs, ys, Es, Ss]),
      ...
      ws = [
        ...
        },
        {
          ...
          stringify: ({ value: t }) =>
            ls(t) ? t.toString() : JSON.stringify(t),
        },
        {
          identify: (t) => typeof t == "number",
          default: !0,
    ...
    var ca = Un.concat(
      ...
      la = { core: aa, failsafe: Un, json: ws, yaml11: ca },
      fa = {
        binary: $.binary,
        bool: ms,
        float: Ss,
    ...
    function pa(t, e, n) {
      ...
      if (!c) {
        ...
        c = t instanceof Map ? ft : t[Symbol.iterator] ? Wt : ft;
      }
    ...
    var ha = (t, e) => (t.key < e.key ? -1 : t.key > e.key ? 1 : 0),
      ut = class t {
        constructor({
          customTags: e,
          merge: n,
          ...
          ((this.merge = !!n),
            (this.name = r),
            (this.sortMapEntries = s === !0 ? ha : s || null),
            !e && i && $.warnOptionDeprecation("tags", "customTags"),
            (this.tags = ma(la, fa, e || i, r)));
        }
        createNode(e, n, r, s) {
          let i = {
    ...
    Vt._defineProperty(ut, "defaultPrefix", Vt.defaultTagPrefix);
    Vt._defineProperty(ut, "defaultTags", Vt.defaultTags);
    bs.Schema = ut;
  });
  var Ls = ne((Ht) => {
    "use strict";
    ...
    function Ea(t, e, { anchors: n, doc: r }) {
      let s = [],
      ...
      Qt = (t, e) => {
        if (t && typeof t == "object") {
          ...
          t instanceof S.Collection
            ? (n && (e[n] = !0), t.items.forEach((r) => Qt(r, e)))
            : t instanceof S.Pair
              ? (Qt(t.key, e), Qt(t.value, e))
              : t instanceof S.Scalar && n && (e[n] = !0);
        }
        return e;
      },
      Sa = (t) => Object.keys(Qt(t, {}));
    function wa(t, e) {
      let n = { before: [], after: [] },
        r,
        s = !1;
...
`) || null;
    ...
    var Gt = class t {
      constructor(e) {
        ((this.anchors = new Kn(e.anchorPrefix)),
      ...
      setIn(e, n) {
        S.isEmptyPath(e)
          ? (this.contents = n)
          : (Be(this.contents), this.contents.setIn(e, n));
      }
      setSchema(e, n) {
      ...
      listNonDefaultTags() {
        return Sa(this.contents).filter(
          (e) => e.indexOf(Ns.Schema.defaultPrefix) !== 0,
        );
      }
      setTagPrefix(e, n) {
        if (e[0] !== "!" || e[e.length - 1] !== "!")
      ...
      toString() {
        ...
        if (this.contents) {
          ...
          let c = a ? null : () => (o = !0),
            l = jt(this.contents, i, () => (a = null), c);
          n.push(S.addComment(l, "", a));
        } else this.contents !== void 0 && n.push(jt(this.contents, i));
        return (
          this.comment &&
...
`
    ...
    Y._defineProperty(Gt, "defaults", As);
    Ht.Document = Gt;
    Ht.defaultOptions = da;
    Ht.scalarOptions = ga;
  });
  var Ms = ne((Cs) => {
    "use strict";
    ...
    function Ca(t, e = !0, n) {
      ...
      return new Aa.Schema(r).createNode(t, e, n);
    }
    ...
    function Ts(t, e) {
      ...
      if (n.length > 1) {
        ...
        r.errors.unshift(new La.YAMLSemanticError(n[1], s));
      }
      return r;
    }
    function ka(t, e) {
      let n = Ts(t, e);
      if ((n.warnings.forEach((r) => Ta.warn(r)), n.errors.length > 0))
        throw n.errors[0];
      return n.toJSON();
    }
    function Pa(t, e) {
  ...
  var Ri = ht("at", function () {
      if (Array.isArray(this) || typeof this == "string") return xi;
    }),
    D = Ri;
  var Di =
    ...
    $i = ht("replaceAll", function () {
      if (typeof this == "string") return Di;
    }),
    dt = $i;
  var Yi = () => {},
    je = Yi;
  var Qe = "string",
    ...
    St = "indent-if-break",
    Me = "line-suffix",
    wt = "line-suffix-boundary",
    re = "line",
    bt = "label",
    ke = "break-parent",
    Nt = new Set([gt, yt, Ae, Et, Le, Te, Ce, St, Me, wt, re, bt, ke]);
  function Bi(t) {
...
Expected it to be 'string' or 'object'.`;
    if (Ot(t)) throw new Error("doc is valid.");
...
`),
  ...
  function ze(t, e = "", n = {}) {
    return (
      Z(t),
      e !== "" && Z(e),
      { type: Ce, breakContents: t, flatContents: e, groupId: n.groupId }
    );
  }
  function v(t, e) {
    (Z(t), At(e));
...
${t}`;
  ...
  var Qi = 10;
  for (let t = 0; t <= Qi; t++) et();
  function mn(t) {
    return et(t);
  }
  function Gi(t, e = "type") {
    mn(t);
    function n(r) {
      let s = r[e],
        i = t[s];
  ...
  function hn(t, e, n) {
    return e(
      "children" in t
        ? { ...t, children: t.children.map((r) => hn(r, e, t)) }
        : t,
      n,
    );
  }
...
` && n++,
  ...
  function kt(t) {
    return ve(t.children) ? kt(D(0, t.children, -1)) : t;
  }
  function Ir(t) {
  ...
  function _e(t) {
    return !ve(t.children) && !Xi(t);
  }
  function Xi(t) {
    return te(t) || ae(t) || dn(t) || K(t) || I(t);
  }
  function te(t) {
...
`,
    ...
    function c(l) {
      if (t.chomping === "keep")
        return D(0, l, -1).length === 0 ? l.slice(0, -1) : l;
      let f = 0;
  ...
  function Pt(t, e) {
    ...
    return (
      ...
      (s.add(n.position.end.line), _r(n, e) && !yn(t.parent))
        ? Tt
        : ""
    );
  }
  function yn(t) {
    return (
      I(t) &&
      !W(t, ["documentHead", "documentBody", "flowMapping", "flowSequence"])
    );
  }
  function _(t, e) {
  ...
  function zi(t, e, n) {
    ...
    (r.indent !== null && o.push(r.indent.toString()),
      ...
      dn(r) && o.push(" ", n("indicatorComment")));
    let a = $r(r, { parentIndent: s, isLastDescendant: i, options: e }),
      c = [];
    for (let [l, f] of a.entries())
      (l === 0 && c.push(N),
        ...
        l !== a.length - 1
          ...
          : r.chomping === "keep" && i && c.push(an(f.length === 0 ? N : He)));
    return (
      r.indent === null
        ? o.push(pr(_(e.tabWidth, c)))
        : o.push(an(_(r.indent - 1 + s, c))),
      o
    );
  }
  var Yr = zi;
  ...
  function eo(t, e, n) {
    ...
    return En(i.content, e) &&
      !te(i.content) &&
      !ae(i.content) &&
      !K(i.content) &&
      !I(i)
      ? cn([[l, w]])
      : cn([[y, ze(h, w, { groupId: g })]]);
  }
  function En(t, e) {
    if (!t) return !0;
    switch (t.type) {
...
`);
  ...
  function so(t) {
    switch (t.type) {
      case "document":
        (Ie(t, "head", () => t.children[0]),
          Ie(t, "body", () => t.children[1]));
        break;
      case "documentBody":
      case "sequenceItem":
      ...
      case "flowMappingItem":
        (Ie(t, "key", () => t.children[0]),
          Ie(t, "value", () => t.children[1]));
        break;
    }
    return t;
  }
  ...
  function io(t, e, n) {
    ...
    return (
      W(r, [
        ...
        !Mt(t) &&
        (a = Pt(t, e.originalText)),
      (i || o) &&
        (W(r, ["sequence", "mapping"]) && !ae(r) ? s.push(N) : s.push(" ")),
      ae(r) &&
        s.push([
        ...
        s.push(
          _(r.type === "sequenceItem" ? 2 : 0, [
            ...
            v(
              N,
              t.map(
                ({ node: c }) => [un(e.originalText, tt(c)) ? N : "", n()],
                "endComments",
              ),
            ),
          ]),
    ...
    switch (r.type) {
      ...
      case "documentBody": {
        ...
        if (s.length > 0 && i.length > 0) {
          let a = kt(r);
          if (W(a, ["blockFolded", "blockLiteral"]))
            a.chomping !== "keep" && (o = [N, N]);
          else {
            let c = D(0, s, -1);
            o = W(c, ["mapping"]) && un(e.originalText, tt(i[0])) ? [N, N] : N;
          }
        }
      ...
      case "quoteSingle": {
        ...
        if (o.includes("'"))
          return [
            '"',
            rt(r.type, r.type === "quoteSingle" ? dt(0, o, "''", "'") : o, e),
            '"',
          ];
        let a = e.singleQuote ? "'" : '"';
  ...
  var uo = {
      bracketSpacing: It.bracketSpacing,
  ...
  var nr = or(Ps(), 1);
  var J = or(vs(), 1),
    Tf = J.default.findPair,
    Cf = J.default.toJSON,
    Mf = J.default.parseMap,
    kf = J.default.parseSeq,
    Pf = J.default.stringifyNumber,
    vf = J.default.stringifyString,
    If = J.default.Type,
    _f = J.default.YAMLError,
    xf = J.default.YAMLReferenceError,
    Is = J.default.YAMLSemanticError,
    Rf = J.default.YAMLSyntaxError,
    Df = J.default.YAMLWarning;
  function F(t, e = null) {
  ...
  function _a(t, e, n) {
    ...
    if (s) {
      if (s.trailingComment)
        throw new Error(
          `Unexpected multiple trailing comment at ${Oe(t.position.start)}`,
        );
    ...
    switch (t.type) {
      ...
      case "SEQ":
        for (let e = t.items.length - 1; e >= 0; e--) {
          let n = t.items[e];
          "char" in n ||
            (n.type === "BLANK_LINE" ? t.items.splice(e, 1) : pt(n));
        }
        break;
      case "MAP_KEY":
      case "MAP_VALUE":
  ...
  function Jt(t, e, n = () => !1) {
    ...
    for (let c of r.props) {
      ...
      switch (l) {
        case me.Tag:
          ((i = i || c), (o = Bs(e.transformRange(c), t.tag)));
          break;
        case me.Anchor:
          ((i = i || c), (a = $s(e.transformRange(c), r.anchor)));
          break;
        case me.Comment: {
          let f = Ve(
            e.transformRange(c),
  ...
  function Xt(t, e) {
    let n = t.cstNode,
      ...
      l = Jt(t, e, (f) => {
        ...
        if (c)
          throw new Error(
            `Unexpected multiple indicator comments at ${Oe(f.position.start)}`,
          );
        return ((c = f), !0);
      });
    return Vs(a, l, Gn[n.chomping], o ? n.blockIndent : null, n.strValue, c);
  }
  function Ws(t, e) {
    return Us(Xt(t, e));
  }
  ...
  function We(t, e) {
    for (let n of t.props) {
      ...
      switch (r) {
        case me.Comment:
          e.comments.push(
            Ve(e.transformRange(n), e.text.slice(n.origStart + 1, n.origEnd)),
          );
          break;
        default:
  ...
  function Hs(t, e) {
    return (We(t, e), Gs(e.transformRange(t.range), t.name, t.parameters));
  }
  ...
  function Ra(t, e, n) {
    ...
    if (i.length > 1)
      throw new Error(
        `Unexpected multiple document trailing comments at ${Oe(i[1].position.start)}`,
      );
    if (o.length > 1)
      throw new Error(
  ...
  function Da(t, e, n) {
    let r = zt(n.text.slice(t.valueRange.origEnd), /^\.\.\./),
      s =
  ...
  function ei(t, e) {
    let n = t.cstNode,
      { directives: r, comments: s, endComments: i } = $a(n, e),
      { position: o, documentEndMarkererPoint: a } = Ya(n, r, e);
    return (
      e.comments.push(...s, ...i),
      {
  ...
  function Ya(t, e, n) {
    let r = zt(n.text.slice(0, t.valueRange.origStart), /---\s*$/);
    r > 0 && !/[\r\n]/.test(n.text[r - 1]) && (r = -1);
    let s =
      r === -1
  ...
  function ti(t, e) {
    ...
    let l = t.cstNode;
    return Js(
      X(c.position.start, i),
      !!l.directivesEndMarker,
      !!l.documentEndMarker,
      c,
      s,
      o,
  ...
  function Ke(t, e, n, r, s) {
    ...
    return n(
      ...
      a || Hn(Qn(c.position.start), null),
      c || Jn(Qn(a.position.end), null),
    );
  }
  function ri(t, e) {
    let n = de(t.cstNode.items, e),
      ...
      s = t.items.map((a, c) => {
        let l = r[c],
          { additionalKeyRange: f, additionalValueRange: m } = tn(l);
        return Ke(a, e, en, f, m);
      }),
      i = n[0],
      o = V(n);
    return ni(
    ...
    let n = de(t.cstNode.items, e),
      ...
      s = t.items.map((a, c) => {
        if (a.type !== "PAIR") {
          ...
          return ii(X(l.position.start, l.position.end), l);
        } else {
          let l = r[c],
            { additionalKeyRange: f, additionalValueRange: m } = tn(l);
          return Ke(a, e, en, f, m);
  ...
  function li(t, e) {
    ...
    let r = de(n.items, e),
      ...
      i = t.items.map((o, a) => {
        ...
        return Ke(o, e, ci, l, f);
      });
    return ai(
      X(i[0].position.start, V(i).position.end),
      e.transformContent(t),
      i,
    );
  }
  ...
  function pi(t, e) {
    ...
    return fi(
      e.transformRange({
        ...
        origEnd: ui(e.text, n.valueRange.origEnd - 1, /\S/) + 1,
      }),
      e.transformContent(t),
      n.strValue,
    );
  ...
  function wi(t, e) {
    ...
    return Ei(
      X(r[0].position.start, V(r).position.end),
      e.transformContent(t),
      r,
    );
  }
  ...
  var Xn,
    zn = class {
      ...
      setOrigRanges() {
        if (!this.#e.setOrigRanges())
          for (let e of this.#e) e.setOrigRanges([], 0);
      }
      #n(e) {
        if (!Xn) {
          let [o] = this.#e,
            a = Object.getPrototypeOf(Object.getPrototypeOf(o));
          Xn = Object.getOwnPropertyDescriptor(a, "rangeAsLinePos").get;
        }
        if (
        ...
        let {
          ...
          range: { start: this.#r(e.origStart), end: this.#r(e.origEnd) },
          context: this.#t,
        });
        return {
  ...
  function Ai(t, e) {
    ...
    return Oi(t.message, e.text, e.transformRange(n));
  }
  function Zn(t) {
    if ("children" in t) {
  ...
  function tr(t) {
    ...
    let e = t.children;
    if ((e.forEach(tr), t.type === "document")) {
      let [i, o] = t.children;
    ...
    let n = er(t.position, Fa, qa, Wa),
      r = er(t.position, Ua, Va, Ka);
    "endComments" in t &&
  ...
  function Li(t) {
    let e = nr.default.parseCST(t),
      n = new Ni(e, t);
    n.setOrigRanges();
    let r = e.map((i) =>
      new nr.default.Document({ merge: !1, keepCstNodes: !0 }).parse(i),
    );
    for (let i of r)
      for (let o of i.errors)
        if (
          !(
            o instanceof Is &&
            o.message === 'Map keys must be unique; "<<" is repeated'
          )
        )
          throw Ai(o, n);
  ...
  function Qa(t) {
    try {
      ...
      throw e?.position ? Ti(e.message, { loc: e.position, cause: e }) : e;
    }
  }
  var Ga = {
    astFormat: "yaml",

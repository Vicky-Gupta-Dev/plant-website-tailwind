...
function $n(e, t) {
  return (Or(e), M(t), { type: Et, contents: t, n: e });
}
function Be(e) {
  return $n(-1, e);
}
...
var N = { type: Q },
  ...
  Xn = { type: Q, hard: !0 },
  ut = [Xn, Re],
  Zn = { type: Q, hard: !0, literal: !0 },
  Lr = [Zn, Re];
var Ir = Object.freeze({ character: "'", codePoint: 39 }),
  Br = Object.freeze({ character: '"', codePoint: 34 }),
  ts = Object.freeze({ preferred: Ir, alternate: Br }),
  es = Object.freeze({ preferred: Br, alternate: Ir });
function rs(e, t) {
    ...
    var e = function (X, b, S, y) {
      ...
      Ne = {
        ...
        table: [
          ...
          e(vr, [2, 88], { 54: 70 }),
          e(W, Sr),
          { 25: 71, 38: 73, 39: wr, 43: 74, 44: we, 45: 72, 47: [2, 60] },
          ...
          { 56: [2, 91] },
          e(s, [2, 13]),
          { 38: 73, 39: wr, 43: 74, 44: we, 45: 128, 46: 127, 47: [2, 82] },
          e(dt, [2, 76], { 40: 129 }),
          { 47: [2, 18] },
          e(s, [2, 14]),
          { 33: [1, 130] },
...
var Qr = {};
for (ue in Ft)
  Object.prototype.hasOwnProperty.call(Ft, ue) && (Qr[ue] = Ft[ue]);
var ue;
function he(e, t) {
  var r, s, n;
...
var po = Xr(pe.FlushElement);
var fo = Xr(pe.GetSymbol);
var _s = !1,
  Ls = /["\x26\xa0]/u,
  vo = new RegExp(Ls.source, "gu"),
  Ds = /[&<>\xa0]/u,
  wo = new RegExp(Ds.source, "gu");
var de = new Set([
  "area",
  "base",
  "br",
...
var st = Object.freeze({ line: 1, column: 0 }),
  Bs = Object.freeze({ source: "(synthetic)", start: st, end: st }),
  sr = Object.freeze({ source: "(nonexistent)", start: st, end: st }),
    ...
    if (Array.isArray(o)) hn(e, o, r, s);
      ...
      c !== void 0 &&
        (function (h, f, p, g) {
          ...
          if (Array.isArray(g)) {
            if (g.length !== 1)
              throw g.length === 0 ? Zr(p, h, f) : qs(p, h, f);
            en(h, f, g[0]);
          } else en(h, f, g);
        })(a, s, o, c);
    }
...
var Us = {
  ...
  element: function (e, t = {}) {
    ...
    return (
      f
        ? (E = v(f))
        : f === void 0 && (E = s || Os(r.original) ? null : v(null)),
      d.element({
        path: r,
        selfClosing: s || !1,
        attributes: n || [],
...
function mn(e, t = {}) {
  ...
  if (t.plugins?.ast)
    for (let c of t.plugins.ast)
      Hs(o, c(ze({}, t, { syntax: Ms }, { plugins: void 0 })).visitor);
  return o;
}
var zs = {
...
var Ni = { parse: wi, astFormat: "glimmer", locStart: mt, locEnd: Gt };
var Ai = { glimmer: _n };

...
var $e = (e, t, r) => (
    xs(e, t, "read from private field"),
    r ? r.call(e) : t.get(e)
  ),
  tn = (e, t, r) =>
    t.has(e)
...
var _ = { type: Y },
  ...
  Ms = { type: Y, hard: !0 },
  v = [Ms, j],
  Bs = { type: Y, hard: !0, literal: !0 },
  nn = [Bs, j];
var cn = Object.freeze({ character: "'", codePoint: 39 }),
  un = Object.freeze({ character: '"', codePoint: 34 }),
  Fs = Object.freeze({ preferred: cn, alternate: un }),
  qs = Object.freeze({ preferred: un, alternate: cn });
function Hs(e, t) {
...
var Er = (e) => (t, r, n) => x(b(n.node), t, { parser: e }, W),
  va = [
    ...
    { test: (e) => /^i18n(?:-.+)?$/u.test(e.node.fullName), print: Ta },
    { test: Un, print: Wn },
  ].map(({ test: e, print: t }) => ({
...
var wa = new Set(Cr),
  Yn = ({ node: e }, t) =>
    wa.has(e.fullName) && !t.parentParser && !e.value.includes("{{"),
  jn = (e, t, r) =>
    x(
      b(r.node),
      e,
...
function Pa(e) {
  ...
  function S() {
    ...
    if (!m)
      ...
      throw new Error(`Invalid srcset descriptor found in "${e}" at "${ee}".`);
  }
}
var ei = Pa;
var ti = (e) =>
  ...
  return (
    vr.has(r) ||
      vr.set(
        r,
        r.children.some(
          (n) => It(n, t) && ["ts", "typescript"].includes(n.attrMap.lang),
        ),
      ),
    vr.get(r)
  );
...
async function li(e, t, r, n) {
  let i = b(r.node),
    { left: s, operator: a, right: o } = Ia(i),
    c = G(r, n);
  return [
    C(
...
function Ia(e) {
  ...
  if (!c.some((u, p) => !u && (p === 0 || c.slice(p + 1).some(Boolean))))
    return { left: c.filter(Boolean).join(","), operator: i[2], right: s.for };
}
var Ra = [
...
var Fa = [
  ...
  ...ui,
  ...Gn,
].map(({ test: e, print: t }) => ({ test: e, print: Ha(t) }));
function qa(e, t) {
  let { node: r } = e,
    { value: n } = r;
  if (n)
...
function _e(e) {
  return (
    !e.next && !e.hasTrailingSpaces && e.isTrailingSpaceSensitive && O(Pt(e))
  );
}
function et(e) {
  return (
      ...
      if (!r.isSelfClosing && Ot(r, t)) {
        ...
        return n
          ? async (i, s) => {
              ...
              return (
                o ||
                  ((c = await i(fr(a), { parser: n, __embeddedInHtml: !0 })),
                  (o = c === "")),
                [
                  U(r, t),
                  C(rt(e, t, s)),
...
function Pi(e, t, r) {
  let { node: n } = e;
  if (Nt(n, t))
    return [U(n, t), C(rt(e, t, r)), L(qt(n, t)), ...Ze(n, t), V(n, t)];
  let i =
      n.children.length === 1 &&
...
var ro = "boolean",
  ...
  oo = Array.from(Ii).reduce((e, [t, r]) => (e.set(t, r), e), new Map()),
  Ri = class extends Di {
    constructor() {
      (super(),
    ...
    hasElement(e, t) {
      return t.some((r) => r.name === xr.name) ||
        (e.indexOf("-") > -1 &&
          (br(e) || wr(e) || t.some((r) => r.name === kr.name)))
        ? !0
  ...
  return (
    lt ||
      ...
      (lt = Object.assign(Object.create(null), {
        ...
        optgroup: new f({ closedByChildren: ["optgroup"], closedByParent: !0 }),
        option: new f({
        ...
        title: new f({
          contentType: { default: R.ESCAPABLE_RAW_TEXT, svg: R.PARSABLE_DATA },
        }),
        textarea: new f({
...
function ns(e, t, r, n = {}) {
  ...
  return (
    i.tokenize(),
    new Lo(Vo(i.tokens), i.errors, i.nonNormalizedIcuExpressions)
  );
}
var Po = /\r\n?/g;
function be(e) {
...
`,
    ...
    _consumePrefixAndName(e) {
      let t = this._cursor.clone(),
        r = "";
      for (; this._cursor.peek() !== 58 && !Ro(this._cursor.peek()); )
        this._cursor.advance();
      let n;
    ...
    decodeHexDigits(t, r) {
      ...
      if (isNaN(i))
        throw (
          ...
          new Vr("Invalid hexadecimal escape sequence", t)
        );
      return i;
    }
  },
    ...
    _collectExpansionExpTokens(t) {
      ...
      for (;;) {
        ...
        if (this._peek.type === l.EOF)
          return (
            this.errors.push(
              N.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'."),
            ),
            null
          );
...
`
    ...
    _consumeAttributesAndDirectives(t, r) {
      for (
        ;
        this._peek.type === l.ATTR_NAME || this._peek.type === l.DIRECTIVE_NAME;
      )
    ...
    _consumeDirective(t) {
      ...
      if ((this._advance(), this._peek.type === l.DIRECTIVE_OPEN)) {
        ...
        this._peek.type === l.DIRECTIVE_CLOSE
          ...
          : this.errors.push(
              N.create(null, t.sourceSpan, "Unterminated directive definition"),
            );
      }
    ...
    if (r.children)
      for (let n = 0; n < r.children.length; n++) {
        ...
        let s = i.prev,
          a = i.next;
        ((s.value +=
          `<${i.rawName}>` + i.firstChild.value + `</${i.rawName}>` + a.value),
...
var er = { attrs: !0, children: !0, cases: !0, expression: !0 },
  Ss = new Set(["parent"]),
  oe,
  $r,
  zr,
...
var pl = [
  ...
  { regex: /^\[if(?<condition>[^\]]*)\]><!$/u, parse: ml },
  { regex: /^<!\s*\[endif\]$/u, parse: fl },
];
function Es(e, t) {
  if (e.value)
    ...
    for (let r of e.attrs)
      r.namespace ||
        (r.name = Cs(
          r.name,
          (n) =>
            Zt.has(e.name) && (Zt.get("*").has(n) || Zt.get(e.name).has(n)),
        ));
}
function Xr(e, t) {
...
function bs(e, t) {
  ...
  if (
    ...
    return Xr(e, rr);
  let a,
    o = () => a ?? (a = Qt(e, { ...r, getTagContentType: void 0 })),
    c = (u) => {
...
function bl(e, t, r, n, i, s) {
  let { offset: a } = n,
    o = w(0, t.slice(0, a), /[^\n]/gu, " ") + r,
    c = Kr(o, e, { ...i, shouldParseFrontMatter: !1 }, s);
...
var wl = gt(rr),
  ...
  xl = gt({ ...rr, name: "mjml", shouldParseAsRawText: (e) => kl.has(e) }),
  Al = gt({
    name: "angular",

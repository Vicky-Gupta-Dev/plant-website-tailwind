...
var ut = (e, t, i) => (
  ...
  Bi(
    t || !e || !e.__esModule
      ? Be(i, "default", { value: e, enumerable: !0 })
      : i,
    e,
  )
);
      ...
      jsx_parseElementAt(c, x) {
        ...
        if (!I.selfClosing) {
          ...
          pe(de.name) !== pe(I.name) &&
            this.raise(
              de.start,
              "Expected corresponding JSX closing tag for <" + pe(I.name) + ">",
            );
        }
...
function Wi(e, t) {
  return function (i, s, r, o, u, p) {
    ...
    (e.locations && (h.loc = new be(this, u, p)),
...
var xe = 0,
  ...
  A = function (t, i, s) {
    ((this.options = t = Xi(t)),
      ...
      (this.keywords = H(
        Fi[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5],
      )));
    var r = "";
    (t.allowReserved !== !0 &&
...
d.parseCatchClauseParam = function () {
  var e = this.parseBindingAtom(),
    t = e.type === "Identifier";
  return (
    this.enterScope(t ? St : 0),
    this.checkLValPattern(e, t ? Tt : K),
...
d.parseExportDefaultDeclaration = function () {
  ...
  if (this.type === a._function || (e = this.isAsyncFunction())) {
    ...
    return (
      this.next(),
      e && this.next(),
      this.parseFunction(t, ae | At, !1, e)
    );
...
g.parseSubscripts = function (e, t, i, s, r) {
  for (
    ...
    if (
      (p.optional && (u = !0), p === e || p.type === "ArrowFunctionExpression")
    ) {
      if (u) {
  ...
  switch (this.type) {
    ...
    case a.name:
      ...
      if (r && !this.canInsertSemicolon()) {
        if (this.eat(a.arrow))
          return this.parseArrowExpression(this.startNodeAt(o, u), [h], !1, t);
        if (
          this.options.ecmaVersion >= 8 &&
          h.name === "async" &&
          this.type === a.name &&
...
var ts =
  ...
  Rt = Lt,
  is = Rt,
  ss = { 9: Pt, 10: It, 11: Nt, 12: Lt, 13: Rt, 14: is },
  rs =
  ...
  ns = Mt + " " + ts,
  os = { 9: Vt, 10: Ot, 11: Bt, 12: Dt, 13: Mt, 14: ns },
  Ft = {};
function us(e) {
  var t = (Ft[e] = {
    binary: H(ss[e] + " " + lt),
    binaryOfStrings: H(as[e]),
    nonBinary: { General_Category: H(lt), Script: H(os[e]) },
  });
...
for (me = 0, Fe = [9, 10, 11, 12, 13, 14]; me < Fe.length; me += 1)
  ((ft = Fe[me]), us(ft));
var ft,
  me,
  Fe,
...
f.regexp_disjunction = function (e) {
  ...
  for (
    t && (e.branchID = new ve(e.branchID, null)), this.regexp_alternative(e);
    e.eat(124);
  )
...
f.regexp_eatZero = function (e) {
  return e.current() === 48 && !Ee(e.lookahead())
...
f.regexp_eatClassAtom = function (e) {
  ...
  if (e.eat(92)) {
    ...
    if (e.switchU) {
      var i = e.current();
      ((i === 99 || Ht(i)) && e.raise("Invalid class escape"),
        e.raise("Invalid escape"));
    }
    e.pos = t;
  }
...
f.regexp_eatNestedClass = function (e) {
  ...
  if (e.eat(91)) {
    ...
    if (e.eat(93))
      return (
        i && s === B && e.raise("Negated character class may contain strings"),
        s
      );
    e.pos = t;
  }
  ...
  e: for (; this.pos < this.input.length; ) {
    ...
    switch (e) {
      ...
      case 47:
        ...
        break;
      default:
        if ((e > 8 && e < 14) || (e >= 5760 && yt.test(String.fromCharCode(e))))
          ++this.pos;
        else break e;
    }
  }
...
function or(e = 5) {
  ...
  if ((t >= 2015 && (t -= 2009), !Ti.includes(t)))
...
var pr = {
  ...
  get jsx() {
    return (
      this._jsx === null && (this._jsx = A.extend((0, Ai.default)(), nt())),
      this._jsx
    );
  },
  get(e) {
...
function lr(e) {
  ...
  return typeof i != "number"
    ? e
    : Ae(t, { loc: { start: { line: i, column: s } }, cause: e });
}
function fr(e, t) {
  let i = Ve(t?.filepath),
    s = (i ? [i] : Re).map((o) => () => ki(e, { ...cr, sourceType: o })),
    r;
  try {
    r = ke(s);
  } catch ({ errors: [o] }) {

...
var si = Object.freeze({ character: "'", codePoint: 39 }),
  ii = Object.freeze({ character: '"', codePoint: 34 }),
  Ua = Object.freeze({ preferred: si, alternate: ii }),
  Ya = Object.freeze({ preferred: ii, alternate: si });
function Ha(e, t) {
...
function It(e, t) {
  ...
  if (r.length === 1) {
    ...
    return r[2] && !Ce(r[2])
      ? !1
      : (r.length === 2 ? Ht(r[1]) : cp(r[1]) && K(r[1]).length <= 1) ||
          Wn(r[1]);
  return !1;
}
var Fi = (e) => (t) => (
...
function di(e, t) {
  ...
  for (let n in e) {
    let s = e[n];
    if (
      (Lr(s) && typeof s.type == "string" && (r++, (r += di(s, t - r))), r > t)
    )
      return r;
  }
  return r;
...
`),
  ...
  return J(e)
    ...
    : (e.type === "UnaryExpression" && Ep.has(e.operator)) ||
...
function gp(e, t) {
  return Cp(e) || Ap(e, t) || Tp(e, t)
    ...
    : e.type === "EmptyStatement"
      ...
      : !(
          xp(e, t) ||
          (e.type === "TSTypeAnnotation" && t[0].type === "TSPropertySignature")
        );
}
var Pi = gp;
function hp(e) {
...
function Wp({
  ...
  return Se(r)
    ? (Lt(e) && ((n.prettierIgnore = !0), (e.unignore = !0)),
      t ? ($(t, e), !0) : !1)
    : (Se(n) && Lt(e) && ((n.types[0].prettierIgnore = !0), (e.unignore = !0)),
      !1);
}
function qp({
  comment: e,
...
var Ri = k([
  ...
  nc = { endOfLine: Ip, ownLine: kp, remaining: Lp },
  Ji = nc;
...
function lc(e) {
  if ((e.type === Fe && e.break) || (e.type === me && e.hard) || e.type === Ne)
    return !0;
}
function ne(e) {
  return Yi(e, lc, !1);
...
`,
      ...
      case Me: {
        ...
        let it = fe[U + 2],
          Bt = { indent: h, mode: g, doc: { ...S, [cs]: U + 2 } },
          Pr = Zr(
...
function bc(e, t, r) {
  ...
  if (s.length > 1 || s.some((i) => i.length > 0)) {
    ...
    let o = i.map(
        (D) =>
          "${" +
          ls(D, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })
            .formatted +
          "}",
      ),
...
function tn(e, t) {
  return ft(e, (r) =>
    typeof r == "string" ? (t ? W(0, r, /(\\*)`/gu, "$1$1\\`") : ms(r)) : r,
  );
}
function ms(e) {
  return W(0, e, /([\\`]|\$\{)/gu, "\\$1");
...
function oo(e) {
  let t = (n) => n.type === "TemplateLiteral",
    r = (n, s) =>
      ...
      s === "value";
  return (
    e.match(t, (n, s) => q(n) && s === "elements", r, ...fs) ||
    e.match(t, r, ...fs)
  );
}
function ys(e) {
...
function rn({ node: e, parent: t }, r) {
  return (
    Ds(e, r) ||
    (Ic(t) && Ds(t, r)) ||
    (t.type === "ExpressionStatement" && Ds(t, r))
  );
}
function Ic(e) {
  return (
...
var jc = [
  ...
  { test: ys, print: yo },
  { test: Fo, print: Eo },
].map(({ test: e, print: t }) => ({ test: e, print: Rc(t) }));
function vc(e) {
  let { node: t } = e;
...
function xo(e, t) {
  return [...ho, ...(Array.isArray(t) ? t : [t])].map((r) =>
    `@${e} ${r}`.trim(),
  );
}
var ko = "format";
...
function ds(e, t) {
  ...
  if (t.__isInHtmlInterpolation && !t.bracketSpacing && el(r) && xr(e))
    return !0;
  if (Qc(r)) return !1;
...
function ol(e, t, r) {
  ...
  return !p || r?.hasLineSuffix
    ? { doc: [us([" ", s]), ke], isBlock: p, hasLineSuffix: !0 }
...
function Q(e) {
  let { node: t } = e;
  return t.declare || (pl(t) && e.parent.type !== "DeclareExportDeclaration")
    ? "declare "
    : "";
}
var cl = k([
...
function Ts(e, t, r, n, s) {
  ...
  let u = er(i),
    ...
    c =
      (i.operator === "|>" || i.type === "NGPipeExpression" || yl(e, t)) &&
      !Ee(t.originalText, p),
  ...
  if (p.length === 0) s.push(Al(e, t, i, o));
    ...
    s.push(
      l(
        [
          i,
          m([f, d ? xl(e, t, r, b) : [Tl(e, t, r, u, n.inexact), b], v(e, t)]),
          f,
          o,
        ],
        { shouldBreak: C, id: F },
...
function Uo(e) {
  ...
  if (Ae(e) || e.type === "TypeCastExpression") {
    ...
    if (
      ...
      let r =
        t.type === "GenericTypeAnnotation" ? t.typeParameters : t.typeArguments;
...
function Xo(e, t, r) {
  ...
  function d(_) {
    ...
    return (
      J(ae) && ae.property.type === "Identifier" && (F(ae.property.name) || re)
    );
  }
...
function _l(e, t, r, n, s) {
  ...
  if (
    e.match(
      ...
      (F) =>
        !u ||
        (F.type !== "ExpressionStatement" && F.type !== "VariableDeclaration"),
    )
  )
    return u
...
function Ml(e, t, r, n) {
  ...
  switch (s.type) {
    ...
    case "ConditionalExpression": {
      ...
      return (
        u.type === "ConditionalExpression" || p.type === "ConditionalExpression"
      );
    }
    case "ClassExpression":
...
function Nl(e) {
  if (eu(e)) {
    ...
    return (
      ...
      t.properties.some(
        (r) => Oe(r) && (!r.shorthand || r.value?.type === "AssignmentPattern"),
      )
    );
  }
  return !1;
...
function Rl(e) {
  ...
  return (
    R(r) &&
    r.length > 1 &&
    r.some((n) => R(Ko(n)) || n.type === "TSConditionalType")
  );
}
function Bs(e) {
  return (
...
function Vl(e, t, r) {
  ...
  n.children = n.children.map((g) =>
    cm(g) ? { type: "JSXText", value: " ", raw: " " } : g,
  );
  let o = n.children.some(H),
    u =
      n.children.filter((g) => g.type === "JSXExpressionContainer").length > 1,
    ...
    e.each(({ node: c, next: y }) => {
      if (c.type === "JSXText") {
        ...
        if (Br(c)) {
          ...
          F[0] === "" &&
            (F.shift(),
            /\n/u.test(F[0]) ? p(lu(s, F[1], c, y)) : p(n),
            F.shift());
          let C;
          if ((N(0, F, -1) === "" && (F.pop(), (C = F.pop())), F.length === 0))
            return;
...
function fu({ node: e, index: t }) {
  return (
    e.type === "NGMicrosyntaxKeyedExpression" && e.key.name === "of" && t === 1
  );
}
function mm(e) {
  let { node: t } = e;
...
function Fu(e, t, r) {
  ...
  let o =
    n.type === "ClassExpression" || n.type === "ClassDeclaration" || du(n, t);
  return [
...
function Tu(e, t, r, n = {}) {
  ...
  let y = !Ee(t.originalText, c) && (ym(c) || Fm(c, i, t) || (!u && Au(c))),
    ...
    C = dm(e, n, { signatureDocs: s, shouldBreak: u }),
    d = !1,
    b = !1,
    B = !1;
  return (
...
function Cm(
  ...
  t,
  r,
  { bodyDoc: n, bodyComments: s, functionBody: i, shouldPutBodyOnSameLine: o },
) {
...
function Rt(e, t, r) {
  ...
  if (
    (hm(e, ({ node: F, next: C, isLast: d }) => {
      ...
      (!o &&
        (Sm({ node: F, next: C }, t) || bu({ node: F, next: C }, t)) &&
        s.push(";"),
...
function hm(e, t) {
  ...
  if (r.type === "ObjectTypeAnnotation") {
    let n = ["properties", "indexers", "callProperties", "internalSlots"]
      .flatMap((s) =>
        e.map(
          ({ node: i, index: o }) => ({ node: i, loc: w(i), selector: [s, o] }),
          s,
        ),
      )
    ...
    : r.type === "TSTypeLiteral"
      ? e.isLast
        ? t.semi
          ? P(";")
          : ""
        : t.semi || bu({ node: e.node, next: e.next }, t)
          ? ";"
          : P("", ";")
      : "";
}
...
function km(e) {
  return e.type === "ObjectTypeAnnotation"
    ? ["properties", "indexers", "callProperties", "internalSlots"].some((t) =>
        R(e[t]),
      )
    : R(e.body);
}
...
function ur(e, t, r, n) {
  ...
  let Vs = Symbol("test"),
    ...
    Sa = Mn
      ? l([$s, g ? Ir : P(Ir, l(Ir, { id: xa }), { groupId: Vs })], { id: kr })
      : [$s, Ir],
    Nn = r(p),
    ...
    case "AwaitExpression": {
      ...
      if (s.argument) {
        ...
        if ((M(o) && o.callee === s) || (J(o) && o.object === s)) {
          ...
          if (u?.type !== "AwaitExpression" || !ye(u.argument, (p) => p === s))
            return l(i);
        }
      }
      return i;
...
function oD(e) {
  return ua(e) || e.type === "MatchObjectPattern"
    ? !0
...
function aa(e, t, r) {
  ...
  if (
    (n.supertype && s.push(": ", r("supertype")), n.lowerBound || n.upperBound)
  ) {
    let i = [];
...
function Gt(e, t, r, n) {
  ...
  if (
    ...
    (!o &&
      (i ||
        (s[n].length === 1 &&
          (s[n][0].type === "NullableTypeAnnotation" || Jo(s[n][0])))))
  )

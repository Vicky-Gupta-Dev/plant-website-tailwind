(function (n) {
  ...
  var x = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
    Vn = (e, r) => {
      for (var t in r) Tr(e, t, { get: r[t], enumerable: !0 });
    },
    jn = (e, r, t, n) => {
  ...
  var Re = (e, r, t) => (
    ...
    xl = (e) => jn(Tr({}, "__esModule", { value: !0 }), e);
  var Br = x((EF, $n) => {
    "use strict";
    $n.exports = Bl;
    function Bl(e) {
  ...
  var Zi = x((XC, Qi) => {
    ...
    function rD(e, r) {
      ...
      function p(b, d, y) {
        ...
        if (d.charCodeAt(B++) === je && d.charCodeAt(B++) === hr) {
          ...
          if (!(N === void 0 || P === N || d.charCodeAt(B++) !== Kf)) {
            if (y) return !0;
            for (
              S = d.slice(P, N), I = b.now(), ie = 0, Z = 0, ve = B, Ae = [];
              B < T;
            ) {
              if (((O = d.charCodeAt(B)), O !== O || O === Vr))
                ((G = {
                  start: ie,
                  contentStart: ve || B,
                  contentEnd: B,
            ...
            for (
              B = -1, T = Ae.length;
              T > 0 && ((G = Ae[T - 1]), G.contentStart === G.contentEnd);
            )
              T--;
            for (le = b(d.slice(0, G.contentEnd)); ++B < T; )
              ((G = Ae[B]),
                (k[I.line + B] =
                  (k[I.line + B] || 0) + (G.contentStart - G.start)),
      ...
      function g(b, d, y) {
        ...
        if (
          (d.charCodeAt(w) === Hf && w++,
          d.charCodeAt(w) === je && d.charCodeAt(w + 1) !== hr)
        )
          return l.call(this, b, d, y);
      }
      function E(b, d, y) {
        for (var w = 0, C = d.charCodeAt(w); C === Ve || C === pr; )
          C = d.charCodeAt(++w);
        if (C === je && d.charCodeAt(w + 1) !== hr)
          return s.call(this, b, d, y);
      }
      function v(b, d) {
        return b.indexOf("[", d);
      }
    ...
    function lD(e, r) {
      ...
      function u(a, o, s) {
        let l = o.length,
          ...
          v;
        if (
          (o.charCodeAt(D) === nu && ((f = !0), D++), o.charCodeAt(D) === Hr)
        ) {
          if ((D++, f))
            return s ? !0 : a(o.slice(0, D))({ type: "text", value: "$" });
          if (
            (o.charCodeAt(D) === Hr && ((c = !0), D++),
            (h = o.charCodeAt(D)),
            !(h === tu || h === ru))
          ) {
            for (F = D; D < l; ) {
...
`,
  ...
  var mr = x((dv, Ku) => {
    ...
    function rp(e, r) {
      ...
      for (
        ...
        if ((y === Uu && (h = f[p] || 1), (y = e.charCodeAt(m)), y === Yu)) {
          if (
            ((C = e.charCodeAt(m + 1)),
            C === WD ||
              C === Uu ||
          ...
          ((b = e.charCodeAt(L) === $D),
            ...
            w
              ? (ve(),
                ...
                (le = ie()),
                le.offset++,
                u && u.call(s, w, { start: I, end: le }, e.slice(P - 1, L)),
                (I = le))
              : ((d = e.slice(P - 1, L)),
                (g += d),
                (h += d.length),
  ...
  var Qu = x((mv, Ju) => {
    ...
    function up(e) {
      return ((t.raw = n), t);
      function r(u) {
        for (var a = e.offset, o = u.line, s = []; ++o && o in a; )
          s.push((a[o] || 0) + 1);
      ...
      function n(u, a, o) {
        return Xu(u, ip(o, { position: r(a), warning: i }));
      }
      function i(u, a, o) {
    ...
    function Dp(e) {
      ...
      for (n in fp) {
        if (
          ((i = e[n]),
          i == null && (i = t[n]),
          (n !== "blocks" && typeof i != "boolean") ||
            (n === "blocks" && typeof i != "object"))
        )
          throw new Error(
            "Invalid value `" + i + "` for setting `options." + n + "`",
          );
        e[n] = i;
      }
      ...
      function a(o, s, l) {
        ...
        function D() {
          ...
          if (
            ...
            return p;
          if (o.children && p[0] !== ma)
            for (
              F = (n ? o.children.length : -1) + i;
...
`,
  ...
  var ka = x((Tv, wa) => {
    ...
    function Np(e, r, t) {
      for (
        var n, i = "", u = 0, a = r.length;
        u < a && ((n = qp.exec(r.slice(u))), n != null);
      )
        ((u += n[0].length), (i += n[0]));
      if (i !== "") {
        if (t) return !0;
...
`,
    ...
    function Up(e, r, t) {
      for (
        var n = -1, i = r.length, u = "", a = "", o = "", s = "", l, c, f;
        ++n < i;
      )
        if (((l = r.charAt(n)), f))
          if (((f = !1), (u += o), (a += s), (o = ""), (s = ""), l === Zt))
            ((o = l), (s = l));
          else
            for (u += l, a += l; ++n < i; ) {
      ...
      if (a)
        return t
          ? !0
          : e(u)({ type: "code", lang: null, meta: null, value: Lp(a) });
    }
  });
  var Ia = x((qv, Pa) => {
    "use strict";
...
`,
    ...
    function Wp(e, r, t) {
      var n = this,
        ...
        A;
      if (i) {
        for (; a < u && ((c = r.charAt(a)), !(c !== Xe && c !== Fr)); )
          ((o += c), a++);
        if (((v = a), (c = r.charAt(a)), !(c !== Yp && c !== Na))) {
          for (
            a++, l = c, s = 1, o += c;
            a < u && ((c = r.charAt(a)), c === l);
          )
            ((o += c), s++, a++);
          if (!(s < Gp)) {
            for (; a < u && ((c = r.charAt(a)), !(c !== Xe && c !== Fr)); )
            ...
            if (((c = r.charAt(a)), !(c && c !== rt))) {
              ...
              for (var b = !0; a < u; ) {
                ...
                if (((g += p), (E += p.slice(v)), !(p.length >= zp))) {
                  for (p = ""; a < u && ((c = r.charAt(a)), c === l); )
                    ((p += c), a++);
                  if (((g += p), (E += p), !(p.length < s))) {
                    for (
                      p = "";
                      a < u && ((c = r.charAt(a)), !(c !== Xe && c !== Fr));
                    )
                      ((g += c), (E += c), a++);
                    if (!c || c === rt) break;
                  }
...
`,
    ...
    function Kp(e, r, t) {
      ...
      if (r.charAt(p) === Ma) {
        ...
        for (p = -1, l = D.length, m = e(c.join(rn)); ++p < l; )
          ((i[s] = (i[s] || 0) + D[p]), s++);
        return (
          (d = n.enterBlock()),
...
`,
  ...
  var nn = x((Lv, Ka) => {
    ...
    function sh(e) {
      for (
        var r = 0, t = 0, n = e.charAt(r), i = {}, u, a = 0;
        n === Ha || n === uh;
      ) {
        for (
          u = n === Ha ? oh : ah, t += u, u > 1 && (t = Math.floor(t / u) * u);
          a < t;
        )
          i[++a] = r;
        n = e.charAt(++r);
    ...
    function kh(e, r, t) {
      for (
        var n = this,
          ...
          O,
          I;
        s < l && ((p = r.charAt(s)), !(p !== nt && p !== Ee));
      )
        s++;
      if (((p = r.charAt(s)), p === un || p === eo || p === an))
        ((h = p), (m = !1));
      else {
        for (m = !0, D = ""; s < l && ((p = r.charAt(s)), !!Za(p)); )
          ((D += p), s++);
        if (
          ((p = r.charAt(s)),
          !D || !(p === ro || (i && p === to)) || (t && D !== "1"))
      ...
      if (
        ...
        for (s = 0, w = [], C = [], k = []; s < l; ) {
          ...
          if (
            (T && f >= T.indent && (I = !0), (p = r.charAt(s)), (v = null), !I)
          ) {
            if (p === un || p === eo || p === an) ((v = p), s++, f++);
            else {
              for (D = ""; s < l && ((p = r.charAt(s)), !!Za(p)); )
                ((D += p), s++);
              ((p = r.charAt(s)),
                s++,
                D &&
            ...
            if (v)
              if (((p = r.charAt(s)), p === nt)) ((f += ke - (f % ke)), s++);
              else if (p === Ee) {
          ...
          if (((d = y), (y = !E && !dh(A).length), I && T))
            ...
            (k.length !== 0 &&
              ((S = !0), T.value.push(""), (T.trail = k.concat())),
              (T = { value: [b], indent: f, trail: [] }),
              w.push(T),
              (C = C.concat(k, b)),
              (k = []));
          else if (y) {
...
`,
    ...
    function Sh(e, r, t) {
      for (
        var n = this, i = e.now(), u = r.length, a = -1, o = "", s, l, c, f, D;
        ++a < u;
      ) {
  ...
  var cn = x((sn) => {
    "use strict";
    var Lh = "[a-zA-Z_:][a-zA-Z0-9:._-]*",
      Rh = "[^\"'=<>`\\u0000-\\u0020]+",
      Mh = "'[^']*'",
      Uh = '"[^"]*"',
      Yh = "(?:" + Rh + "|" + Mh + "|" + Uh + ")",
      Gh = "(?:\\s+" + Lh + "(?:\\s*=\\s*" + Yh + ")?)",
      co = "<[A-Za-z][A-Za-z0-9\\-]*" + Gh + "*\\s*\\/?>",
      lo = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",
      zh = "<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->",
      Wh = "<[?].*?[?]>",
      Vh = "<![A-Za-z]+\\s+[^>]*>",
      jh = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>";
    ...
    function Ed(e, r, t) {
      ...
      if (((f = r.charAt(u)), f === Dn)) {
        ...
        if (!(!c || r.charAt(u) !== vr || r.charAt(u + 1) !== Co)) {
          for (
            m = c, o += c + vr + Co, u = o.length, c = "";
            u < a && ((f = r.charAt(u)), !(f !== it && f !== ut && f !== Qe));
          )
            ((o += f), u++);
          if (((f = r.charAt(u)), (c = ""), (s = o), f === vo)) {
            for (u++; u < a && ((f = r.charAt(u)), !!fn(f)); ) ((c += f), u++);
            if (((f = r.charAt(u)), f === fn.delimiter))
              ((o += vo + c + f), u++);
            else {
              if (i) return;
              ((u -= c.length + 1), (c = ""));
          ...
          if (c) {
            ...
            for (; u < a && ((f = r.charAt(u)), !(f !== it && f !== ut)); )
              ((o += f), u++);
      ...
      if (n.options.gfm) {
        ...
        if ((a !== !1 && p.push(a), !(p.length < kd))) {
          ...
          for (
            E = -1,
              b = [],
              d = e(o).reset({ type: "table", align: p, children: b });
            ++E < v;
          ) {
            for (
              A = c[E],
              ...
              (D === "" || D === pn
                ? F
                  ...
                  : ((h || D) &&
                      ...
                      (g = e.now()),
                      e(o)(
                        { type: "tableCell", children: n.tokenizeInline(h, g) },
                        s,
                      )),
                    e(f + D),
                    (f = ""),
...
`,
    ...
    function Po(e, r, t) {
      var n = this,
        i,
        u;
      if (r.charAt(0) === No && ((i = r.charAt(1)), n.escape.indexOf(i) !== -1))
        return t
          ? !0
          : (i === Ud
              ? (u = { type: "break" })
    ...
    function gn(e, r, t) {
      ...
      if (r.charAt(0) === Mo) {
        for (
          ...
          ((o += c), a++);
        if (o) {
          if (((l += o), (o = ""), (c = r.charAt(a)), (l += c), a++, c === Uo))
            s = !0;
          else {
            if (c !== ":" || r.charAt(a + 1) !== mn) return;
            ((l += mn), a++);
          }
          for (; a < u && ((c = r.charAt(a)), !(Ro(c) || c === dn)); )
            ((o += c), a++);
          if (((c = r.charAt(a)), !(!o || c !== dn)))
            return t
              ...
              : ((l += o),
                ...
                f.offset++,
                s &&
                  (l.slice(0, ot).toLowerCase() === Fn
                    ? ((D = D.slice(ot)), (f.column += ot), (f.offset += ot))
                    : (l = Fn + l)),
  ...
  var $o = x((Zv, jo) => {
    ...
    function Vd(e, r) {
      ...
      for (i = Vo.length, n = -1; ++n < i; )
        ((u = e.indexOf(Vo[n], r)), u !== -1 && (t === -1 || u < t) && (t = u));
      return t;
    }
  });
  var Qo = x((e2, Jo) => {
    ...
    function vn(e, r, t) {
      ...
      if (i) {
        ...
        if (
          ...
          for (
            F = D, m = D;
            D < a && ((h = r.charCodeAt(D)), !(Hd(h) || h === u0));
          )
            (D++,
              h === Xd ||
                h === Zd ||
          ...
          if (((D = F), r.charCodeAt(D - 1) === Qd))
            for (p = r.slice(m, D), g = Ho(p, o0), E = Ho(p, Xo); E > g; )
              ((D = m + p.lastIndexOf(Xo)), (p = r.slice(m, D)), E--);
          ...
          return (
            ...
            d(),
            e(v)({ type: "link", title: null, url: b, children: A })
          );
        }
      }
    }
  ...
  var ts = x((r2, rs) => {
    ...
    function es(e, r) {
      ...
      if (((i = n), i === r || !Zo(e.charCodeAt(i - 1))))
        return es.call(t, e, n + 1);
      ...
      if (
        ...
        return t
          ...
          : ((a = a[0]),
            !n.inLink && y0.test(a)
              ? (n.inLink = !0)
              : n.inLink && w0.test(a) && (n.inLink = !1),
            e(a)({ type: "html", value: a }));
    }
  });
  var yn = x((i2, ls) => {
    "use strict";
...
`,
    ...
    function ds(e, r, t) {
      ...
      if (
        ...
        if (c) {
          for (E = y, i += y + h, u++; u < A && ((a = r.charAt(u)), !!br(a)); )
            ((i += a), u++);
          ...
          if (r.charAt(u) === xr)
            return t
              ? !0
              : ((i += xr),
                (w = n.decode.raw(n.unescape(w), e(m).test().end, {
                  nonTerminated: !1,
                })),
                b &&
                  ((p = e(p).test().end), (b = n.decode.raw(n.unescape(b), p))),
                (T = { type: g ? "image" : "link", title: b || null, url: w }),
                g
                  ? (T.alt = n.decode.raw(n.unescape(E), C) || null)
                  : ((k = n.enterLink()),
                    (T.children = n.tokenizeInline(E, C)),
                    k()),
                e(i)(T));
        }
      }
      ...
      if ((u === R0 && ((c = I0), (l = u), (u = r.charAt(++a))), u === ct)) {
        ...
        if (((s = g), (D = g), (u = r.charAt(a)), u === ft)) {
          ...
          if (((u = r.charAt(a)), u === ct)) {
            for (
              m = "", g += u, a++;
              a < o && ((u = r.charAt(a)), !(u === ct || u === ft));
            )
              (u === lt && ((m += lt), (u = r.charAt(++a))), (m += u), a++);
            ((u = r.charAt(a)),
              u === ft ? ((f = m ? Bn : L0), (g += m + u), a++) : (m = ""),
              (s += g),
              (g = ""));
          } else {
            if (!D) return;
              ...
              c === Tn && n.inLink
                ...
                : t
                  ...
                  : ((p = e.now()),
                    ...
                    c === Tn
                      ? ((F = n.enterLink()),
                        (h.children = n.tokenizeInline(D, p)),
                        F())
    ...
    function Us(e, r, t) {
      ...
      if (
        ...
        for (
          ...
          if (((i = r.charAt(s)), i === Dt && u === Dt && (!a || !Rs(a))))
            return t
              ? !0
              : e(Ms + o + Ms)({
                  type: "delete",
  ...
  var $s = x((d2, js) => {
    ...
    function Vs(e, r, t) {
      for (
        var n = r.length, i = 0, u, a, o, s, l, c;
        i < n && r.charCodeAt(i) === qn;
      )
        i++;
      if (!(i === 0 || i === n)) {
...
`,
  ...
  var sc = x((C2, oc) => {
    ...
    function ac(e) {
      var r = this.data("settings"),
        t = hm(uc);
      ((t.prototype.options = dm(t.prototype.options, r, e)),
        (this.Parser = t));
    }
  });
  var lc = x((v2, cc) => {
    ...
    var ht = Object.prototype.hasOwnProperty,
      ...
      hc = function (r) {
        return typeof Array.isArray == "function"
          ? Array.isArray(r)
          : gc.call(r) === "[object Array]";
      },
      dc = function (r) {
        if (!r || gc.call(r) !== "[object Object]") return !1;
        var t = ht.call(r, "constructor"),
          n =
            r.constructor &&
            r.constructor.prototype &&
            ht.call(r.constructor.prototype, "isPrototypeOf");
              ...
              o !== i &&
                (c && i && (dc(i) || (u = hc(i)))
                  ? (u
                      ? ((u = !1), (a = n && hc(n) ? n : []))
                      : (a = n && dc(n) ? n : {}),
                    mc(o, { name: t, newValue: e(c, a, i) }))
                  : typeof i < "u" && mc(o, { name: t, newValue: i })));
      return o;
    };
  });
  var Ac = x((x2, vc) => {
    ...
    function kc() {
      ...
      function t() {
        ...
        function o(s) {
          ...
          ((u = f),
            l ? wc(l, o).apply(null, u) : a.apply(null, [null].concat(u)));
        }
      }
      function n(i) {
  ...
  var Gc = x((O2, Yc) => {
    ...
    function Lm(e) {
      (Mn(e, "basename"),
        Rn(e, "basename"),
        (this.path = ce.join(this.dirname || "", e)));
    }
    function Rm() {
    ...
    function Rn(e, r) {
      if (e && e.indexOf(ce.sep) > -1)
        throw new Error(
          "`" + r + "` cannot be a path: did not expect `" + ce.sep + "`",
        );
    }
    function Mn(e, r) {
  ...
  var rl = x((P2, el) => {
    ...
    function Zc() {
      ...
      function s(F) {
        ...
        function v(d) {
          if (typeof d == "function") b(d);
            ...
            "length" in d ? b.apply(null, d) : E(d);
        ...
        function A(d) {
          ...
          if (d != null)
            if (typeof d == "object" && "length" in d)
              for (; ++y < d.length; ) v(d[y]);
            else throw new Error("Expected a list of plugins, not `" + d + "`");
        }
        function b(d, y) {
          var w = l(d);
          w
            ? (Hc(w[1]) && Hc(y) && (y = mt(!0, w[1], y)), (w[1] = y))
            : e.push(Hm.call(arguments));
        }
      }
      function l(F) {
      ...
      function c(F) {
        ...
        return (
          ...
          (E = u.Parser),
          Un("parse", E),
          Kc(E, "parse") ? new E(String(g), g).parse() : E(String(g), g)
        );
      }
      function f(F, g, E) {
        if (
          (Xc(F),
          a(),
          !E && typeof g == "function" && ((E = g), (g = null)),
          !E)
        )
      ...
      function m(F, g) {
        ...
        return (
          ...
          Yn("stringify", v),
          Xc(F),
          Kc(v, "compile") ? new v(F, E).compile() : v(F, E)
        );
      }
      function p(F, g) {
        if ((a(), Un("process", u.Parser), Yn("process", u.Compiler), !g))
    ...
    function Kc(e, r) {
      return (
        typeof e == "function" &&
        e.prototype &&
        (eF(e.prototype) || r in e.prototype)
      );
    }
    function eF(e) {
      var r;
  ...
  var V = "string",
    ...
    me = "label",
    te = "break-parent",
    _r = new Set([be, ee, re, De, X, J, Q, pe, he, de, $, me, te]);
  function Ol(e) {
      ...
      switch (W(u)) {
        ...
        case X: {
          ...
          return (
            ...
            r({ ...u, contents: o, expandedStates: a })
          );
        }
        case re:
        case ee:
...
`),
  ...
  function Fe(e, r) {
    return (Zn(e), ne(r), { type: re, contents: r, n: e });
  }
  function ur(e) {
  ...
  function ei(e, r = "", t = {}) {
    return (
      ne(e),
      r !== "" && ne(r),
      { type: Q, breakContents: e, flatContents: r, groupId: t.groupId }
    );
  }
  function Or(e, r) {
    (ne(e), qr(r));
    ...
    for (; t >= 0; ) {
      ...
      switch (D) {
        ...
        case X: {
          ...
          let m = f.break ? H : c,
            p =
              f.expandedStates && m === H
                ? U(0, f.expandedStates, -1)
                : f.contents;
          s.push({ mode: m, doc: p });
          break;
        }
...
`,
        ...
        case j:
          for (let b = A.length - 1; b >= 0; b--)
            a.push({ indent: E, mode: v, doc: A[b] });
          break;
        case be:
          if (c.length >= 2)
          ...
          break;
        case ee:
          a.push({ indent: ai(E, r), mode: v, doc: A.contents });
          break;
        case re:
          a.push({ indent: ui(E, A.n, r), mode: v, doc: A.contents });
          break;
        case De:
          g();
          break;
        case X:
          switch (v) {
            ...
            case H: {
              s = !1;
              let b = { indent: E, mode: ue, doc: A.contents },
                d = n - u,
                y = l.length > 0;
                ...
                if (A.break) {
                  ...
                  for (let C = 1; C < A.expandedStates.length + 1; C++)
                    if (C >= A.expandedStates.length) {
                      ...
                      let k = A.expandedStates[C],
                        T = { indent: E, mode: ue, doc: k };
                      if (Ir(T, a, d, y, t)) {
                        a.push(T);
                        break;
                      }
        ...
        case J: {
          ...
          let C = y[d + 0],
            k = y[d + 1],
            T = { indent: E, mode: ue, doc: C },
            B = { indent: E, mode: H, doc: C },
            _ = Ir(T, [], b, l.length > 0, t, !0);
          if (w === 1) {
            _ ? a.push(T) : a.push(B);
            break;
          }
          let S = { indent: E, mode: ue, doc: k },
            P = { indent: E, mode: H, doc: k };
          if (w === 2) {
            _ ? a.push(S, T) : a.push(P, B);
            break;
          }
          let N = y[d + 2],
            O = { indent: E, mode: v, doc: { ...A, [bt]: d + 2 } },
            le = Ir(
              { indent: E, mode: ue, doc: [C, k, N] },
              [],
              b,
              l.length > 0,
              t,
        ...
        case $:
          switch (v) {
            ...
            case H:
              if (l.length > 0) {
                (a.push({ indent: E, mode: v, doc: A }, ...l.reverse()),
                  (l.length = 0));
                break;
              }
              A.literal
                ? ((o += i),
                  (u = 0),
                  E.root &&
                    (E.root.value && (o += E.root.value), (u = E.root.length)))
    ...
    function g() {
      ...
      (E && (f.push(E), (m += E.length)),
        ...
        (u -= v),
        c.length > 0 &&
          (D.push(...c.map((A) => Math.min(A, m))), (c.length = 0)));
    }
  }
  function Kl(e, r) {
    ...
    return (
      t.reduce || (t = [...t]),
      t.reduce((n, [i]) => Math.max(n, i.length), 0) / r.length
    );
  }
  var Sr = Kl;
  function Xl(e, r) {
  ...
  var si = Xl;
  var ci = Object.freeze({ character: "'", codePoint: 39 }),
    li = Object.freeze({ character: '"', codePoint: 34 }),
    Jl = Object.freeze({ preferred: ci, alternate: li }),
    Ql = Object.freeze({ preferred: li, alternate: ci });
  function Zl(e, r) {
  ...
  var di = (e) => String(e).split(/[/\\]/u).pop(),
    mi = (e) => String(e).startsWith("file:");
  function Fi(e, r) {
    if (!r) return;
  ...
  function gi(e, r) {
    if (r) {
      ...
      if (typeof r == "string")
        return e.find(({ isSupported: t }) => t?.({ filepath: r }));
    }
  }
  function cf(e, r) {
...
`)),
  ...
  var Rr = (e) => _e(e).content.trimStart().match(vi)?.index === 0,
    Ai = (e) => _e(e).content.trimStart().match(Ci)?.index === 0,
    bi = (e) => {
...
`,
  ...
  var Tt = new Set([
    ...
    Mr = new Set([...Tt, "tableCell", "paragraph", "heading"]),
    We = "non-cjk",
    ae = "cj-letter",
    Pe = "k-letter",
    cr = "cjk-punctuation",
...
`
  ...
  function ze(e, r) {
    let t = r.originalText.slice(
        e.position.start.offset,
        e.position.end.offset,
      ),
      { numberText: n, leadingSpaces: i } = t.match(
...
`)
  ...
  function ye(e, r) {
    return (function t(n, i, u) {
      ...
      return (
        a.children &&
          (a.children = a.children.map((o, s) => t(o, s, [a, ...u]))),
        a
      );
    })(e, null, []);
  }
  ...
  function zr(e, r) {
    ...
    function t(n, i, u) {
      ...
      for (let o of i.children)
        if ((o.type === n.type && u(o) ? a++ : (a = -1), o === n)) return a;
    }
  }
  function df(e, r) {
    let { node: t } = e;
        ...
        return (
          ...
          i
            ? async (u) => {
                ...
                let o = await u(Yr(t, r.originalText), a),
                  s = r.__inJsTemplate ? "~" : "`",
                  l = s.repeat(Math.max(3, Sr(t.value, s) + 1));
                return ur([
                  l,
                  t.lang,
                  t.meta ? " " + t.meta : "",
    ...
    return (
      e.each(() => {
        ...
        a !== !1 &&
          (u.length > 0 &&
            Cf(e) &&
            (u.push(M), (Af(e, r) || Ni(e)) && u.push(M), Ni(e) && u.push(M)),
          u.push(a));
      }, "children"),
      u
    );
  ...
  function Af({ node: e, previous: r, parent: t }, n) {
    if (
      Pi(r, n) ||
      (e.type === "list" && t.type === "listItem" && r.type === "code")
    )
      return !0;
    let u = r.type === e.type && vf.has(e.type),
      a = t.type === "listItem" && (e.type === "list" || !Pi(t, n)),
      o = lr(r) === "next",
      s =
        e.type === "html" &&
        r.type === "html" &&
    ...
    return z(e, r, t, {
      processor() {
        ...
        if (
          ...
          o.children[0].position.start.column !==
            o.children[1].position.start.column
        )
          return [a, Ii(e, r, t, a)];
        return [a, Fe(" ".repeat(a.length), Ii(e, r, t, a))];
        function s() {
          let l = n.ordered
            ? (e.isFirst ? n.start : u ? 1 : n.start + e.index) +
              (i % 2 === 0 ? ". " : ") ")
            : i % 2 === 0
              ? "- "
              : "* ";
...
`,
  ...
  function Pf(e) {
    return ye(e, (r, t, [n]) => {
      ...
      return (
        n.type === "paragraph" &&
          (t === 0 && (i = Ot.trimStart(i)),
          t === n.children.length - 1 && (i = Ot.trimEnd(i))),
        { type: "sentence", position: r.position, children: Ur(i) }
      );
    });
  }
  function If(e, r) {
  ...
  function Mf(e, r) {
    ...
    let i = t.kind,
      u = n.kind;
    return (Wi(i) && Wi(u)) || (i === Pe && u === ae) || (u === Pe && i === ae)
      ? !0
      : i === cr || u === cr || (i === ae && u === ae)
        ? !1
        : zi.has(n.value[0]) || zi.has(U(0, t.value, -1))
          ? !0
    ...
    switch (n.type) {
      ...
      case "emphasis": {
        ...
        if (Gr(n.children[0])) i = r.originalText[n.position.start.offset];
          ...
          let u = Vi(e),
            a = e.callParent(({ node: o }) => o.type === "strong" && Vi(e));
...
`,
      ...
      case "link":
        switch (r.originalText[n.position.start.offset]) {
          ...
          case "[":
            return ["[", z(e, r, t), "](", Nt(n.url, ")"), Wr(n.title, r), ")"];
          default:
      ...
      case "image":
        return ["![", n.alt || "", "](", Nt(n.url, ")"), Wr(n.title, r), ")"];
      case "blockquote":
        return ["> ", Fe("> ", z(e, r, t))];
      case "heading":
      ...
      case "definition": {
        ...
        return Ge([
          Pt(n),
          ":",
          ir([i, Nt(n.url), n.title === null ? "" : [i, Wr(n.title, r, !1)]]),
        ]);
      }
      case "footnote":
        return ["[^", z(e, r, t), "]"];
          ...
          i
            ...
            : Ge([
                Fe(
                  " ".repeat(4),
                  z(e, r, t, {
                    processor: ({ isFirst: u }) => (u ? Ge([Pr, t()]) : t()),
                  }),
                ),
              ]),
        ];
      ...
      switch (lr(o)) {
        ...
        case "end":
          i !== null &&
            (n.push({
              start: i,
              end: { index: a, offset: o.position.start.offset },
            }),
            (i = null));
          break;
        default:
  ...
  function Nt(e, r = []) {
    ...
    return new RegExp(t.map((n) => fe(n)).join("|"), "u").test(e)
      ? `<${Wf(e, "<>")}>`
      : e;
  }
  function Wr(e, r, t = !0) {
  ...
  var $f = { proseWrap: It.proseWrap, singleQuote: It.singleQuote },
    Ji = $f;
  var Wn = {};
...
`),
        n = t === -1 ? r : r.slice(0, t);
      if (ul(n)) return e(n)({ type: il(n) ? "export" : "import", value: n });
    };
  zn.notInBlock = !0;
  ...
  function aF() {
    return (e) =>
      ye(e, (r, t, [n]) =>
        r.type !== "html" || nl.test(r.value) || Mr.has(n.type)
          ? r
          : { ...r, type: "jsx" },
      );
  }
  ...
  function Fl({ isMDX: e }) {
    return (r) => {
      let t = (0, ml.default)()
        .use(dl.default, { commonmark: !0, ...(e && { blocks: [tl] }) })
        .use(pl.default)
        .use(sl)
        .use(hl.default)
        .use(e ? ol : Dl)
  ...
  var gl = {
    ...
    cF = { ...gl, parse: Fl({ isMDX: !1 }) },
    lF = { ...gl, parse: Fl({ isMDX: !0 }) };
  var fF = { mdast: Ki };
  return xl(DF);
});

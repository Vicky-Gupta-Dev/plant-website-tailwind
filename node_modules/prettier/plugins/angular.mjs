...
var ln = (t, e) => {
  for (var n in e) Ci(t, n, { get: e[n], enumerable: !0 });
};
var nt = (t, e, n) => e.has(t) || an("Cannot " + n);
var U = (t, e, n) => (
    nt(t, e, "read from private field"),
    n ? n.call(t) : e.get(t)
  ),
  ke = (t, e, n) =>
    e.has(t)
...
var ms = "-shadowcsshost",
  ...
  Zi = `(?:\\(${Ki}\\)|${Bt})+?`,
  zt = `(?:\\((${Zi})\\))`,
  Yr = new RegExp("(:nth-[-\\w]+)" + zt, "g"),
  Qr = new RegExp(ms + zt + "?([^,{]*)", "gim"),
  er = Qi + zt + "?([^{]*)",
  Kr = new RegExp(`${Yi}(${er})`, "gim"),
  tr = ms + "-no-combinator",
  Zr = new RegExp(`${tr}(?![^(]*\\))`, "g");
var gs = "%COMMENT%",
  eo = new RegExp(gs, "g");
...
var rr = Symbol("ConsumesSlot"),
  vs = Symbol("DependsOnSlotContext"),
  Te = Symbol("ConsumesVars"),
  Gt = Symbol("UsesVarOffset"),
  ro = { [rr]: !0, numSlotsUsed: 1 },
  oo = { [vs]: !0 },
  ao = { [Te]: !0 };
var je = class {
  strings;
...
var Gn = class t extends re {
  ...
  transformInternalExpressions(e, n) {
    this.body !== null
      ? (this.body = (this.body, n | Ot.InChildOperation, void 0))
      ...
      for (this.advance(); ; ) {
        if (!W(this.peek))
          if (this.peek === Xe) {
            ...
            if (
              (this.advance(), vr(this.peek) && this.advance(), !W(this.peek))
            )
    ...
    parseCallChain() {
      ...
      for (;;)
        if (this.consumeOptionalCharacter(H))
          ...
          n = new Nt(this.span(e), this.sourceSpan(e), n);
      ...
      if ((this.expectCharacter(Ve), !this.consumeOptionalCharacter(K))) {
        ...
        do {
          ...
          let r = this.next.isString(),
            ...
            u = this.span(i),
            p = this.sourceSpan(i),
            d = { kind: "property", key: a, quoted: r, span: u, sourceSpan: p };
          (e.push(d),
            r
...
var Er = new Map(
  ...
  vo = Array.from(Er).reduce((t, [e, n]) => (t.set(e, n), t), new Map());
...
var Io = Symbol("queryAdvancePlaceholder");
var ss;
(function (t) {
...
var Je = (t) => (e) => {
    let n = Ss(e);
    return ys({ ...n, result: Es()[t](e, n.sourceSpan, 0), comments: kr(e) });
  },
  Cs = Je("parseAction"),
  _s = Je("parseBinding"),
...
var As = Object.defineProperty,
  Is = (t, e) => {
    let n = {};
    for (var s in t) As(n, s, { get: t[s], enumerable: !0 });
...
var Nr = { computed: !0, optional: !1 },
  Pr = { computed: !0, optional: !0 },
  Lr = { computed: !1, optional: !1 },
  Mr = { computed: !1, optional: !0 },
  Qe =
  ...
  Br =
    ...
    (vi = function () {
      ...
      return v(this, m, C).call(
        ...
        r.length === 0
          ? n[0].sourceSpan
          : { start: r[0].start, end: pi(0, r, -1).end },
      );
    }),
    (xi = function (n, s) {
      if (hi(n)) {

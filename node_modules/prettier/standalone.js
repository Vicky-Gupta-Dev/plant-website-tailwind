(function (t) {
  ...
  var no = (e, t) => () => (
    ...
    Yt = (e, t) => {
      for (var u in t) Je(e, u, { get: t[u], enumerable: !0 });
    },
    ku = (e, t, u, r) => {
  ...
  var oo = (e, t, u) => (
    ...
    ao = (e) => ku(Je({}, "__esModule", { value: !0 }), e);
  var pn = no((af, dn) => {
    var bt,
      At,
      _t,
    ...
    wt = /\/\/.*/y;
    _t = /[<>.:={}]|\/(?![\/*])/y;
    At = /[$_\p{ID_Start}][$_\u200C\u200D\p{ID_Continue}-]*/uy;
    xt = /(['"])(?:[^'"]+|(?!\1)['"])*(\1)?/y;
    Bt = /[^<>{}]+/y;
    Pt =
    ...
    fn = RegExp(Ke.source);
    dn.exports = Aa = function* (e, { jsx: t = !1 } = {}) {
      ...
      for (
        ...
        switch (((D = F[F.length - 1]), D.tag)) {
            ...
            if (((Ve.lastIndex = n), (i = Ve.exec(e)))) {
              switch (((p = i[0]), (f = Ve.lastIndex), (l = p), p)) {
                ...
                case ")":
                  (d--,
                    (c = !0),
                    D.tag === "JSNonExpressionParen" &&
                      d === D.nesting &&
                      (F.pop(), (l = "?NonExpressionParenEnd"), (c = !1)));
                  break;
                case "{":
                  ((Ve.lastIndex = 0),
                    (o = !ln.test(a) && (Pt.test(a) || $e.test(a))),
                    u.push(o),
                    (c = !1));
                  break;
                case "}":
                ...
                case "<":
                  if (t && (Pt.test(a) || $e.test(a))) {
                    (F.push({ tag: "JSXTag" }),
                      (n += 1),
                      (a = "<"),
                      yield { type: "JSXPunctuator", value: p });
                    continue;
                  }
                  c = !1;
                  break;
          ...
          case "JSXTagEnd":
              ...
              switch (((n = _t.lastIndex), (l = i[0]), i[0])) {
                ...
                case ">":
                  (F.pop(),
                    a === "/" || D.tag === "JSXTagEnd"
                      ? ((l = "?JSX"), (c = !0))
                      : F.push({ tag: "JSXChildren" }));
                  break;
                case "{":
                  (F.push({ tag: "InterpolationInJSX", nesting: u.length }),
                    (l = "?InterpolationInJSX"),
                    (c = !1));
                  break;
                case "/":
                  a === "<" &&
                    (F.pop(),
                    F[F.length - 1].tag === "JSXChildren" && F.pop(),
                    F.push({ tag: "JSXTagEnd" }));
              }
            ...
            if (((At.lastIndex = n), (i = At.exec(e)))) {
              ((n = At.lastIndex),
                (a = i[0]),
                yield { type: "JSXIdentifier", value: i[0] });
              continue;
            }
        ...
        if (((Ke.lastIndex = n), (i = Ke.exec(e)))) {
          ((n = Ke.lastIndex),
            (c = !1),
            bu.test(a) && (a = "?NoLineTerminatorHere"),
        ...
        if (((Tt.lastIndex = n), (i = Tt.exec(e)))) {
          ((n = Tt.lastIndex),
            fn.test(i[0]) &&
              ((c = !1), bu.test(a) && (a = "?NoLineTerminatorHere")),
            yield {
        ...
        if (((wt.lastIndex = n), (i = wt.exec(e)))) {
          ((n = wt.lastIndex),
            (c = !1),
            yield { type: "SingleLineComment", value: i[0] });
          continue;
        }
        ((r = String.fromCodePoint(e.codePointAt(n))),
          (n += r.length),
          (a = r),
          (c = !1),
          yield {
  ...
  var X =
    (e, t) =>
    (u, r, ...o) =>
      u | 1 && r == null ? void 0 : (t.call(r) ?? r[e]).apply(r, o);
  var io =
  ...
  var Ne = class {
    diff(t, u, r = {}) {
      ...
      typeof r == "function"
        ? ((o = r), (r = {}))
        : "callback" in r && (o = r.callback);
      let n = this.castInput(t, r),
        a = this.castInput(u, r),
        s = this.removeEmpty(this.tokenize(n, r)),
        i = this.removeEmpty(this.tokenize(a, r));
    ...
    diffWithOptionsObj(t, u, r, o) {
      ...
      let l = (n = r.timeout) !== null && n !== void 0 ? n : 1 / 0,
        d = Date.now() + l,
        c = [{ oldPos: -1, lastComponent: void 0 }],
        p = this.extractCommon(c[0], u, t, 0, r);
      if (c[0].oldPos + 1 >= i && p + 1 >= s)
        return a(this.buildValues(c[0].lastComponent, u, t));
      let F = -1 / 0,
        C = 1 / 0,
        y = () => {
          for (let m = Math.max(F, -D); m <= Math.min(C, D); m += 2) {
            ...
            if (
              (!J || (A && E.oldPos < g.oldPos)
                ? (h = this.addToPath(g, !0, !1, 0, r))
                : (h = this.addToPath(E, !1, !0, 1, r)),
              (p = this.extractCommon(h, u, t, m, r)),
              h.oldPos + 1 >= i && p + 1 >= s)
            )
              return a(this.buildValues(h.lastComponent, u, t)) || !0;
            ((c[m] = h),
              h.oldPos + 1 >= i && (C = Math.min(C, m - 1)),
              p + 1 >= s && (F = Math.max(F, m + 1)));
          }
          D++;
        };
      if (o)
    ...
    extractCommon(t, u, r, o, n) {
      let a = u.length,
        ...
        D = i - o,
        f = 0;
      for (; D + 1 < a && i + 1 < s && this.equals(r[i + 1], u[D + 1], n); )
        (D++,
          i++,
          f++,
          n.oneChangePerToken &&
    ...
    equals(t, u, r) {
      return r.comparator
        ? r.comparator(t, u)
        : t === u || (!!r.ignoreCase && t.toLowerCase() === u.toLowerCase());
    }
    removeEmpty(t) {
      let u = [];
    ...
    buildValues(t, u, r) {
      ...
      for (; s < a; s++) {
        let f = o[s];
        if (f.removed)
          ((f.value = this.join(r.slice(D, D + f.count))), (D += f.count));
        else {
...
`,
  ...
  var G = "string",
    ...
    O = "label",
    T = "break-parent",
    Xe = new Set([U, I, k, v, x, w, B, R, L, M, _, O, T]);
  function Wu(e) {
    let t = e.length;
    for (
      ;
...
Expected it to be ${r}.`;
    ...
    function o(n) {
      switch (H(n)) {
        ...
        case x: {
          ...
          return (
            a ? ((a = a.map(r)), (s = a[0])) : (s = r(s)),
            t({ ...n, contents: s, expandedStates: a })
          );
        }
        case k:
        case I:
  ...
  function bo(e) {
    if ((e.type === x && e.break) || (e.type === _ && e.hard) || e.type === T)
      return !0;
  }
  function Gu(e) {
    return qe(e, bo, !1);
  ...
  function Ku(e) {
    for (
      e = [...e];
      e.length >= 2 && b(0, e, -2).type === _ && b(0, e, -1).type === T;
    )
      e.length -= 2;
    if (e.length > 0) {
      let t = Oe(b(0, e, -1));
    ...
    switch (H(e)) {
      ...
      case j: {
        ...
        for (let u of e) {
          ...
          (typeof r == "string" && typeof b(0, t, -1) == "string"
            ? (t[t.length - 1] += r)
            : t.push(r),
            t.push(...o));
        }
...
`),
  ...
  function rr(e, t = "", u = {}) {
    return (
      N(e),
      t !== "" && N(t),
      { type: B, breakContents: e, flatContents: t, groupId: u.groupId }
    );
  }
  function nr(e, t) {
    return (
      N(e),
      { type: R, contents: e, groupId: t.groupId, negate: t.negate }
    );
  }
  function Ie(e, t) {
    (N(e), et(t));
  ...
  function te(e) {
    ...
    if (Array.isArray(e)) {
      let t = [];
      for (let u of e)
        if (Array.isArray(u)) t.push(...te(u));
        else {
          let r = te(u);
          r !== "" && t.push(r);
        }
    ...
    return e.type === B
      ...
      : e.type === x
        ...
        : e.type === w
          ? { type: "fill", parts: e.parts.map(te) }
          : e.contents
            ? { ...e, contents: te(e.contents) }
            : e;
  }
  function Dr(e) {
    ...
    function r(n, a, s) {
      ...
      if (n.type === T)
        return s?.[a - 1]?.type === _ && s[a - 1].hard ? void 0 : "breakParent";
      if (n.type === v) return "trim";
      if (n.type === I) return "indent(" + r(n.contents) + ")";
      if (n.type === k)
        return n.n === Number.NEGATIVE_INFINITY
          ? "dedentToRoot(" + r(n.contents) + ")"
          : n.n < 0
            ? "dedent(" + r(n.contents) + ")"
            : n.n.type === "root"
              ? "markAsRoot(" + r(n.contents) + ")"
              : "align(" + JSON.stringify(n.n) + ", " + r(n.contents) + ")";
      if (n.type === B)
        return (
          "ifBreak(" +
          r(n.breakContents) +
          (n.flatContents ? ", " + r(n.flatContents) : "") +
          (n.groupId
            ? (n.flatContents ? "" : ', ""') + `, { groupId: ${o(n.groupId)} }`
            : "") +
          ")"
        );
      if (n.type === R) {
        let i = [];
        (n.negate && i.push("negate: true"),
          n.groupId && i.push(`groupId: ${o(n.groupId)}`));
        let D = i.length > 0 ? `, { ${i.join(", ")} }` : "";
        return `indentIfBreak(${r(n.contents)}${D})`;
      }
      if (n.type === x) {
        let i = [];
        (n.break && n.break !== "propagated" && i.push("shouldBreak: true"),
          n.id && i.push(`id: ${o(n.id)}`));
        let D = i.length > 0 ? `, { ${i.join(", ")} }` : "";
        return n.expandedStates
          ? `conditionalGroup([${n.expandedStates.map((f) => r(f)).join(",")}]${D})`
          : `group(${r(n.contents)}${D})`;
      }
  ...
  function lr(e, t, u) {
    let r = t.type === 1 ? e.queue.slice(0, -1) : [...e.queue, t],
      o = "",
      n = 0,
      a = 0,
      s = 0;
    ...
    for (; u >= 0; ) {
      ...
      switch (d) {
        ...
        case w: {
          let c = d === j ? l : l.parts,
            p = l[qt] ?? 0;
          for (let F = c.length - 1; F >= p; F--)
            i.push({ mode: f, doc: c[F] });
          break;
        }
        case I:
        case k:
        ...
        case x: {
          ...
          let c = l.break ? W : f,
            p =
              l.expandedStates && c === W
                ? b(0, l.expandedStates, -1)
                : l.contents;
          i.push({ mode: c, doc: p });
          break;
        }
...
`,
        ...
        case j:
          for (let g = E.length - 1; g >= 0; g--)
            a.push({ indent: m, mode: h, doc: E[g] });
          break;
        case U:
          if (f.length >= 2)
        ...
        case x:
          switch (h) {
            ...
            case W: {
              i = !1;
              let g = { indent: m, mode: q, doc: E.contents },
                A = r - n,
                J = D.length > 0;
              if (!E.break && nt(g, a, A, J, u)) a.push(g);
                ...
                if (E.break) {
                  ...
                  for (let re = 1; re < E.expandedStates.length + 1; re++)
                    if (re >= E.expandedStates.length) {
                      a.push({ indent: m, mode: W, doc: Q });
                      break;
                    } else {
                      let Te = E.expandedStates[re],
                        ne = { indent: m, mode: q, doc: Te };
                      if (nt(ne, a, A, J, u)) {
                        a.push(ne);
                        break;
                      }
        ...
        case w: {
          ...
          let re = J[A + 0],
            Te = J[A + 1],
            ne = { indent: m, mode: q, doc: re },
            Rt = { indent: m, mode: W, doc: re },
            Lt = nt(ne, [], g, D.length > 0, u, !0);
          if (Q === 1) {
            Lt ? a.push(ne) : a.push(Rt);
            break;
          }
          let Iu = { indent: m, mode: q, doc: Te },
            Mt = { indent: m, mode: W, doc: Te };
          if (Q === 2) {
            Lt ? a.push(Iu, ne) : a.push(Mt, Rt);
            break;
          }
          let Xn = J[A + 2],
            qn = { indent: m, mode: h, doc: { ...E, [qt]: A + 2 } },
            Qn = nt(
              { indent: m, mode: q, doc: [re, Te, Xn] },
              [],
              g,
              D.length > 0,
              u,
          ...
          (a.push(qn),
            Qn ? a.push(Iu, ne) : Lt ? a.push(Mt, ne) : a.push(Mt, Rt));
          break;
        }
        case B:
        case R: {
        ...
        case _:
          switch (h) {
            ...
            case W:
              if (D.length > 0) {
                (a.push({ indent: m, mode: h, doc: E }, ...D.reverse()),
                  (D.length = 0));
                break;
              }
              E.literal
                ? ((s += o),
                  (n = 0),
                  m.root &&
                    (m.root.value && (s += m.root.value), (n = m.root.length)))
                : (y(), (s += o + m.value), (n = m.length));
              break;
          }
          break;
        case O:
    ...
    function y() {
      ...
      (m && (l.push(m), (c += m.length)),
        (s = ""),
        (n -= h),
        f.length > 0 &&
          (d.push(...f.map((E) => Math.min(E, c))), (f.length = 0)));
    }
  }
  function Io(e, t, u = 0) {
    let r = 0;
  ...
  var Qt = class {
      ...
      #t(t) {
        let { stack: u } = this;
        for (let r = u.length - 1; r >= 0; r -= 2)
          if (!Array.isArray(u[r]) && --t < 0) return r;
        return -1;
      }
      call(t, ...u) {
        let { stack: r } = this,
      ...
      each(t, ...u) {
        ...
        try {
          for (let a = 0; a < n.length; ++a)
            (r.push(a, n[a]), t(this, a, n), (r.length -= 2));
        } finally {
          r.length = o;
        }
      }
      ...
      match(...t) {
        ...
        for (let n of t) {
          ...
          if (
            (typeof r == "number" &&
              ((a = r), (r = this.stack[u--]), (o = this.stack[u--])),
            n && !n(o, r, a))
          )
            return !1;
...
`
  ...
  function yr(e, t, u) {
    ...
    let n,
      a = (
        u.getChildren?.(e, u) ?? [
          ...be(e, { getVisitorKeys: u.getVisitorKeys }),
        ]
      ).flatMap((D) => (n ?? (n = [e, ...t]), o(D, n) ? [D] : yr(D, n, u))),
      { locStart: s, locEnd: i } = u;
  ...
  function _r(e, t) {
    ...
    let r = [],
      {
        printer: {
          features: { experimental_avoidAstMutation: o },
          handleComments: n = {},
        },
        originalText: a,
      } = t,
      { ownLine: s = eu, endOfLine: i = eu, remaining: D = eu } = n,
      f = u.map((l, d) => ({
        ...Ar(e, l, t),
        comment: l,
        text: a,
    ...
    for (let [l, d] of f.entries()) {
      ...
      if (
        ...
        ((c.placement = "ownLine"),
          s(...g) || (C ? fe(C, c) : p ? le(p, c) : F ? ue(F, c) : ue(h, c)));
      else if (jo(y, m, f, l))
        ((c.placement = "endOfLine"),
          i(...g) || (p ? le(p, c) : C ? fe(C, c) : F ? ue(F, c) : ue(h, c)));
      else if (((c.placement = "remaining"), !D(...g)))
        if (p && C) {
          let A = r.length;
    ...
    if ((br(r, t), !o))
      for (let l of u)
        (delete l.precedingNode,
          delete l.enclosingNode,
          delete l.followingNode);
  }
  var xr = (e) => !/[\S\n\u2028\u2029]/u.test(e);
  function Yo(e, t, u, r) {
    let { comment: o, precedingNode: n } = u[r],
  ...
  function jo(e, t, u, r) {
    let { comment: o, followingNode: n } = u[r],
      { locStart: a, locEnd: s } = t,
      i = s(o);
    if (n)
      for (let D = r + 1; D < u.length; D++) {
  ...
  function br(e, t) {
    let u = e.length;
    if (u === 0) return;
    let { precedingNode: r, followingNode: o } = e[0],
      n = t.locStart(o),
      a;
    for (a = u; a > 0; --a) {
    ...
    for (let s of [r, o])
      s.comments &&
        s.comments.length > 1 &&
        s.comments.sort((i, D) => t.locStart(i) - t.locStart(D));
    e.length = 0;
  }
  function tu(e, t, u) {
  ...
  function Wo(e, t) {
    ...
    if (o.isBlockComment?.(u)) {
      let f = z(n, s(u)) ? (z(n, a(u), { backwards: !0 }) ? V : rt) : " ";
      r.push(f);
    } else r.push(V);
    let D = K(n, Y(n, s(u)));
  ...
  function $o(e, t, u) {
    let r = e.node,
      o = Br(e, t),
      { printer: n, originalText: a, locStart: s } = t,
      i = n.isBlockComment?.(r);
    if ((u?.hasLineSuffix && !u?.isBlock) || z(a, s(r), { backwards: !0 })) {
      let D = Le(a, s(r));
      return { doc: ve([V, D ? V : "", o]), isBlock: i, hasLineSuffix: !0 };
    }
    return !i || u?.hasLineSuffix
      ? { doc: [ve([" ", o]), ce], isBlock: i, hasLineSuffix: !0 }
      : { doc: [" ", o], isBlock: i, hasLineSuffix: !1 };
  }
  function Vo(e, t) {
    let u = e.node;
    if (!u) return {};
...
The range will extend backwards to the start of the first line containing the selected statement.`,
  ...
  function st({ plugins: e = [], showDeprecated: t = !1 } = {}) {
    let u = e.flatMap((o) => o.languages ?? []),
      r = [];
    for (let o of Go(Object.assign({}, ...e.map(({ options: n }) => n), wr)))
      (!t && o.deprecated) ||
        (Array.isArray(o.choices) &&
          (t || (o.choices = o.choices.filter((n) => !n.deprecated)),
          o.name === "parser" &&
            (o.choices = [...o.choices, ...Ko(o.choices, u, e)])),
        (o.pluginDefaults = Object.fromEntries(
          e
            .filter((n) => n.defaultOptions?.[o.name] !== void 0)
            .map((n) => [n.name, n.defaultOptions[o.name]]),
        )),
        r.push(o));
        ...
        for (let n of o.parsers)
          if (!r.has(n)) {
            ...
            let a = u.find(
                (i) =>
                  i.parsers &&
                  Object.prototype.hasOwnProperty.call(i.parsers, n),
              ),
              s = o.name;
            (a?.name && (s += ` (plugin: ${a.name})`),
              yield { value: n, description: s });
          }
      }
  }
  function Go(e) {
    ...
    for (let [u, r] of Object.entries(e)) {
      let o = { name: u, ...r };
      (Array.isArray(o.default) && (o.default = b(0, o.default, -1).value),
        t.push(o));
    }
    return t;
  }
  ...
  function Ho() {
    ...
    return typeof t == "string"
      ...
      : (e.navigator?.platform?.startsWith("Win") ??
          e.process?.platform?.startsWith("win") ??
          !1);
  }
  var Xo = Ho();
  function Pr(e) {
  ...
  var Ir = (e) => String(e).split(/[/\\]/u).pop(),
    kr = (e) => String(e).startsWith("file:");
  function vr(e, t) {
    if (!t) return;
    let u = Ir(t).toLowerCase();
    return (
      e.find(({ filenames: r }) => r?.some((o) => o.toLowerCase() === u)) ??
      e.find(({ extensions: r }) => r?.some((o) => u.endsWith(o)))
    );
  }
  function Zo(e, t) {
    if (t)
  ...
  var ie = {
    ...
    value(e) {
      ...
      return t.length === 0
        ? "{}"
        : `{ ${t.map((u) => `${ie.key(u)}: ${ie.value(e[u])}`).join(", ")} }`;
    },
  ...
  var Lr = (e, t, { descriptor: u }) => {
    ...
    return (
      t &&
        r.push(
          `we now treat it as ${$.blue(typeof t == "string" ? u.key(t) : u.pair(t))}`,
        ),
      r.join("; ") + "."
    );
  };
  var ct = Symbol.for("vnopts.VALUE_NOT_EXIST"),
    Ae = Symbol.for("vnopts.VALUE_UNCHANGED");
  var Mr = " ".repeat(2),
    jr = (e, t, u) => {
      let { text: r, list: o } = u.normalizeExpectedResult(
      ...
      return (
        ...
        o &&
          n.push(
            [Yr(e, t, o.title, u.descriptor)].concat(
              o.values.map((a) => Ur(a, u.loggerPrintWidth)),
            ).join(`
`),
          ),
  ...
  function Yr(e, t, u, r) {
    return [
      ...
      `Expected ${$.blue(u)},`,
      `but received ${t === ct ? $.gray("nothing") : $.red(r.value(t))}.`,
    ].join(" ");
  }
...
`,
  ...
  function ft(e, t, u) {
    ...
    for (; c < a; ) {
      for (i = t.charCodeAt(s + c), f = c++, D = c, d = 0; d < n; d++)
        ((l = i === au[d] ? f : f + 1),
          (f = _e[d]),
          (D = _e[d] = f > D ? (l > D ? D + 1 : l) : l > f ? f + 1 : l));
      if (r !== void 0) {
        let p = D;
  ...
  function $r(e, t, u) {
    ...
    for (let i of t) {
      ...
      let f = Number.isFinite(a) ? (r === void 0 ? a : Math.min(a, r)) : r,
        l = f === void 0 ? ft(e, i) : ft(e, i, { maxDistance: f });
      if (r !== void 0 && l > r) continue;
      let d = l;
      if (
        (f !== void 0 && l === f && f === r && (d = ft(e, i)),
        d < a && ((a = d), (n = i), a === 0))
      )
        break;
    }
  ...
  var lt = (e, t, { descriptor: u, logger: r, schemas: o }) => {
    let n = [
        `Ignored unknown option ${$.yellow(u.pair({ key: e, value: t }))}.`,
      ],
      a = $r(e, Object.keys(o), { maxDistance: 3 });
  ...
  var Ft = class extends S {
    ...
    expected(t) {
      let { text: u, list: r } = t.normalizeExpectedResult(
    ...
    deprecated(t, u) {
      let r = [];
      for (let o of t) {
        let n = u.normalizeDeprecatedResult(
  ...
  function su(e) {
    ...
    return (
      ...
      u
        ? { text: t, list: { title: u.title, values: u.values.map(su) } }
        : { text: t }
    );
  }
  function Du(e, t) {
  ...
  var Ct = class extends S {
    constructor(t) {
      (super(t),
        (this._choices = zr(
          t.choices.map((u) => (u && typeof u == "object" ? u : { value: u })),
          "value",
        )));
    }
    expected({ descriptor: t }) {
      let u = Array.from(this._choices.keys())
          .map((a) => this._choices.get(a))
          .filter(({ hidden: a }) => !a)
          .map((a) => a.value)
          .sort(qr)
          .map(t.value),
      ...
      return {
        ...
        list: { title: "one of the following values", values: u },
      };
    }
    validate(t) {
  ...
  var gt = class extends ht {
    ...
    validate(t, u) {
      return u.normalizeValidateResult(super.validate(t, u), t) === !0 && Xr(t);
    }
  };
  ...
  var yt = class {
    constructor(t, u) {
      ...
      ((this._utils = {
        ...
        normalizeForwardResult: Et,
        normalizeRedirectResult: fu,
        normalizeValidateResult: Du,
      }),
        (this._unknownHandler = a),
        (this._invalidHandler = Qr(s)),
        (this._deprecatedHandler = i),
        (this._identifyMissing = (c, p) => !(c in p) || D(c, p)),
        (this._identifyRequired = f),
        (this._preprocess = l),
        (this._postprocess = d),
        this.cleanHistory());
    }
    ...
    normalize(t) {
      let u = {},
        ...
        n = () => {
          for (; o.length !== 0; ) {
            let a = o.shift(),
              s = this._applyNormalization(a, u);
            o.push(...s);
          }
        };
      n();
    ...
    _applyNormalization(t, u) {
      let r = [],
        { knownKeys: o, unknownKeys: n } = this._partitionOptionKeys(t);
      for (let a of o) {
        let s = this._utils.schemas[a],
          i = s.preprocess(t[a], this._utils);
              ...
              if (F === !0)
                this._hasDeprecationWarned(a) ||
                  this._utils.logger.warn(
                    this._deprecatedHandler(a, p, this._utils),
                  );
              else
                for (let { value: C } of F) {
                  let y = { key: a, value: C };
                  if (!this._hasDeprecationWarned(y)) {
                    let m = typeof p == "string" ? { key: p, value: C } : p;
                    this._utils.logger.warn(
                      this._deprecatedHandler(y, m, this._utils),
                    );
                  }
                }
          };
        ...
        if ((d.redirect.forEach(D), "remain" in d)) {
          let c = d.remain;
          ((u[a] = a in u ? s.overlap(u[a], c, this._utils) : c),
            f({ value: c }));
        }
        for (let { from: c, to: p } of d.redirect)
          f({ value: c, redirectTo: p });
      }
      for (let a of n) {
        let s = t[a];
    ...
    _applyRequiredCheck(t) {
      for (let u of Object.keys(this._utils.schemas))
        if (this._identifyMissing(u, t) && this._identifyRequired(u))
          throw this._invalidHandler(u, ct, this._utils);
    }
    ...
    _applyPostprocess(t) {
      ...
      if (u !== Ae) {
        ...
        if (u.override) {
          let { knownKeys: r, unknownKeys: o } = this._partitionOptionKeys(
            u.override,
          );
          for (let n of r) {
            let a = u.override[n];
  ...
  function ia(
    ...
    let s = o
        ? Array.isArray(o)
          ? (d, c) => (o.includes(d) ? { [d]: c } : void 0)
          : (d, c) => ({ [d]: c })
        : (d, c, p) => {
            let { _: F, ...C } = p.schemas;
            return lt(d, c, { ...p, schemas: C });
          },
      i = sa(t, { isCLI: r, FlagSchema: n }),
      D = new yt(i, { logger: u, unknown: s, descriptor: a }),
      f = u !== !1;
  ...
  function sa(e, { isCLI: t, FlagSchema: u }) {
    ...
    for (let o of e)
      (r.push(Da(o, { isCLI: t, optionInfos: e, FlagSchema: u })),
        o.alias &&
          t &&
          r.push(dt.create({ name: o.alias, sourceName: o.name })));
    return r;
  }
  function Da(e, { isCLI: t, optionInfos: u, FlagSchema: r }) {
    ...
    switch (e.type) {
      ...
      case "choice":
        ((a = Ct),
          (n.choices = e.choices.map((i) =>
            i?.redirect
              ? { ...i, redirect: { to: { key: e.name, value: i.redirect } } }
              : i,
          )));
        break;
      case "boolean":
    ...
    if (
      (e.exception
        ? (n.validate = (i, D, f) => e.exception(i) || D.validate(i, f))
        : (n.validate = (i, D, f) => i === void 0 || D.validate(i, f)),
      e.redirect &&
        (s.redirect = (i) =>
          i
            ? {
      ...
      n.preprocess = (D, f, l) =>
        f.preprocess(i(Array.isArray(D) ? b(0, D, -1) : D), l);
    }
    return e.array
      ? Ft.create({
  ...
  var ca =
    ...
    du = fa;
  var nn = Symbol.for("PRETTIER_IS_FRONT_MATTER"),
    pu = [];
  function la(e) {
    return !!e?.[nn];
  }
  var de = la;
  var on = new Set(["yaml", "toml"]),
    Ue = ({ node: e }) => de(e) && on.has(e.language);
  ...
  var an = new Set([
    ...
    Fa = (e) => Object.keys(e).filter((t) => !an.has(t));
  function ma(e, t) {
    let u = e ? (r) => e(r, an) : Fa;
    return t
      ? new Proxy(u, {
  ...
  function Ea(e) {
    ...
    if (r) {
      ...
      D = new Proxy(r, {
        get(c, p, F) {
          return p === "getVisitorKeys"
            ? (d ??
                (d = r.getVisitorKeys
                  ? Cu(r.getVisitorKeys, s.massageAstNode || s.embed)
                  : u),
              d)
            : Reflect.get(c, p, F);
        },
  ...
  var Ca = ["clean", "embed", "print"],
    ha = Object.fromEntries(Ca.map((e) => [e, !1]));
  function ga(e) {
    return { ...ha, ...e };
  }
  function ya(e) {
  ...
  async function ba(e, t = {}) {
    ...
    if (!u.parser)
      if (u.filepath) {
        if (((u.parser = Dt(u, { physicalFile: u.filepath })), !u.parser))
          throw new Ye(`No parser could be inferred for file "${u.filepath}".`);
      } else
        throw new Ye(
          "No parser and no file path given, couldn't infer a parser.",
        );
    let r = st({ plugins: e.plugins, showDeprecated: !0 }).options,
      o = {
        ...cn,
        ...Object.fromEntries(
          r.filter((l) => l.default !== void 0).map((l) => [l.name, l.default]),
        ),
      },
      n = gu(u.plugins, u.parser),
      a = await yu(n, u.parser);
    ((u.astFormat = a.astFormat),
      (u.locEnd = a.locEnd),
      (u.locStart = a.locStart));
    let s = n.printers?.[a.astFormat] ? n : sn(u.plugins, a.astFormat),
      i = await Dn(s, a.astFormat);
    ...
    for (let [l, d] of Object.entries(f))
      (u[l] === null || u[l] === void 0) && (u[l] = d);
    return (
      u.parser === "json" && (u.trailingComma = "none"),
      rn(u, r, { passThrough: Object.keys(cn), ...t })
    );
  }
  var se = ba;
  var Ff = oo(pn(), 1);
  ...
  var _u = {
    ...
    cf = new Set(_u.keyword),
    ff = new Set(_u.strict),
    lf = new Set(_u.strictBind);
  var kt = (e, t) => (u) => e(t(u));
  function En(e) {
    return {
      keyword: e.cyan,
      ...
      regex: e.magenta,
      comment: e.gray,
      invalid: kt(kt(e.white, e.bgRed), e.bold),
      gutter: e.gray,
      marker: kt(e.red, e.bold),
      message: kt(e.red, e.bold),
      reset: e.reset,
    };
  }
  var gf = En(ou(!0)),
  ...
  function xa(e, t, u) {
    let r = Object.assign({ column: 0, line: -1 }, e.start),
      ...
      { linesAbove: n = 2, linesBelow: a = 3 } = u || {},
      s = r.line,
      i = r.column,
      D = o.line,
      f = o.column,
      l = Math.max(s - (n + 1), 0),
      d = Math.min(t.length, D + a);
  ...
  function Cn(e, t, u = {}) {
    let o = _a(!1),
      n = e.split(mn),
      { start: a, end: s, markerLines: i } = xa(t, n, u),
      ...
      d = e
        ...
        .map((c, p) => {
          ...
          if (m) {
            let E = "";
            if (Array.isArray(m)) {
              let g = c.slice(0, Math.max(m[0] - 1, 0)).replace(/[^\t]/g, " "),
                A = m[1] || 1;
              ((E = [
                `
 `,
                ...
                h && u.message && (E += " " + o.message(u.message)));
            }
            return [
              o.marker(">"),
              o.gutter(y),
...
${d}`),
  ...
  async function Ba(e, t) {
    let u = await We(t),
      r = u.preprocess ? await u.preprocess(e, t) : e;
    t.originalText = r;
    let o;
    try {
...
` + r),
  ...
  async function hn(e, t, u, r, o) {
    ...
    let { hasPrettierIgnore: s } = n,
      { getVisitorKeys: i } = a,
      D = [];
    d();
    let f = e.stack;
    for (let { print: c, node: p, pathStack: F } of D)
      try {
        e.stack = F;
  ...
  function yn(e, t, u, r, o) {
    ...
    return (
      a.printComment && !a.willPrintOwnComments?.(e, t) && (s = Tr(e, s, t)),
      s
    );
  }
  ...
  function wa(e, t) {
    let { cursorOffset: u, locStart: r, locEnd: o, getVisitorKeys: n } = t,
      a = (c) => r(c) <= u && o(c) >= u,
      s = e,
      i = [e];
  ...
  function Oa(e, t) {
    let { printer: u } = t,
      r = u.massageAstNode;
    if (!r) return e;
    let { getVisitorKeys: o } = u,
      { ignoredProperties: n } = r;
    return a(e);
    function a(s, i) {
      if (!ge(s)) return s;
  ...
  async function Pn(e, t, u = 0) {
    ...
    if (u > 0) {
      ...
      (a.cursorNodeStart !== void 0 &&
        ((a.cursorNodeStart -= a.formatted.indexOf(i)),
        a.cursorNodeStart < 0 &&
          ((a.cursorNodeStart = 0),
          (a.cursorNodeText = a.cursorNodeText.trimStart())),
        a.cursorNodeStart + a.cursorNodeText.length > i.length &&
          (a.cursorNodeText = a.cursorNodeText.trimEnd())),
        (a.formatted = i + Se(t.endOfLine)));
    }
    ...
    if (t.cursorOffset >= 0) {
      ...
      if (
        ...
        if (((f = a.cursorNodeStart), (l = a.cursorNodeText), t.cursorNode))
          ((i = t.locStart(t.cursorNode)),
            (D = o.slice(i, t.locEnd(t.cursorNode))));
        else {
      ...
      if (D === l)
        return { formatted: a.formatted, cursorOffset: f + d, comments: s };
      let c = D.split("");
      c.splice(d, 0, Nn);
      let p = l.split(""),
        F = Ut(c, p),
...
`,
      ...
      f = await Pn(
        a,
        {
          ...
          cursorOffset:
            t.cursorOffset > o && t.cursorOffset <= n ? t.cursorOffset - o : -1,
          endOfLine: "lf",
        },
        D,
      ),
      l = f.formatted.trimEnd(),
      { cursorOffset: d } = t;
    d > n
      ? (d += l.length - a.length)
      : f.cursorOffset >= 0 && (d = f.cursorOffset + o);
...
`,
  ...
  function Sn(e, t) {
    ...
    return (
      ...
      (r = Nu(e, r, 0)),
      (o = Nu(e, o, e.length)),
      { ...t, cursorOffset: u, rangeStart: r, rangeEnd: o }
    );
  }
  function In(e, t) {
    let {
...
`,
  ...
  async function Su(e, t) {
    ...
    if (
      (o.rangeStart >= o.rangeEnd && r !== "") ||
      (o.requirePragma && !(await wn(r, o))) ||
      (o.checkIgnorePragma && (await ja(r, o)))
    )
    ...
    return (
      o.rangeStart > 0 || o.rangeEnd < r.length
        ...
        : (!o.requirePragma &&
            ...
            !(await wn(r, o)) &&
            (r = o.printer.insertPragma(r)),
          (n = await Pn(r, o))),
      u &&
        ((n.formatted = On + n.formatted),
        n.cursorOffset >= 0 && n.cursorOffset++),
      n
    );
  }
  async function kn(e, t, u) {
    let { text: r, options: o } = In(e, await se(t)),
      n = await Fe(r, o);
    return (
      u &&
        (u.preprocessForPrint && (n.ast = await xu(n.ast, o)),
        u.massage && (n.ast = bn(n.ast, o))),
      n
    );
  }
  ...
  async function Rn(e, t) {
    let u = Dr(e),
      { formatted: r } = await Su(u, { ...t, parser: "__js_expression" });
    return r;
  }
  ...
  Yt(Pu, {
    ...
    getAlignmentSize: () => he,
    getIndentSize: () => jn,
    getMaxContinuousCount: () => Un,
    getNextNonSpaceNonCommentCharacter: () => Wn,
    getNextNonSpaceNonCommentCharacterIndex: () => ni,
    getPreferredQuote: () => Kn,
    getStringWidth: () => Re,
    hasNewline: () => z,
    hasNewlineInRange: () => Gn,
    hasSpaces: () => zn,
    isNextLineEmpty: () => Di,
    isNextLineEmptyAfterIndex: () => vt,
  ...
  function za(e, t) {
    let u = null,
      r = t;
    for (; r !== u; )
      ((u = r), (r = Y(e, r)), (r = xe(e, r)), (r = Be(e, r)), (r = K(e, r)));
    return r;
  }
  var ze = za;
  function Ja(e, t) {
...
`);
  ...
  var Wn = qa;
  var $n = Object.freeze({ character: "'", codePoint: 39 }),
    Vn = Object.freeze({ character: '"', codePoint: 34 }),
    Qa = Object.freeze({ preferred: $n, alternate: Vn }),
    Za = Object.freeze({ preferred: Vn, alternate: $n });
  function ei(e, t) {
    let { preferred: u, alternate: r } = t === !0 || t === "'" ? Qa : Za,
      { length: o } = e,
      n = 0,
      a = 0;
    for (let s = 0; s < o; s++) {
  ...
  function me(e, t = 1) {
    return async (...u) => {
      let r = u[t] ?? {},
        o = r.plugins ?? [];
      return (
        (u[t] = { ...r, plugins: Array.isArray(o) ? o : Object.values(o) }),
        e(...u)
      );
    };
  }

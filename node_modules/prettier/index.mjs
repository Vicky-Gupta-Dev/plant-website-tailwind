  ...
  "node_modules/fill-range/index.js"(exports, module) {
    ...
    var fillNumbers = (start, end, step = 1, options8 = {}) => {
      ...
      let maxLen = padded
        ...
        : 0;
      let toNumber =
        padded === false && stringify2(start, end, options8) === false;
    ...
    function readdir(directory, settings, callback) {
      settings.fs.readdir(directory, (readdirError, names) => {
        ...
        const tasks = names.map((name) => {
          const path15 = common.joinPathSegments(
            directory,
            name,
            settings.pathSegmentSeparator,
          );
...
var require_fnmatch = __commonJS({
  "node_modules/editorconfig/src/lib/fnmatch.js"(exports, module) {
    ...
    function parse7(pattern, isSub) {
      ...
      for (
        var i = 0, len = pattern.length, c2;
        i < len && (c2 = pattern.charAt(i));
        i++
      ) {
        if (options8.debug) {
  ...
  "node_modules/ignore/index.js"(exports, module) {
    ...
    var Ignore = class {
      ...
      _t(path15, cache3, checkUnignored, slices) {
        ...
        slices.pop();
        if (!slices.length) {
          return (cache3[path15] = this._rules.test(
            path15,
            checkUnignored,
            MODE_IGNORE,
          ));
...
var Diff = class {
  ...
  diffWithOptionsObj(oldTokens, newTokens, options8, callback) {
    ...
    const maxExecutionTime =
      (_a = options8.timeout) !== null && _a !== void 0 ? _a : Infinity;
...
function createTwoFilesPatch(
  ...
  if (
    !(options8 === null || options8 === void 0 ? void 0 : options8.callback)
  ) {
...
function leven(first, second, options8) {
  ...
  if (firstLength === 0) {
    return maxDistance !== void 0 && secondLength > maxDistance
      ? maxDistance
      : secondLength;
  }
  let bCharacterCode;
...
var apiDescriptor = {
  key: (key2) =>
    /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(key2) ? key2 : JSON.stringify(key2),
  value(value) {
...
var commonInvalidHandler = (key2, value, utils) => {
  const { text, list } = utils.normalizeExpectedResult(
    utils.schemas[key2].expected(utils),
  );
  const descriptions = [];
  if (text) {
...
var levenUnknownHandler = (key2, value, { descriptor, logger, schemas }) => {
  ...
  const suggestion = closestMatch(key2, Object.keys(schemas), {
    maxDistance: 3,
  });
  if (suggestion) {
    messages2.push(
  ...
  _partitionOptionKeys(options8) {
    const [knownKeys, unknownKeys] = partition(
      Object.keys(options8).filter(
        (key2) => !this._identifyMissing(key2, options8),
      ),
...
async function loadEditorconfigInternal(file, { shouldCache }) {
  ...
  const editorConfig = await import_editorconfig.default.parse(file, {
    root: root2,
  });
...
import {
  fileURLToPath as fileURLToPath4,
  pathToFileURL as pathToFileURL3,
} from "url";
...
function mergeOverrides(configResult, filePath) {
  ...
  if (filePath && overrides) {
    const relativeFilePath = path10.relative(
      path10.dirname(configFile),
      filePath,
    );
...
// src/main/core.js
import {
  builders as __doc_builders4,
  printer as __doc_printer,
} from "./doc.mjs";
...
function getStringWidth(text) {
  ...
  text = text.replace(emoji_regex_default(), (match) =>
...
var create_print_pre_check_function_default = true
  ? () => noop_default
...
// src/main/front-matter/embed.js
var { hardline: hardline2, markAsRoot } = __doc_builders2;
...
function getPrinterPluginByAstFormat(plugins, astFormat) {
  ...
  const plugin = method_find_last_default(
    ...
    (plugin2) =>
      plugin2.printers &&
      Object.prototype.hasOwnProperty.call(plugin2.printers, astFormat),
  );
  if (plugin) {
    return plugin;
  }
...
function normalizePrinter(printer) {
  ...
  getVisitorKeys = create_get_visitor_keys_function_default(
    ...
    frontMatterSupport.massageAstNode ||
...
async function parse5(originalText, options8) {
  ...
  const text = parser.preprocess
    ? await parser.preprocess(originalText, options8)
    : originalText;
...
// src/main/multiparser.js
var { stripTrailingHardline } = __doc_utils;
...
function callPluginPrintFunction(path15, options8, printPath, args, embeds) {
  ...
  if (
    ...
    !printer.willPrintOwnComments?.(path15, options8)
  ) {
...
// src/main/core.js
var { addAlignmentToDoc, hardline: hardline3 } = __doc_builders4;
var { printDocToString: printDocToStringWithoutNormalizeOptions } =
  __doc_printer;
var BOM = "\uFEFF";
...
var builtin_plugins_proxy_default = [
  estreePlugin,
  { options: options7, languages, parsers, printers },
];

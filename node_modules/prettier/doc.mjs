            ...
            if (
              ...
              if (doc2.expandedStates) {
                ...
                if (doc2.break) {
                  ...
                  for (
                    let index = 1;
                    index < doc2.expandedStates.length + 1;
                    index++
                  ) {
  ...
  function trim2() {
    ...
    if (cursorPositions.length > 0) {
      settledCursorPositions.push(
        ...cursorPositions.map((position2) =>
          Math.min(position2, settledTextLength),
        ),
      );
...
export { builders, public_exports as default, printer, utils };

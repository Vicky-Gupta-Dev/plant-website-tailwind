...
var no = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  Yt = (e, t) => {
    for (var u in t) Mt(e, u, { get: t[u], enumerable: !0 });
  },
  oo = (e, t, u, r) => {
...
var ao = (e, t, u) => (
  ...
  oo(
    t || !e || !e.__esModule
      ? Mt(u, "default", { value: e, enumerable: !0 })
      : u,
    e,
  )
);
        ...
        case "InterpolationInJSX":
          ...
          if (((Ve.lastIndex = n), (i = Ve.exec(e)))) {
            switch (((p = i[0]), (f = Ve.lastIndex), (l = p), p)) {
              ...
              case "{":
                ((Ve.lastIndex = 0),
                  (o = !fn.test(a) && (Ot.test(a) || $e.test(a))),
                  u.push(o),
                  (c = !1));
                break;
              case "}":
          ...
          if (((pe.lastIndex = n), (i = pe.exec(e)))) {
            ((n = pe.lastIndex),
              ...
              i[1] === "${"
                ? ((a = "?InterpolationInTemplate"),
                  F.push({ tag: "InterpolationInTemplate", nesting: u.length }),
                  (c = !1),
...
var G = "string",
  ...
  O = "label",
  T = "break-parent",
  He = new Set([U, I, k, v, x, w, B, R, L, M, _, O, T]);
function Uu(e) {
  let t = e.length;
  for (
    ;
...
`,
      ...
      case w: {
        ...
        (a.push(qn),
          Qn ? a.push(Iu, ne) : Rt ? a.push(Lt, ne) : a.push(Lt, vt));
        break;
      }
      case B:
      case R: {
...
function gr(e, t, u) {
  ...
  let n,
    a = (
      u.getChildren?.(e, u) ?? [...be(e, { getVisitorKeys: u.getVisitorKeys })]
    ).flatMap((D) => (n ?? (n = [e, ...t]), o(D, n) ? [D] : gr(D, n, u))),
...
function Ar(e, t) {
  ...
  if ((yr(r, t), !o))
    for (let l of u)
      (delete l.precedingNode, delete l.enclosingNode, delete l.followingNode);
}
var _r = (e) => !/[\S\n\u2028\u2029]/u.test(e);
function Yo(e, t, u, r) {
...
function Wo(e, t) {
  ...
  if (o.isBlockComment?.(u)) {
    let f = z(n, s(u)) ? (z(n, a(u), { backwards: !0 }) ? V : ut) : " ";
    r.push(f);
  } else r.push(V);
  let D = K(n, Y(n, s(u)));
...
function it({ plugins: e = [], showDeprecated: t = !1 } = {}) {
  let u = e.flatMap((o) => o.languages ?? []),
    r = [];
  for (let o of Go(Object.assign({}, ...e.map(({ options: n }) => n), Sr)))
    (!t && o.deprecated) ||
    ...
    if (o.parsers) {
      for (let n of o.parsers)
        if (!r.has(n)) {
          ...
          let a = u.find(
              (i) =>
                i.parsers && Object.prototype.hasOwnProperty.call(i.parsers, n),
            ),
            s = o.name;
...
var Lr = " ".repeat(2),
  Yr = (e, t, u) => {
    ...
    return (
      ...
      o &&
        n.push(
          [Mr(e, t, o.title, u.descriptor)].concat(
            o.values.map((a) => jr(a, u.loggerPrintWidth)),
          ).join(`
`),
        ),
...
function jr({ text: e, list: t }, u) {
  ...
  return (
    ...
    t &&
      r.push(
        [`- ${$.blue(t.title)}:`].concat(
          t.values.map((o) => jr(o, u - Lr.length).replace(/^|\n/g, `$&${Lr}`)),
        ).join(`
`),
      ),
    Ur(r, u)
...
function Wr(e, t, u) {
  ...
  for (let i of t) {
    ...
    let f = Number.isFinite(a) ? (r === void 0 ? a : Math.min(a, r)) : r,
      l = f === void 0 ? ct(e, i) : ct(e, i, { maxDistance: f });
    if (r !== void 0 && l > r) continue;
    let d = l;
    if (
      (f !== void 0 && l === f && f === r && (d = ct(e, i)),
      d < a && ((a = d), (n = i), a === 0))
    )
      break;
  }
...
var ft = (e, t, { descriptor: u, logger: r, schemas: o }) => {
  let n = [`Ignored unknown option ${$.yellow(u.pair({ key: e, value: t }))}.`],
  ...
  _applyRequiredCheck(t) {
    for (let u of Object.keys(this._utils.schemas))
      if (this._identifyMissing(u, t) && this._identifyRequired(u))
        throw this._invalidHandler(u, Dt, this._utils);
  }
...
function ia(
  ...
  let s = o
    ...
    D = new gt(i, { logger: u, unknown: s, descriptor: a }),
    f = u !== !1;
...
function sa(e, { isCLI: t, FlagSchema: u }) {
  ...
  for (let o of e)
    (r.push(Da(o, { isCLI: t, optionInfos: e, FlagSchema: u })),
      o.alias && t && r.push(lt.create({ name: o.alias, sourceName: o.name })));
  return r;
}
...
async function ba(e, t = {}) {
  ...
  if (!u.parser)
    if (u.filepath) {
      if (((u.parser = st(u, { physicalFile: u.filepath })), !u.parser))
        throw new Ye(`No parser could be inferred for file "${u.filepath}".`);
    } else
      throw new Ye(
        "No parser and no file path given, couldn't infer a parser.",
      );
  let r = it({ plugins: e.plugins, showDeprecated: !0 }).options,
    o = {
      ...Dn,
      ...Object.fromEntries(
  ...
  let s = n.printers?.[a.astFormat] ? n : an(u.plugins, a.astFormat),
    i = await sn(s, a.astFormat);
  ...
  return (
    ...
    un(u, r, { passThrough: Object.keys(Dn), ...t })
  );
}
var se = ba;
var pf = ao(dn(), 1);
...
function gn(e, t, u, r, o) {
  ...
  return (
    a.printComment && !a.willPrintOwnComments?.(e, t) && (s = Br(e, s, t)),
    s
  );
}
...
function Pn(e, t) {
  let { cursorOffset: u, rangeStart: r, rangeEnd: o, endOfLine: n } = Nn(e, t),
    a = e.charAt(0) === wn;
  if (
    (a && ((e = e.slice(1)), u--, r--, o--),
    n === "auto" && (n = Yu(e)),

...
- `sortingOrder`: `'ascending' | 'descending' (default)` - Determines the order of imports. If set to 'ascending', imports will be sorted in ascending order and vice versa.
...
- Fix bug where imports were not sorted in a stable manner when sorted by length

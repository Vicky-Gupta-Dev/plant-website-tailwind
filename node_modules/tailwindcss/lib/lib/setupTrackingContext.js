...
const _resolveConfigPath = /*#__PURE__*/ _interop_require_default(
  require('../util/resolveConfigPath')
)
...
function getTailwindConfig(configOrPath) {
  ...
  if (userConfigPath !== null) {
    ...
    let newConfig = (0, _validateConfig.validateConfig)(
      (0, _resolveconfig.default)((0, _loadconfig.loadConfig)(userConfigPath))
    )
  ...
  let newConfig = (0, _resolveconfig.default)(
    (_ref =
      (_configOrPath_config =
        configOrPath === null || configOrPath === void 0 ? void 0 : configOrPath.config) !== null &&
      _configOrPath_config !== void 0
        ? _configOrPath_config
        : configOrPath) !== null && _ref !== void 0
      ? _ref
      : {}
  )
...
function setupTrackingContext(configOrPath) {
  return ({ tailwindDirectives, registerDependency }) => {
    return (root, result) => {
      ...
      let [context, , mTimesToCommit] = (0, _setupContextUtils.getContext)(
        root,
        result,
        tailwindConfig,
        userConfigPath,
      ...
      if (tailwindDirectives.size > 0) {
        ...
        let [changedContent, contentMTimesToCommit] = (0, _content.resolvedChangedContent)(
          context,
          candidateFiles,
          fileModifiedMap
        )

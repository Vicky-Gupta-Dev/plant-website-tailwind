...
const _parseObjectStyles = /*#__PURE__*/ _interop_require_default(
  require('../util/parseObjectStyles')
)
      ...
      preserveSource:
        (_match__options_preserveSource =
          (_match__options = match[0].options) === null || _match__options === void 0
            ? void 0
            : _match__options.preserveSource) !== null && _match__options_preserveSource !== void 0
          ? _match__options_preserveSource
          : false,
    }
    yield match

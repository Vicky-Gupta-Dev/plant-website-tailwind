...
function expandTailwindAtRules(context) {
  return async (root) => {
    ...
    let candidates = new Set([
      ...((_context_candidates = context.candidates) !== null && _context_candidates !== void 0
        ? _context_candidates
        : []),
    ...
    if (layerNodes.base) {
      layerNodes.base.before(
        (0, _cloneNodes.default)([...defaultNodes, ...baseNodes], layerNodes.base.source, {
          layer: 'base',
        })
      )
    ...
    if (layerNodes.components) {
      layerNodes.components.before(
        (0, _cloneNodes.default)([...componentNodes], layerNodes.components.source, {
          layer: 'components',
        })
      )
    ...
    if (layerNodes.utilities) {
      layerNodes.utilities.before(
        (0, _cloneNodes.default)([...utilityNodes], layerNodes.utilities.source, {
          layer: 'utilities',
        })
      )
    ...
    const variantNodes = Array.from(screenNodes).filter((node) => {
      ...
      const parentLayer =
        (_node_raws_tailwind = node.raws.tailwind) === null || _node_raws_tailwind === void 0
          ? void 0
          : _node_raws_tailwind.parentLayer
    ...
    if (layerNodes.variants) {
      layerNodes.variants.before(
        (0, _cloneNodes.default)(variantNodes, layerNodes.variants.source, {
          layer: 'variants',
        })
      )
      ...
      root.append(
        (0, _cloneNodes.default)(variantNodes, root.source, {
          layer: 'variants',
        })
      )
    }
    ...
    root.source.end =
      (_root_source_end = root.source.end) !== null && _root_source_end !== void 0
        ? _root_source_end
        : root.source.start
    ...
    const hasUtilityVariants = variantNodes.some((node) => {
      ...
      return (
        ((_node_raws_tailwind = node.raws.tailwind) === null || _node_raws_tailwind === void 0
          ? void 0
          : _node_raws_tailwind.parentLayer) === 'utilities'
      )
    })

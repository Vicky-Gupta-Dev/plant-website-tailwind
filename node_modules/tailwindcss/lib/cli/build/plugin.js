...
const _plugins = /*#__PURE__*/ _interop_require_default(
  require(
    'postcss-load-config/src/plugins' // Little bit scary, looking at private/internal API
  )
)
const _options = /*#__PURE__*/ _interop_require_default(
  require(
    'postcss-load-config/src/options' // Little bit scary, looking at private/internal API
  )
)
const _processTailwindFeatures = /*#__PURE__*/ _interop_require_default(
  require('../../processTailwindFeatures')
)
...
const _getModuleDependencies = /*#__PURE__*/ _interop_require_default(
  require('../../lib/getModuleDependencies')
)
...
let state = {
  ...
  refreshContentPaths() {
    var _this_context
    this.contentPaths = (0, _content.parseCandidateFiles)(
      this.context,
      (_this_context = this.context) === null || _this_context === void 0
        ? void 0
        : _this_context.tailwindConfig
    )
  },
  get config() {
  ...
  refreshConfigDependencies() {
    ...
    ;(_this_configBag = this.configBag) === null || _this_configBag === void 0
      ? void 0
      : _this_configBag.dispose()
  ...
  getContext({ createContext, cliConfigPath, root, result, content }) {
    ...
    let configPath =
      (_findAtConfigPath1 = (0, _findAtConfigPath.findAtConfigPath)(root, result)) !== null &&
      _findAtConfigPath1 !== void 0
        ? _findAtConfigPath1
        : cliConfigPath
...
async function createProcessor(args, cliConfigPath) {
  ...
  let content =
    (_args_content_split =
      (_args_content = args['--content']) === null || _args_content === void 0
        ? void 0
        : _args_content.split(/(?<!{[^}]+),/)) !== null && _args_content_split !== void 0
      ? _args_content_split
      : []
  let tailwindPlugin = () => {
    return {
      ...
      state.watcher = (0, _watching.createWatcher)(args, {
         ...
         */ async rebuild(changes) {
          let needsNewContext = changes.some((change) => {
            ...
            return (
              ((_state_configBag = state.configBag) === null || _state_configBag === void 0
                ? void 0
                : _state_configBag.dependencies.has(change.file)) ||

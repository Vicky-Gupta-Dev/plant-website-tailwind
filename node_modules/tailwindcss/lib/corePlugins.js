...
const _createUtilityPlugin = /*#__PURE__*/ _interop_require_default(
  require('./util/createUtilityPlugin')
)
...
const _parseAnimationValue = /*#__PURE__*/ _interop_require_default(
  require('./util/parseAnimationValue')
)
const _flattenColorPalette = /*#__PURE__*/ _interop_require_default(
  require('./util/flattenColorPalette')
)
const _withAlphaVariable = /*#__PURE__*/ _interop_require_wildcard(
  require('./util/withAlphaVariable')
)
...
const _transformThemeValue = /*#__PURE__*/ _interop_require_default(
  require('./util/transformThemeValue')
)
...
let corePlugins = {
  ...
  animation: ({ matchUtilities, theme, config }) => {
    ...
    let keyframes = Object.fromEntries(
      Object.entries((_theme = theme('keyframes')) !== null && _theme !== void 0 ? _theme : {}).map(
        ([key, value]) => {
          return [
            key,
            {

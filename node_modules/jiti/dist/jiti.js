(() => {
  var __webpack_modules__ = {
        ...
        (module, __unused_webpack_exports, __webpack_require__) => {
          ...
          module.exports = function (filename) {
            return (
              ...
              })(filename) && (filename = path.join(filename, "index.js")),
              nativeModule.createRequire
                ? nativeModule.createRequire(filename)
                : nativeModule.createRequireFromPath
                  ? nativeModule.createRequireFromPath(filename)
                  : (function (filename) {
      ...
      "./node_modules/.pnpm/mlly@1.7.3/node_modules/mlly/dist lazy recursive": (
        module,
      ) => {
        ...
        (module, exports, __webpack_require__) => {
          ...
          function objectHash(object, options) {
            return (function (object, options) {
              var hashingStream;
              hashingStream =
                "passthrough" !== options.algorithm
                  ? crypto.createHash(options.algorithm)
                  : new PassThrough();
              void 0 === hashingStream.write &&
                ((hashingStream.write = hashingStream.update),
                (hashingStream.end = hashingStream.update));
              var hasher = typeHasher(options, hashingStream);
              (hasher.dispatch(object),
                hashingStream.update || hashingStream.end(""));
              if (hashingStream.digest)
                return hashingStream.digest(
                  "buffer" === options.encoding ? void 0 : options.encoding,
                );
          ...
          function applyDefaults(object, sourceOptions) {
            ...
            if (
              ...
              (options.ignoreUnknown = !0 === sourceOptions.ignoreUnknown),
              (options.respectType = !1 !== sourceOptions.respectType),
              (options.respectFunctionNames =
                !1 !== sourceOptions.respectFunctionNames),
              (options.respectFunctionProperties =
                !1 !== sourceOptions.respectFunctionProperties),
              (options.unorderedArrays = !0 === sourceOptions.unorderedArrays),
              (options.unorderedSets = !1 !== sourceOptions.unorderedSets),
              (options.unorderedObjects =
                !1 !== sourceOptions.unorderedObjects),
            ...
            for (var i = 0; i < hashes.length; ++i)
              hashes[i].toLowerCase() === options.algorithm.toLowerCase() &&
            ...
            if (
              -1 === encodings.indexOf(options.encoding) &&
              "passthrough" !== options.algorithm
            )
              throw new Error(
                'Encoding "' +
            ...
            return {
              ...
              _object: function (object) {
                ...
                if (
                  ...
                  return keys.forEach(function (key) {
                    (self.dispatch(key),
                      write(":"),
                      options.excludeValues || self.dispatch(object[key]),
                      write(","));
                  });
                }
                if (!this["_" + objType]) {
              ...
              _array: function (arr, unordered) {
                unordered =
                  void 0 !== unordered
                    ? unordered
                    : !1 !== options.unorderedArrays;
                var self = this;
                if (
                  (write("array:" + arr.length + ":"),
                  !unordered || arr.length <= 1)
                )
              ...
              _function: function (fn) {
                (write("fn:"),
                  ...
                  !1 !== options.respectFunctionNames &&
                    this.dispatch("function-name:" + String(fn.name)),
                  options.respectFunctionProperties && this._object(fn));
              },
          ...
          exports.writeToStream = function (object, options, stream) {
            return (
              void 0 === stream && ((stream = options), (options = {})),
              typeHasher(
      ...
      "./node_modules/.pnpm/pirates@4.0.6/node_modules/pirates/lib/index.js": (
        module,
        exports,
        __webpack_require__,
      ) => {
            ...
            return (
              exts.forEach((ext) => {
                ...
                ((oldLoaders[ext] = Module._extensions[ext]),
                  (loaders[ext] = Module._extensions[ext] =
                    function (mod, filename) {
                      ...
                      (reverted ||
                        ((function (
                          ...
                          if (
                            -1 === exts.indexOf(_path.default.extname(filename))
                          )
                            return !1;
                          const resolvedFilename =
                            _path.default.resolve(filename);
                          if (
                            ignoreNodeModules &&
                            nodeModulesRegex.test(resolvedFilename)
                          )
                            return !1;
                          if (matcher && "function" == typeof matcher)
                            return !!matcher(resolvedFilename);
                          return !0;
                        })(filename, exts, matcher, ignoreNodeModules) &&
              ...
              function () {
                reverted ||
                  ((reverted = !0),
                  exts.forEach((ext) => {
                    Module._extensions[ext] === loaders[ext] &&
                      (oldLoaders[ext]
        ...
        (module, __unused_webpack_exports, __webpack_require__) => {
          ...
          class Comparator {
            ...
            constructor(comp, options) {
              if (
                ((options = parseOptions(options)), comp instanceof Comparator)
              ) {
          ...
          const parseOptions = __webpack_require__(
            ...
            { safeRe: re, t } = __webpack_require__(
      ...
      "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/classes/range.js":
        (module, __unused_webpack_exports, __webpack_require__) => {
          ...
          const cache = new (__webpack_require__(
            ...
            parseOptions = __webpack_require__(
              "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/internal/parse-options.js",
            ),
            ...
            { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = __webpack_require__(
      ...
      "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/classes/semver.js":
        (module, __unused_webpack_exports, __webpack_require__) => {
          const debug = __webpack_require__(
            ...
            { MAX_LENGTH, MAX_SAFE_INTEGER } = __webpack_require__(
              "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/internal/constants.js",
            ),
            { safeRe: re, t } = __webpack_require__(
              "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/internal/re.js",
          ...
          class SemVer {
            constructor(version, options) {
              if (
                ((options = parseOptions(options)), version instanceof SemVer)
              ) {
                if (
      ...
      "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/functions/compare-build.js":
        (module, __unused_webpack_exports, __webpack_require__) => {
          ...
          module.exports = (a, b, loose) => {
            ...
            return (
              versionA.compare(versionB) || versionA.compareBuild(versionB)
            );
          };
        },
      ...
      "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/index.js": (
        ...
        const internalRe = __webpack_require__(
          ...
          identifiers = __webpack_require__(
            "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/internal/identifiers.js",
          ),
          parse = __webpack_require__(
            "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/functions/parse.js",
        ...
        (module) => {
          module.exports = class {
            ...
            get(key) {
              ...
              return void 0 === value
                ? void 0
                : (this.map.delete(key), this.map.set(key, value), value);
            }
            delete(key) {
        ...
        (module, __unused_webpack_exports, __webpack_require__) => {
          ...
          module.exports = (versions, range, options) => {
            ...
            const simplified = ranges.join(" || "),
              original =
                "string" == typeof range.raw ? range.raw : String(range);
          ...
          const Range = __webpack_require__(
            ...
            simpleSubset = (sub, dom, options) => {
              ...
              for (const c of dom) {
                if (
                  ((hasDomGT =
                    hasDomGT || ">" === c.operator || ">=" === c.operator),
                  (hasDomLT =
                    hasDomLT || "<" === c.operator || "<=" === c.operator),
                  gt)
                )
                  if (
                    (needDomGTPre &&
  ...
  ((() => {
    ...
    var external_vm_default = __webpack_require__.n(
    ...
    const _UNC_REGEX = /^[/\\]{2}/,
      ...
      pathe_ff20891b_normalize = function (path) {
      ...
      join = function (...arguments_) {
        ...
        return void 0 === joined
          ? "."
          : pathe_ff20891b_normalize(joined.replace(/\/\/+/g, "/"));
      };
    ...
    const isAbsolute = function (p) {
      ...
      pathe_ff20891b_dirname = function (p) {
        ...
        return (
          1 === segments.length &&
            _DRIVE_LETTER_RE.test(segments[0]) &&
            (segments[0] += "/"),
    ...
    var create_require = __webpack_require__(
        "./node_modules/.pnpm/create-require@1.1.1/node_modules/create-require/create-require.js",
      ),
    ...
    function normalizeAliases(_aliases) {
      ...
      const aliases = Object.fromEntries(
        Object.entries(_aliases).sort(([a], [b]) =>
          (function (a, b) {
        ...
        for (const alias in aliases)
          alias === key ||
            ...
            (aliases[key].startsWith(alias) &&
              ...
              (aliases[key] =
                aliases[alias] + aliases[key].slice(alias.length)));
      return (
    ...
    var Parser = function (options, input, startPos) {
        ...
        (!0 !== options.allowReserved &&
          ((reserved =
            reservedWords[
              options.ecmaVersion >= 6 ? 6 : 5 === options.ecmaVersion ? 5 : 3
            ]),
    ...
    ((pp$8.isLet = function (context) {
      ...
      (pp$8.parseStatement = function (context, topLevel, exports) {
        var kind,
          ...
          node = this.startNode();
        switch (
          (this.isLet(context) && ((starttype = types$1._var), (kind = "let")),
          starttype)
        ) {
          case types$1._break:
      ...
      (pp$8.parseWithClause = function () {
        ...
        for (var attributeKeys = {}, first = !0; !this.eat(types$1.braceR); ) {
          ...
          var attr = this.parseImportAttribute(),
            keyName =
              "Identifier" === attr.key.type ? attr.key.name : attr.key.value;
          (hasOwn(attributeKeys, keyName) &&
            this.raiseRecoverable(
              attr.key.start,
              "Duplicate attribute key '" + keyName + "'",
            ),
            (attributeKeys[keyName] = !0),
            nodes.push(attr));
        }
        return nodes;
      }),
      ...
      (pp$5.parseMaybeUnary = function (
        ...
        if (this.isContextual("await") && this.canAwait)
          ...
          ((node.operator = this.value),
            (node.prefix = !0),
            this.next(),
            (node.argument = this.parseMaybeUnary(null, !0, update, forInit)),
            this.checkExpressionErrors(refDestructuringErrors, !0),
            update
      ...
      (pp$5.parseDynamicImport = function (node) {
        if (
          ...
          this.eat(types$1.parenR)
            ? (node.options = null)
            : (this.expect(types$1.comma),
              this.afterTrailingComma(types$1.parenR)
                ? (node.options = null)
      ...
      (pp$5.parseParenAndDistinguishExpression = function (
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          for (
            ...
            if (
              (first ? (first = !1) : this.expect(types$1.comma),
              allowTrailingComma && this.afterTrailingComma(types$1.parenR, !0))
            ) {
              lastIsComma = !0;
              break;
            }
    ...
    ((RegExpValidationState.prototype.reset = function (start, pattern, flags) {
          ...
          if (state.eat(63)) {
            if (this.options.ecmaVersion >= 16) {
              var addModifiers = this.regexp_eatModifiers(state),
                hasHyphen = state.eat(45);
              if (addModifiers || hasHyphen) {
                for (var i = 0; i < addModifiers.length; i++) {
                  var modifier = addModifiers.charAt(i);
                  addModifiers.indexOf(modifier, i + 1) > -1 &&
      ...
      (pp$1.regexp_eatModifiers = function (state) {
        for (
          var modifiers = "", ch = 0;
          -1 !== (ch = state.current()) && isRegularExpressionModifier(ch);
        )
          ...
          if (known)
            if (trackDisjunction)
              for (var i = 0, list = known; i < list.length; i += 1) {
                list[i].separatedFrom(state.branchID) ||
      ...
      (pp$1.regexp_eatBackReference = function (state) {
        ...
        if (this.regexp_eatDecimalEscape(state)) {
          ...
          if (state.switchU)
            return (
              n > state.maxBackReference && (state.maxBackReference = n),
              !0
            );
    ...
    ((pp$1.regexp_eatCharacterClassEscape = function (state) {
      ...
      if (
        ...
        if (
          ...
          return (
            negate && 2 === result && state.raise("Invalid property name"),
            result
          );
      ...
      (pp.readNumber = function (startsWithDot) {
        ...
        var str,
          val =
            ...
            octal ? parseInt(str, 8) : parseFloat(str.replace(/_/g, "")));
          ...
          if (
            ...
            return this.pos !== this.start ||
              ...
              : 36 === ch
                ...
                : (++this.pos, this.finishToken(types$1.backQuote));
          if (92 === ch)
            ((out += this.input.slice(chunkStart, this.pos)),
            ...
            switch (
              ((out += this.input.slice(chunkStart, this.pos)), ++this.pos, ch)
            ) {
              case 13:
    ...
    function dist_hasTrailingSlash(input = "", respectQueryAndFragment) {
      return respectQueryAndFragment
        ? TRAILING_SLASH_RE.test(input)
        : input.endsWith("/");
    }
    ...
    const external_node_url_namespaceObject = require("url"),
      external_node_assert_namespaceObject = require("assert"),
              ...
              return (
                ...
                0 === parameters.length
                  ...
                  : (parameters.unshift(message),
                    Reflect.apply(
                      external_node_util_namespaceObject.format,
                      null,
                      parameters,
                    ))
              );
    ...
    function isErrorStackTraceLimitWritable() {
      try {
        if (
          external_node_v8_namespaceObject.startupSnapshot.isBuildingSnapshot()
        )
          return !1;
      } catch {}
      ...
      return void 0 === desc
        ...
        : own$1.call(desc, "writable") && void 0 !== desc.writable
          ? desc.writable
          : void 0 !== desc.set;
    }
    ((codes.ERR_INVALID_ARG_TYPE = createError(
      ...
      (name, expected, actual) => {
        ...
        return (
          types.length > 0 &&
            ...
            (instances.length > 0 || other.length > 0) && (message += " or ")),
          instances.length > 0 &&
            ((message += `an instance of ${formatList(instances, "or")}`),
            other.length > 0 && (message += " or ")),
          other.length > 0 &&
            (other.length > 1
              ? (message += `one of ${formatList(other, "or")}`)
              : (other[0].toLowerCase() !== other[0] && (message += "an "),
                (message += `${other[0]}`))),
          (message += `. Received ${(function (value) {
            if (null == value) return String(value);
            if ("function" == typeof value && value.name)
              return `function ${value.name}`;
            if ("object" == typeof value)
              return value.constructor && value.constructor.name
                ? `an instance of ${value.constructor.name}`
                : `${(0, external_node_util_namespaceObject.inspect)(value, { depth: -1 })}`;
            let inspected = (0, external_node_util_namespaceObject.inspect)(
              value,
              { colors: !1 },
            );
            inspected.length > 28 &&
      ...
      (codes.ERR_INVALID_PACKAGE_TARGET = createError(
        ...
        (packagePath, key, target, isImport = !1, base = void 0) => {
          const relatedError =
            ...
            !target.startsWith("./");
          return "." === key
            ? (external_node_assert_namespaceObject(!1 === isImport),
              `Invalid "exports" main target ${JSON.stringify(target)} defined in the package config ${packagePath}package.json${base ? ` imported from ${base}` : ""}${relatedError ? '; targets must start with "./"' : ""}`)
            : `Invalid "${isImport ? "imports" : "exports"}" target ${JSON.stringify(target)} defined for '${key}' in the package config ${packagePath}package.json${base ? ` imported from ${base}` : ""}${relatedError ? '; targets must start with "./"' : ""}`;
        },
        Error,
      )),
      (codes.ERR_MODULE_NOT_FOUND = createError(
        "ERR_MODULE_NOT_FOUND",
        (path, base, exactUrl = !1) =>
      ...
      (codes.ERR_PACKAGE_PATH_NOT_EXPORTED = createError(
        ...
        (packagePath, subpath, base = void 0) =>
          "." === subpath
            ? `No "exports" main defined in ${packagePath}package.json${base ? ` imported from ${base}` : ""}`
            : `Package subpath '${subpath}' is not defined by "exports" in ${packagePath}package.json${base ? ` imported from ${base}` : ""}`,
        Error,
      )),
      ...
      (codes.ERR_UNKNOWN_FILE_EXTENSION = createError(
        ...
        (extension, path) =>
          `Unknown file extension "${extension}" for ${path}`,
        TypeError,
      )),
    ...
    function read(jsonPath, { base, specifier }) {
      ...
      let string;
      try {
        string = external_node_fs_namespaceObject.readFileSync(
          external_node_path_namespaceObject.toNamespacedPath(jsonPath),
          "utf8",
        );
      } catch (error) {
      ...
      if (void 0 !== string) {
        ...
        try {
          ...
          const cause = error_,
            error = new ERR_INVALID_PACKAGE_CONFIG$1(
              jsonPath,
              (base ? `"${specifier}" from ` : "") +
                (0, external_node_url_namespaceObject.fileURLToPath)(
                  base || specifier,
                ),
              cause.message,
            );
        ...
        ((result.exists = !0),
          hasOwnProperty$1.call(parsed, "name") &&
            "string" == typeof parsed.name &&
            (result.name = parsed.name),
          hasOwnProperty$1.call(parsed, "main") &&
            "string" == typeof parsed.main &&
            (result.main = parsed.main),
          hasOwnProperty$1.call(parsed, "exports") &&
            (result.exports = parsed.exports),
          hasOwnProperty$1.call(parsed, "imports") &&
            (result.imports = parsed.imports),
          !hasOwnProperty$1.call(parsed, "type") ||
            ("commonjs" !== parsed.type && "module" !== parsed.type) ||
    ...
    function getPackageScopeConfig(resolved) {
      ...
      for (;;) {
        ...
        if (
          ...
          packageJSONUrl.pathname === lastPackageJSONUrl.pathname)
        )
          break;
      }
      return {
        pjsonPath: (0, external_node_url_namespaceObject.fileURLToPath)(
          packageJSONUrl,
        ),
        exists: !1,
        type: "none",
    ...
    const protocolHandlers = {
      ...
      "data:": function (parsed) {
        ...
        return (function (mime) {
          return mime &&
            /\s*(text|application)\/javascript\s*(;\s*charset=utf-?8\s*)?/i.test(
              mime,
            )
            ? "module"
      ...
      "file:": function (url, _context, ignoreErrors) {
        const value = (function (url) {
          ...
          for (; index--; ) {
            ...
            if (47 === code) return "";
            if (46 === code)
              return 47 === pathname.codePointAt(index - 1)
                ? ""
        ...
        if ("" === value) {
          const packageType = getPackageType(url);
          return "none" === packageType || "commonjs" === packageType
            ? "commonjs"
            : "module";
        }
    ...
    function emitInvalidSegmentDeprecation(
      ...
      const pjsonPath = (0, external_node_url_namespaceObject.fileURLToPath)(
          packageJsonUrl,
        ),
        double = null !== doubleSlashRegEx.exec(isTarget ? target : request);
      external_node_process_namespaceObject.emitWarning(
        `Use of deprecated ${double ? "double slash" : "leading or trailing slash matching"} resolving "${target}" for module request "${request}" ${request === match ? "" : `matched to "${match}" `}in the "${internal ? "imports" : "exports"}" field module resolution of the package at ${pjsonPath}${base ? ` imported from ${(0, external_node_url_namespaceObject.fileURLToPath)(base)}` : ""}.`,
        "DeprecationWarning",
        "DEP0166",
      );
    }
    function emitLegacyIndexDeprecation(url, packageJsonUrl, base, main) {
      ...
      const format = (function (url, context) {
        ...
        return (
          (dist_hasOwnProperty.call(protocolHandlers, protocol) &&
            protocolHandlers[protocol](url, context, !0)) ||
          null
        );
      ...
      const urlPath = (0, external_node_url_namespaceObject.fileURLToPath)(
        ...
        packagePath = (0, external_node_url_namespaceObject.fileURLToPath)(
          new external_node_url_namespaceObject.URL(".", packageJsonUrl),
        ),
        basePath = (0, external_node_url_namespaceObject.fileURLToPath)(base);
      main
        ? external_node_path_namespaceObject.resolve(packagePath, main) !==
            urlPath &&
          external_node_process_namespaceObject.emitWarning(
    ...
    function legacyMainResolve(packageJsonUrl, packageConfig, base) {
      ...
      if (void 0 !== packageConfig.main) {
        if (
          ((guess = new external_node_url_namespaceObject.URL(
            packageConfig.main,
            packageJsonUrl,
          )),
          fileExists(guess))
    ...
    function invalidPackageTarget(
      ...
      return (
        (target =
          "object" == typeof target && null !== target
            ? JSON.stringify(target, null, "")
            : `${target}`),
        new ERR_INVALID_PACKAGE_TARGET(
          (0, external_node_url_namespaceObject.fileURLToPath)(
            new external_node_url_namespaceObject.URL(".", packageJsonUrl),
          ),
          subpath,
    ...
    function resolvePackageTargetString(
      ...
      const resolved = new external_node_url_namespaceObject.URL(
          target,
          packageJsonUrl,
        ),
        resolvedPath = resolved.pathname,
        packagePath = new external_node_url_namespaceObject.URL(
          ".",
          packageJsonUrl,
        ).pathname;
      ...
      if (null !== invalidSegmentRegEx.exec(subpath)) {
        ...
        if (null === deprecatedInvalidSegmentRegEx.exec(subpath)) {
          ...
          !(function (request, match, packageJsonUrl, internal, base) {
      ...
      return pattern
        ? new external_node_url_namespaceObject.URL(
            RegExpPrototypeSymbolReplace.call(
              patternRegEx,
              resolved.href,
              () => subpath,
      ...
      if (Array.isArray(target)) {
        ...
        for (; ++i < targetList.length; ) {
          ...
          try {
            ...
            if (
              ((lastException = error),
              "ERR_INVALID_PACKAGE_TARGET" === error.code)
            )
              continue;
            throw error;
          }
    ...
    function emitTrailingSlashPatternDeprecation(match, pjsonUrl, base) {
      ...
      emittedPackageWarnings.has(pjsonPath + "|" + match) ||
        (emittedPackageWarnings.add(pjsonPath + "|" + match),
        external_node_process_namespaceObject.emitWarning(
          `Use of deprecated trailing slash pattern mapping "${match}" in the "exports" field module resolution of the package at ${pjsonPath}${base ? ` imported from ${(0, external_node_url_namespaceObject.fileURLToPath)(base)}` : ""}. Mapping specifiers ending in "/" is no longer supported.`,
          "DeprecationWarning",
          "DEP0155",
        ));
    }
    function packageExportsResolve(
      ...
      if (
        ((function (exports, packageJsonUrl, base) {
          ...
          for (; ++keyIndex < keys.length; ) {
            const key = keys[keyIndex],
              currentIsConditionalSugar = "" === key || "." !== key[0];
      ...
      for (; ++i < keys.length; ) {
        ...
        if (
          ...
          packageSubpath.length >= key.length &&
            ...
            1 === patternKeyCompare(bestMatch, key) &&
    ...
    function patternKeyCompare(a, b) {
      ...
      return baseLengthA > baseLengthB
        ? -1
        : baseLengthB > baseLengthA || -1 === aPatternIndex
          ? 1
          : -1 === bPatternIndex || a.length > b.length
            ? -1
            : b.length > a.length
              ? 1
              : 0;
    ...
    function packageImportsResolve(name, base, conditions) {
      ...
      if (packageConfig.exists) {
        packageJsonUrl = (0, external_node_url_namespaceObject.pathToFileURL)(
    ...
    function packageResolve(specifier, base, conditions) {
      if (
        external_node_module_namespaceObject.builtinModules.includes(specifier)
      )
        return new external_node_url_namespaceObject.URL("node:" + specifier);
      const { packageName, packageSubpath, isScoped } = (function (
          specifier,
          base,
        ) {
          ...
          "@" === specifier[0] &&
            ((isScoped = !0),
            -1 === separatorIndex || 0 === specifier.length
              ? (validPackageName = !1)
          ...
          if (
            (null !== invalidPackageNameRegEx.exec(packageName) &&
              (validPackageName = !1),
            !validPackageName)
          )
            throw new ERR_INVALID_MODULE_SPECIFIER(
          ...
          return {
            ...
            packageSubpath:
              "." +
              (-1 === separatorIndex ? "" : specifier.slice(separatorIndex)),
            isScoped,
          };
        })(specifier, base),
        packageConfig = getPackageScopeConfig(base);
      if (packageConfig.exists) {
        const packageJsonUrl = (0,
        external_node_url_namespaceObject.pathToFileURL)(
          packageConfig.pjsonPath,
        );
        if (
          packageConfig.name === packageName &&
          void 0 !== packageConfig.exports &&
          null !== packageConfig.exports
        )
      ...
      let lastPath,
        ...
        packageJsonPath = (0, external_node_url_namespaceObject.fileURLToPath)(
          packageJsonUrl,
        );
      do {
        ...
        if (!stat || !stat.isDirectory()) {
          ((lastPath = packageJsonPath),
            ...
            (packageJsonPath = (0,
            external_node_url_namespaceObject.fileURLToPath)(packageJsonUrl)));
          continue;
        }
        const packageConfig = read(packageJsonPath, { base, specifier });
        return void 0 !== packageConfig.exports &&
          null !== packageConfig.exports
    ...
    function moduleResolve(specifier, base, conditions, preserveSymlinks) {
      const protocol = base.protocol,
        isRemote =
          "data:" === protocol || "http:" === protocol || "https:" === protocol;
      let resolved;
      if (
        (function (specifier) {
          return (
            ...
            ("/" === specifier[0] ||
              (function (specifier) {
                if ("." === specifier[0]) {
                  ...
                  if (
                    "." === specifier[1] &&
                    (2 === specifier.length || "/" === specifier[2])
                  )
                    return !0;
                }
                return !1;
      ...
      else if ("file:" === protocol && "#" === specifier[0])
        ...
        try {
          ...
          if (
            isRemote &&
            !external_node_module_namespaceObject.builtinModules.includes(
              specifier,
            )
          ) {
            const error = new ERR_UNSUPPORTED_RESOLVE_REQUEST(specifier, base);
      ...
      return (
        ...
        "file:" !== resolved.protocol
          ? resolved
          : (function (resolved, base, preserveSymlinks) {
              if (null !== encodedSeparatorRegEx.exec(resolved.pathname))
                throw new ERR_INVALID_MODULE_SPECIFIER(
                  resolved.pathname,
              ...
              let filePath;
              try {
                filePath = (0, external_node_url_namespaceObject.fileURLToPath)(
                  resolved,
                );
              } catch (error) {
                const cause = error;
              ...
              if (!preserveSymlinks) {
                const real = (0, external_node_fs_namespaceObject.realpathSync)(
                    filePath,
                  ),
                ...
                external_node_url_namespaceObject.pathToFileURL)(
                  real +
                    (filePath.endsWith(external_node_path_namespaceObject.sep)
                      ? "/"
                      : ""),
                )).search = search),
                  (resolved.hash = hash));
    ...
    function fileURLToPath(id) {
      return "string" != typeof id || id.startsWith("file://")
        ? normalizeSlash(
            (0, external_node_url_namespaceObject.fileURLToPath)(id),
          )
        : normalizeSlash(id);
    }
    ...
    function _resolve(id, options = {}) {
      ...
      if (
        (id.startsWith("file://") && (id = fileURLToPath(id)), isAbsolute(id))
      )
        try {
      ...
      const conditionsSet = options.conditions
        ...
        _urls = (Array.isArray(options.url) ? options.url : [options.url])
          .filter(Boolean)
          .map(
            (url) =>
              new URL(
                (function (id) {
                  return (
                    "string" != typeof id && (id = id.toString()),
                    /(node|data|http|https|file):/.test(id)
                      ? id
                      : BUILTIN_MODULES.has(id)
                        ? "node:" + id
                        : "file://" + encodeURI(normalizeSlash(id))
                  );
                })(url.toString()),
              ),
          );
          ...
          for (const extension of options.extensions || DEFAULT_EXTENSIONS)
            if (
              ((resolved = _tryModuleResolve(
                dist_joinURL(id, prefix) + extension,
                url,
                conditionsSet,
              )),
              resolved)
    ...
    function hasESMSyntax(code, opts = {}) {
      return (
        opts.stripComments && (code = code.replace(COMMENT_RE, "")),
        ESM_RE.test(code)
      );
    }
    var external_crypto_ = __webpack_require__("crypto");
    function md5(content, len = 8) {
      return (0, external_crypto_.createHash)("md5")
        .update(content)
        .digest("hex")
        .slice(0, len);
    }
    ...
    const _EnvDebug = destr(process.env.JITI_DEBUG),
      ...
      isWindows = "win32" === (0, external_os_namespaceObject.platform)(),
      defaults = {
        debug: _EnvDebug,
        ...
        experimentalBun:
          void 0 === _ExpBun ? !!process.versions.bun : !!_ExpBun,
      },
      JS_EXT_RE = /\.(c|m)?j(sx?)$/,
      TS_EXT_RE = /\.(c|m)?t(sx?)$/;
    function createJITI(_filename, opts = {}, parentModule, parentCache) {
      ((opts = Object.assign(Object.assign({}, defaults), opts)).legacy &&
        (opts.cacheVersion += "-legacy"),
        opts.transformOptions &&
          (opts.cacheVersion +=
            "-" + object_hash_default()(opts.transformOptions)));
      const alias =
        ...
        isNativeRe = new RegExp(
          `node_modules/(${nativeModules.map((m) => escapeStringRegexp(m)).join("|")})/`,
        ),
        isTransformRe = new RegExp(
          `node_modules/(${transformModules.map((m) => escapeStringRegexp(m)).join("|")})/`,
        );
      function debug(...args) {
        opts.debug && console.log("[jiti]", ...args);
      }
      if (
        (_filename || (_filename = process.cwd()),
        (function (filename) {
          try {
        ...
        })(_filename) && (_filename = join(_filename, "index.js")),
        !0 === opts.cache &&
          (opts.cache = (function () {
            ...
            if (
              ...
              (delete process.env.TMPDIR,
                (_tmpDir = (0, external_os_namespaceObject.tmpdir)()),
        ...
        try {
          if (
            ((0, external_fs_.mkdirSync)(opts.cache, { recursive: !0 }),
            !(function (filename) {
              try {
                return (
                  (0, external_fs_.accessSync)(
                    filename,
                    external_fs_.constants.W_OK,
                  ),
                  !0
                );
              } catch (_a) {
      ...
      const nativeRequire = create_require_default()(
          isWindows ? _filename.replace(/\//g, "\\") : _filename,
        ),
        ...
        _resolve = (id, options) => {
          ...
          if (
            (alias &&
              (id = (function (path, aliases) {
                const _path = normalizeWindowsPath(path);
                aliases = normalizeAliases(aliases);
                for (const [alias, to] of Object.entries(aliases)) {
                  if (!_path.startsWith(alias)) continue;
                  const _alias = hasTrailingSlash(alias)
                    ? alias.slice(0, -1)
                    : alias;
          ...
          for (const ext of _additionalExts) {
            ...
            if (
              TS_EXT_RE.test(
                (null == parentModule ? void 0 : parentModule.filename) || "",
              ) &&
              ((resolved = tryResolve(
      ...
      function transform(topts) {
        let code = (function (filename, source, get) {
          ...
          const sourceHash = ` /* v${opts.cacheVersion}-${md5(source, 16)} */`,
            filebase =
              basename(pathe_ff20891b_dirname(filename)) +
              "-" +
              basename(filename),
            cacheFile = join(
              opts.cache,
          ...
          if ((0, external_fs_.existsSync)(cacheFile)) {
            const cacheSource = (0, external_fs_.readFileSync)(
              cacheFile,
              "utf8",
            );
          ...
          const result = get();
          return (
            result.includes("__JITI_ERROR__") ||
          ...
          const res = opts.transform(
            Object.assign(
              Object.assign(
                Object.assign({ legacy: opts.legacy }, opts.transformOptions),
                {
                  babel: Object.assign(
                    Object.assign(
                      {},
                    ...
                    null === (_a = opts.transformOptions) || void 0 === _a
                      ? void 0
                      : _a.babel,
                  ),
                },
      ...
      function _interopDefault(mod) {
        return opts.interopDefault
          ? (function (sourceModule, opts = {}) {
              if (
                null === (value = sourceModule) ||
                "object" != typeof value ||
              ...
              if (
                "object" !== _defaultType &&
                ("function" !== _defaultType || opts.preferNamespace)
              )
      ...
      function jiti(id, _importOptions) {
        ...
        if (
          (id.startsWith("node:")
            ? (id = id.slice(5))
            : id.startsWith("file:") &&
              (id = (0, external_url_namespaceObject.fileURLToPath)(id)),
          external_module_.builtinModules.includes(id) || ".pnp.js" === id)
        )
        ...
        if (opts.experimentalBun && !opts.transformOptions)
          try {
            ...
            return (
              !1 === opts.requireCache && delete nativeRequire.cache[id],
              _interopDefault(_mod)
            );
          } catch (error) {
        ...
        if (
          cache[filename] &&
          (!0 === cache[filename].loaded ||
            !1 === (null == parentModule ? void 0 : parentModule.loaded))
        )
          return _interopDefault(
            null === (_a = cache[filename]) || void 0 === _a
              ? void 0
              : _a.exports,
          );
        if (opts.requireCache && nativeRequire.cache[filename]) {
          const cacheEntry = nativeRequire.cache[filename];
          if (null == cacheEntry ? void 0 : cacheEntry.loaded)
      ...
      function evalModule(source, evalOptions = {}) {
        ...
        if (needsTranspile) {
          ...
          debug(
            ...
            filename,
            `(${Math.round(1e3 * (external_perf_hooks_namespaceObject.performance.now() - start)) / 1e3}ms)`,
          );
        } else
          try {
            return (
              debug("[native]", filename),
              _interopDefault(nativeRequire(id))
            );
          } catch (error) {
        ...
        ((mod.filename = filename),
          ...
          (mod.path = pathe_ff20891b_dirname(filename)),
          (mod.paths = external_module_.Module._nodeModulePaths(mod.path)),
          (cache[filename] = mod),
          opts.requireCache && (nativeRequire.cache[filename] = mod));
        try {
          compiled = external_vm_default().runInThisContext(
            external_module_.Module.wrap(source),
            { filename, lineOffset: 0, displayErrors: !1 },
          );
        } catch (error) {
          (opts.requireCache && delete nativeRequire.cache[filename],
            opts.onError(error));
        }
        try {
          compiled(
            ...
            mod,
            mod.filename,
            pathe_ff20891b_dirname(mod.filename),
          );
        } catch (error) {
          (opts.requireCache && delete nativeRequire.cache[filename],
            opts.onError(error));
      ...
      return (
        ...
        (jiti.register = function () {
          return (0, lib.addHook)(
            (source, filename) =>
              jiti.transform({
                source,
                filename,

...
class ReactDisplayNameTransformer extends _Transformer2.default {
  ...
  findDisplayName(startIndex) {
    ...
    if (
      ...
      this.tokens.tokens[startIndex - 2].identifierRole ===
        _tokenizer.IdentifierRole.ObjectKey
    ) {
  ...
  classNeedsDisplayName() {
    ...
    if (
      !this.tokens.matches2(_types.TokenType.parenL, _types.TokenType.braceL)
    ) {
      return false;
    }
    ...
    for (; index < this.tokens.tokens.length; index++) {
      ...
      if (
        token.type === _types.TokenType.braceR &&
      ...
      if (
        ...
        this.tokens.tokens[index].identifierRole ===
          _tokenizer.IdentifierRole.ObjectKey &&
        token.contextId === objectContextId
      ) {

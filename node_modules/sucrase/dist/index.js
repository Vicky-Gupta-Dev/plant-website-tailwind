...
var _identifyShadowedGlobals2 = _interopRequireDefault(
  _identifyShadowedGlobals,
);
...
function getSucraseContext(code, options) {
  ...
  if (options.transforms.includes("imports")) {
    ...
    _identifyShadowedGlobals2.default.call(
      void 0,
      tokenProcessor,
      scopes,
    ...
    _identifyShadowedGlobals2.default.call(
      ...
      tokenProcessor,
      scopes,
      _getTSImportedNames2.default.call(void 0, tokenProcessor),
    );
  }
  return {
    tokenProcessor,

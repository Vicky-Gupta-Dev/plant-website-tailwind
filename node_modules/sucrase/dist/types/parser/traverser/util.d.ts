...
export declare function isContextual(
  contextualKeyword: ContextualKeyword,
): boolean;
export declare function isLookaheadContextual(
  contextualKeyword: ContextualKeyword,
): boolean;
export declare function eatContextual(
  contextualKeyword: ContextualKeyword,
): boolean;
export declare function expectContextual(
  contextualKeyword: ContextualKeyword,
): void;

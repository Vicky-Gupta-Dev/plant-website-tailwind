...
export declare function tsParseModifiers(
  allowedModifiers: Array<ContextualKeyword>,
): void;
/** Parses a modifier matching one the given modifier names. */
export declare function tsParseModifier(
  allowedModifiers: Array<ContextualKeyword>,
...
export declare function tsParseFunctionBodyAndFinish(
  functionStart: number,
  funcContextId: number,
): void;
export declare function tsParseSubscript(
...
export declare function tsTryParseClassMemberWithIsStatic(
  isStatic: boolean,
): boolean;
export declare function tsParseIdentifierStatement(
...
export declare function tsParseMaybeAssign(
  noIn: boolean,
  isWithinParens: boolean,
): boolean;
export declare function tsParseMaybeAssignWithJSX(
  noIn: boolean,
  isWithinParens: boolean,
): boolean;
export declare function tsParseMaybeAssignWithoutJSX(
  noIn: boolean,
  isWithinParens: boolean,
): boolean;

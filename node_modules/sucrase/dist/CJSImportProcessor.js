...
class CJSImportProcessor {
  ...
  pruneTypeOnlyImports() {
    this.nonTypeIdentifiers = _getNonTypeIdentifiers.getNonTypeIdentifiers.call(
      void 0,
      this.tokens,
      this.options,
    );
  ...
  preprocessVarExportAtIndex(index) {
    ...
    for (let i = index + 2; ; i++) {
      if (
        ...
        depth === 0 &&
        !this.tokens.matches1AtIndex(i, _types.TokenType.name)
      ) {
        break;
